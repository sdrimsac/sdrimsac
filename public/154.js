...
var ListItems = function ListItems() {
  return __webpack_require__.e/* import() */(187).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/list_items.vue"));
};

var CardBrandsForm = function CardBrandsForm() {
  return __webpack_require__.e/* import() */(174).then(__webpack_require__.bind(null, "./resources/js/views/card_brands/form.vue"));
};

var MultiplePaymentForm = function MultiplePaymentForm() {
  return __webpack_require__.e/* import() */(185).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/multiple_payment.vue"));
};
...
var ShowSplitPaymentForm = function ShowSplitPaymentForm() {
  return __webpack_require__.e/* import() */(177).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/split_payment.vue"));
};

var PersonCollegeForm = function PersonCollegeForm() {
  return __webpack_require__.e/* import() */(128/* duplicate */).then(__webpack_require__.bind(null, "./modules/College/Resources/assets/js/views/persons/form.vue"));
};
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 21:
              ...
              if (!_this.configuration.discount_with_base_variant) {
                _this.discountTotal = true;
              }
  ...
  methods: {
    ...
    changeCustomer: function changeCustomer() {
      ...
      if (customer != null) {
        ...
        if (this.clientSaleNoteNumber && customer.identity_document_type_id !== "6") {
          this.form.document_type_id = "03";
        }
      }
            ...
            switch (_context9.prev = _context9.next) {
              case 0:
                ...
                if (_this10.establishments.customer_id) {
                  ...
                  if (isRuc && _this10.form.document_type_id != "01") {// this.value = this.establishments.customer_id;
    ...
    checkCustomers: function checkCustomers() {
      if (this.form.document_type_id == "01" || this.form.document_type_id == "03") {
        return this.customers.some(function (c) {
          return c.identity_document_type_id == "6" || c.identity_document_type_id == "1";
        });
      } else {
        return this.customers.some(function (c) {
    ...
    filterSeries: function filterSeries() {
      ...
      if (this.form.document_type_id == "01" && currentClient && currentClient.identity_document_type_id !== "6") {
