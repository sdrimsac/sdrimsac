...
var ConsignmentForm = function ConsignmentForm() {
  return __webpack_require__.e/* import() */(189).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/consignment_modal.vue"));
};

var QuotationForm = function QuotationForm() {
  return __webpack_require__.e/* import() */(176).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/quotation_modal.vue"));
};

var CreditForm = function CreditForm() {
  return __webpack_require__.e/* import() */(187).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/credit_modal.vue"));
};

var CashForm = function CashForm() {
  return __webpack_require__.e/* import() */(192).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/cash/form.vue"));
};

var CloseCash = function CloseCash() {
  return __webpack_require__.e/* import() */(158).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/cash/closecash.vue"));
};

var OrdenPullApart = function OrdenPullApart() {
  return __webpack_require__.e/* import() */(179).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/ordens_pull_apart.vue"));
};

var TableOrdensPending = function TableOrdensPending() {
  return __webpack_require__.e/* import() */(182).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/list_pending_ordens.vue"));
};

var ObservationForm = function ObservationForm() {
  return __webpack_require__.e/* import() */(157).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/partials/observation_form.vue"));
};

var ExpensesIncomes = function ExpensesIncomes() {
  return __webpack_require__.e/* import() */(147).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/expenses_incomes.vue"));
};

var ShowSeriesProduct = function ShowSeriesProduct() {
  return __webpack_require__.e/* import() */(174).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/show_series_product.vue"));
};

var ShowLotesProduct = function ShowLotesProduct() {
  return __webpack_require__.e/* import() */(175).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/show_lotes_product.vue"));
};

var TransfersModal = function TransfersModal() {
  return __webpack_require__.e/* import() */(171).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/transfer_modal.vue"));
};
    ...
    mergeItems: function mergeItems(items) {
      ...
      items.forEach(function (obj) {
        ...
        if (resultado[key]) {
          ...
          resultado[key] = _objectSpread({}, obj);
        }
      });
