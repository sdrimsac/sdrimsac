...
var ListItems = function ListItems() {
  return __webpack_require__.e/* import() */(183).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/list_items.vue"));
};

var CardBrandsForm = function CardBrandsForm() {
  return __webpack_require__.e/* import() */(170).then(__webpack_require__.bind(null, "./resources/js/views/card_brands/form.vue"));
};

var MultiplePaymentForm = function MultiplePaymentForm() {
  return __webpack_require__.e/* import() */(181).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/multiple_payment.vue"));
};
...
var ShowSplitPaymentForm = function ShowSplitPaymentForm() {
  return __webpack_require__.e/* import() */(173).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/split_payment.vue"));
};

var PersonCollegeForm = function PersonCollegeForm() {
  return __webpack_require__.e/* import() */(126/* duplicate */).then(__webpack_require__.bind(null, "./modules/College/Resources/assets/js/views/persons/form.vue"));
};
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: ["clientSaleNoteNumber", "ordens_all_table", "consignment_id", "isConsignment", "affectation_igv_types", "printer", "printing", "customer_default", "customer_variation", "variation", "establishments", "formVariation", "documentsType", "orden_items", "cash_id", "form", "exchangeRateSale", "is_payment", "soapCompany", "direct_printing", "auth_login", "payments", "configuration", "idOrden", "company", "desarrollador", "percentage_igv", "all_series", "all_customers", "personalWhatsapp", "sellers"],
  watch: {
  ...
  data: function data() {
    return {
      ...
      students: [],
      bank: null,
      hasExceedBank: false // percentage_igv: 18
  ...
  methods: {
    ...
    formatItems: function formatItems() {
      ...
      items = items.map(function (i) {
        ...
        return _objectSpread(_objectSpread({}, i), {}, (_objectSpread2 = {
          ...
          item: i,
          item_id: i.id,
          unit_value: affectation_igv_type_id == 10 ? i.sale_unit_price / (1 + _this2.percentage_igv / 100) : i.sale_unit_price,
          quantity: i.quantity,
          aux_quantity: i.quantity,
          total_base_igv: affectation_igv_type_id == 10 ? i.sale_unit_price * i.quantity / (1 + _this2.percentage_igv / 100) : i.sale_unit_price * i.quantity,
          percentage_igv: _this2.percentage_igv,
          total_igv: affectation_igv_type_id == 10 ? i.sale_unit_price * i.quantity / (1 + _this2.percentage_igv / 100) * (_this2.percentage_igv / 100) : 0,
          total_base_isc: 0.0,
          percentage_isc: 0.0,
          total_isc: 0.0,
          ...
          total_taxes: affectation_igv_type_id == 10 ? i.sale_unit_price * i.quantity / (1 + _this2.percentage_igv / 100) * (_this2.percentage_igv / 100) : 0,
          total_value: affectation_igv_type_id == 10 ? i.sale_unit_price * i.quantity / (1 + _this2.percentage_igv / 100) : i.quantity * i.sale_unit_price,
          total_charge: 0.0,
          total_discount: 0.0,
        ...
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _this3.$http.get("/pos/table/customers").then( /*#__PURE__*/function () {
                    ...
                    return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          case 0:
                            _context2.next = 2;
                            return _this3.$emit("update:all_customers", response.data);

                          case 2:
                            _this3.value = customer_id;
                            _this3.form.customer_id = customer_id;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                //buscar
                if (_this4.time) {
                  clearTimeout(_this4.time);
                }

                _this4.time = setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.mark(function _callee4() {
                  var response, persons;
                  return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee4$(_context4) {
                    while (1) {
                      switch (_context4.prev = _context4.next) {
                        case 0:
                          _this4.input_person.number = _this4.$refs.select_person.$el.getElementsByTagName("input")[0].value;
                          _context4.next = 3;
                          return _this4.$http("/caja/search_customers?value=".concat(_this4.input_person.number));

                        case 3:
                          response = _context4.sent;
                          persons = response.data.persons;
                          _this4.customers = persons.filter(function (n) {
                            return n.number != "88888888";
                          });

                          _this4.updateAllCustomers(_this4.customers);
        ...
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ids = _this5.all_customers.map(function (c) {
                  return c.id;
                });
                persons = [];
                ...
                if (_this5.clientSaleNoteNumber) {
                  newData = personsFromServer;
                } else {
                  newData = [].concat(_toConsumableArray(_this5.all_customers), persons);
                }
                ...
                _context6.next = 9;
                return _this5.$emit("update:all_customers", newData);

              case 9:
                if (newData.length == 1) {
                  _this5.value = newData[0].id;
                  _this5.form.customer_id = newData[0].id;
        ...
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _context7.next = 2;
                return _this6.$http.post("".concat(_this6.resource, "/last_number_documents"), {
                  series: _this6.all_series,
                  ordenId: _this6.idOrden
                });
              ...
              case 2:
                ...
                if (response.status == 200) {
                  _this6.last_number = response.data.result;
                  _this6.refCustomer = response.data.customer;

                  if (_this6.refCustomer != null) {
                    _this6.refCustomer.description = "".concat(_this6.refCustomer.number, " - ").concat(_this6.refCustomer.name);
                    _this6.customers = [_this6.refCustomer].concat(_toConsumableArray(_this6.customers.filter(function (f) {
                      return f.id != _this6.refCustomer.id && f.number != "88888888";
                    })));
                    _this6.value = _this6.refCustomer.id;
                  }
                }
    ...
    teclasInit: function teclasInit() {
      ...
      document.onkeydown = function (e) {
        ...
        if (key == "F7" && _this7.form.items.length > 0) {//Guardar
          // this.submit()
        }
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                // this.form.student_id = null;
                if (!_this8.configuration.restrict_receipt_date) {
                  _this8.form.date_of_issue = moment().format("YYYY-MM-DD");
                }

                documents = _this8.establishments.documents;

                if (documents) {
                  invoice = documents.invoice, sale_note = documents.sale_note, receipt = documents.receipt;
                  _this8.invoice = invoice;
                  _this8.sale_note = sale_note;
                  _this8.receipt = receipt;
                }

                _this8.customers = _this8.all_customers.filter(function (n) {
                  return n.number != "88888888";
                });
                _this8.customers = _toConsumableArray(_this8.customers.filter(function (c) {
                  return c.id != _this8.customer_default.id;
                }));

                if (_this8.form.document_type_id != "01") {
                  _this8.customers = [].concat(_toConsumableArray(_this8.customers), [_this8.customer_default]);
                }

                if (_this8.establishments.customer_id) {
                  isRuc = _this8.checkCustomerDocument("6");

                  if (isRuc && _this8.form.document_type_id != "01") {
                    _this8.value = _this8.establishments.customer_id;
                    _this8.form.customer_id = _this8.establishments.customer_id;
                  }
                }
                ...
                if (_this8.clientSaleNoteNumber) {
                  setTimeout(function () {
                    _this8.$refs.select_person.$el.getElementsByTagName("input")[0].value = _this8.clientSaleNoteNumber;

                    _this8.keyupCustomer();
                  }, 800);
                }

                _this8.checkTotal("01");
        ...
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                qz.security.setCertificatePromise(function (resolve, reject) {
                  _this9.$http.get("/api/qz/crt/override", {
                    responseType: "text"
                  }).then(function (response) {
                    resolve(response.data);
                  })["catch"](function (error) {
                ...
                qz.security.setSignaturePromise(function (toSign) {
                  return function (resolve, reject) {
                    _this9.$http.post("/api/qz/signing", {
                      request: toSign
                    }).then(function (response) {
                      resolve(response.data);
                    })["catch"](function (error) {
            ...
            switch (_context10.prev = _context10.next) {
              case 0:
                ...
                formWhatsapp = {
                  ...
                  sender: "sdrimsac",
                  mensaje: "Su comprobante de pago electrónico " + number + "por S/" + _this10.form.total + " de *" + _this10.establishments.description + "*, ha sido generado correctamente a través del facturador electrónico de " + "*" + _this10.$desarrollador + "*"
                };
                _context10.prev = 3;
                _this10.loading = true;
                _context10.next = 7;
                return _this10.$http.post("/whatsapp", formWhatsapp);
              ...
              case 7:
                ...
                if (!(_this10.configuration.xml_whatsapp && document_type_id != "80")) {
                  _context10.next = 15;
                  break;
                }
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                ...
                _this11.form.payments = _this11.payments; //get with screen size
              ...
              case 10:
                _context11.next = 12;
                return _this11.$refs.observation.$el.getElementsByTagName("textarea")[0].focus();
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                ...
                if (differen < 0 && _this13.form.payment_condition_id == "01") {
          ...
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                ...
                if (!(_this15.hasExceedBank && _this15.form.observation == null || _this15.form.observation == "")) {
                  _context14.next = 11;
                  break;
                }
                ...
                _context14.prev = 3;
                _context14.next = 6;
                return _this15.$confirm("¿Desea continuar sin registrar la bancarización?", "Advertencia", {
              ...
              case 13:
                ...
                if (_this15.conf.pos_quick_sale) {
              ...
              case 18:
                ...
                formVariation.variation_document_id = _this15.documentNewId;
        ...
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee15$(_context15) {
          while (1) {
            switch (_context15.prev = _context15.next) {
              case 0:
                _this16.reCalculateTotal(); // return;


                if (!_this16.form.series_id && _this16.conf.pos_quick_sale || _this16.ordens_all_table) {
                  _this16.setSeries();
                }

                if (!(_this16.configuration.college && !_this16.conf.pos_quick_sale)) {
                  _context15.next = 6;
                  break;
                }

                if (_this16.form.student_id) {
                  _context15.next = 6;
                  break;
                }

                _this16.$toast.error("El alumno es obligatorio");
              ...
              case 6:
                ...
                _this16.$toast.error("El monto total no puede ser menor o igual a 0");
              ...
              case 9:
                ...
                _this16.$toast.error("El monto ingresado no puede ser S/. 200 mayor del Total a cobrar ");
              ...
              case 17:
                ...
                return _context15.abrupt("return", _this16.$toast.error("Elija un cliente"));
              ...
              case 19:
                ...
                return _context15.abrupt("return", _this16.$toast.error("No puede emitir Factura con DNI"));
              ...
              case 21:
                ...
                return _context15.abrupt("return", _this16.$toast.warning("El establecimiento no tiene series disponibles para el comprobante"));
              ...
              case 23:
                ...
                if (!(_this16.form.payment_condition_id == "01")) {
                  _context15.next = 34;
                  break;
                }
              ...
              case 34:
                isOk = _this16.checkPaymentsIsOk();
                ...
                _this16.$toast.error("Las cuotas no coinciden con el total");

                return _context15.abrupt("return");

              case 38:
                if (_this16.form.payment_condition_id !== "01") {
                  form.fee = _this16.currentPayments.map(function (b) {
                    return {
                      id: null,
                ...
                if (!_this16.checkLimitReceipt()) {
                  _context15.next = 42;
                  break;
                }

                _this16.$toast.error("Las boletas mayores a 699 deben tener un dni o ruc válido.");

                return _context15.abrupt("return");

              case 42:
                _this16.loading_submit = true;
                _this16.form.items = _this16.form.items.filter(function (item) {
                  return Number(item.quantity) > 0;
                });

                if (_this16.isConsignment) {
                  _this16.form.from_consignment = true;
                }
                ...
                if (!((ordenId == undefined || ordenId == null) && (form.variation == undefined || form.variation == null) && !_this16.conf.pos_quick_sale && !_this16.ordens_all_table)) {
                  _context15.next = 55;
                  break;
                }

                _context15.next = 51;
                return _this16.$http.post("/caja/worker/send-orden", _this16.orden_items);
              ...
              case 59:
                ...
                _context15.t0 = data.format_printer;
                _context15.next = _context15.t0 === 1 ? 66 : _context15.t0 === 2 ? 68 : 70;
                break;
              ...
              case 72:
                if (_this16.printer && format && _this16.printerOn == 1) {// this.printerDocument(this.printer,format)
                }
                ...
                if (!(_this16.configuration.college && _this16.form.student_id)) {
                  _context15.next = 83;
                  break;
                }

                _context15.next = 82;
                return _this16.$http.post("/college/registers/sale", {
                  is_sale_note: form.document_type_id == "80",
                  document_id: _this16.documentNewId,
                  detail: {
                    items: _this16.form.items.map(function (s) {
                      return s.item;
                    })
                  },
                  student_id: _this16.form.student_id
                });

              case 82:
                registerCollegeResponse = _context15.sent;

              case 83:
                if (!(_this16.configuration.consignment && _this16.consignment_id && _this16.isConsignment)) {
                  _context15.next = 88;
                  break;
                }

                _context15.next = 86;
                return _this16.$http.post("/consignment/liquidated", {
                  id: _this16.consignment_id,
                  items: _this16.form.items.map(function (i) {
                    return {
              ...
              case 86:
                consigmentLiquidate = _context15.sent;

                if (consigmentLiquidate.status == 200) {
                  _this16.$toast.success("Liquidación de consignación realizada.");
                }
              ...
              case 90:
                ...
                if (!_this16.configuration.promotions_sell) {
                  _context15.next = 98;
                  break;
                }

                how_is = _this16.all_customers.find(function (c) {
                  return c.id == form.customer_id;
                });
              ...
              case 97:
                procesarOferta = _context15.sent;
              ...
              case 107:
                ...
                _this16.$emit("removeConsignment");
              ...
              case 122:
                if (_this16.conf.pos_quick_sale) {
                  _this16.$toast.success("Venta realizada.");
                }
              ...
              case 133:
                ...
                _response = _context15.t1.response;
          ...
          while (1) {
            switch (_context16.prev = _context16.next) {
              ...
              case 10:
                ...
                _this17.$toast.error(_context16.t0.message);
