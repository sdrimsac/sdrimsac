          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _this2.loading = true;
                _context2.next = 4;
                return _this2.$http.post("".concat(_this2.resource, "/").concat(_this2.commercialTreatment.id), {
        ...
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _this3.title = _this3.originalTitle + "/" + _this3.commercialTreatment.description;
                _context3.next = 3;
