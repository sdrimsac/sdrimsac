var styleSwitcher = {
    ...
    initialize: function() {
        ...
        this.initialized || (a.options = $.extend({}, a.defaults), String.prototype.capitalize = function() {
            ...
            }, $.styleSwitcherCachedScript("porto-light/master/less/less.js").done(function(c, d) {
                $.ajax({
                    url: "porto-light/master/style-switcher/style.switcher.html"
                }).done(function(c) {
                    $("body").append(c), a.container = $("#styleSwitcher"), a.build(), a.events(), b || (null != $.cookie("layoutStyle") && (a.options.layoutStyle = $.cookie("layoutStyle")), null != $.cookie("backgroundColor") && (a.options.backgroundColor = $.cookie("backgroundColor")), null != $.cookie("headerColor") && (a.options.headerColor = $.cookie("headerColor")), null != $.cookie("sidebarColor") && (a.options.sidebarColor = $.cookie("sidebarColor")), null != $.cookie("sidebarSize") && (a.options.sidebarSize = $.cookie("sidebarSize"))), a.setLayoutStyle(a.options.layoutStyle), a.setBackgroundColor(a.options.backgroundColor), a.setHeaderColor(a.options.headerColor), a.setSidebarColor(a.options.sidebarColor), a.setSidebarSize(a.options.sidebarSize), a.setColors(), a.setBorderRadius(a.options.borderRadius), null == $.cookie("initialized") && (a.container.find("#styleSwitcherOpen").trigger("click"), $.cookie("initialized", !0)), a.initialized = !0
                })
            })
        }), $.styleSwitcherCachedScript("porto-light/master/style-switcher/cssbeautify/cssbeautify.js").done(function(a, b) {}))
    },
    build: function() {
        var a = this,
            b = a.container.find(".color-primary input");
        colorSecondaryField = a.container.find(".color-secondary input"), colorTertiaryField = a.container.find(".color-tertiary input"), colorQuaternaryField = a.container.find(".color-quaternary input"), b.val(a.options.colorPrimary).parent().colorpicker({
            align: "right",
            customClass: "style-switcher-color-picker"
        }), colorSecondaryField.val(a.options.colorSecondary).parent().colorpicker(), colorTertiaryField.val(a.options.colorTertiary).parent().colorpicker(), colorQuaternaryField.val(a.options.colorQuaternary).parent().colorpicker(), $(".colorpicker").on("mousedown", function(b) {
            b.preventDefault(), a.isChanging = !0
        }).on("mouseup", function(c) {
            c.preventDefault(), a.isChanging = !1, a.options.colorPrimary = b.val(), a.options.colorSecondary = colorSecondaryField.val(), a.options.colorTertiary = colorTertiaryField.val(), a.options.colorQuaternary = colorQuaternaryField.val(), a.setColors()
        }), $(".colorpicker-element input").on("blur", function(c) {
            a.options.colorPrimary = b.val(), a.options.colorSecondary = colorSecondaryField.val(), a.options.colorTertiary = colorTertiaryField.val(), a.options.colorQuaternary = colorQuaternaryField.val(), a.setColors()
    ...
    setColors: function(a, b) {
        ...
        a && (c.options["color" + b.capitalize()] = a, c.container.find(".color-" + b + " input").val(a)), c.options.preserveCookies || ($.cookie("colorPrimary", c.options.colorPrimary.replace("#", "")), $.cookie("colorSecondary", c.options.colorSecondary.replace("#", "")), $.cookie("colorTertiary", c.options.colorTertiary.replace("#", "")), $.cookie("colorQuaternary", c.options.colorQuaternary.replace("#", ""))), c.modifyVars(), this.setLogo()
    },
    ...
    setBackgroundColor: function(a) {
        this.options.preserveCookies || $.cookie("backgroundColor", a), this.options.saveToStorage && "undefined" != typeof localStorage && localStorage.setItem("backgroundColor", a);
        var b = this.container.find(".options-links.background-color");
        b.find(".active").removeClass("active"), b.find("a[data-background-color=" + a + "]").addClass("active"), "dark" == a ? ($("html").addClass("dark"), $("#addDarkClassInfo").show()) : ($("html").removeClass("dark"), $("#addDarkClassInfo").hide()), $.event.trigger({
            type: "styleSwitcher.setBackgroundColor",
            color: a
        }), this.setLogo()
    },
    setHeaderColor: function(a) {
        this.options.preserveCookies || $.cookie("headerColor", a), this.options.saveToStorage && "undefined" != typeof localStorage && localStorage.setItem("headerColor", a);
        var b = this.container.find(".options-links.header-color");
        b.find(".active").removeClass("active"), b.find("a[data-header-color=" + a + "]").addClass("active"), "dark" == a ? ($("html").addClass("header-dark"), $("#addHeaderDarkClassInfo").show()) : ($("html").removeClass("header-dark"), $("#addHeaderDarkClassInfo").hide()), $.event.trigger({
            type: "styleSwitcher.setHeaderColor",
            color: a
        })
    },
    setSidebarColor: function(a) {
        this.options.preserveCookies || $.cookie("sidebarColor", a), this.options.saveToStorage && "undefined" != typeof localStorage && localStorage.setItem("sidebarColor", a);
        var b = this.container.find(".options-links.sidebar-color");
        b.find(".active").removeClass("active"), b.find("a[data-sidebar-color=" + a + "]").addClass("active"), "light" == a ? ($("html").addClass("sidebar-light"), $("#addSidebarLightClassInfo").show()) : ($("html").removeClass("sidebar-light"), $("#addSidebarLightClassInfo").hide()), $.event.trigger({
            type: "styleSwitcher.setSidebarColor",
            color: a
        })
    },
    setLayoutStyle: function(a, b) {
        if (this.options.preserveCookies || $.cookie("layoutStyle", a), this.options.saveToStorage && "undefined" != typeof localStorage && localStorage.setItem("layout", a), b) return $.cookie("showSwitcher", !0), window.location.reload(), !1;
        var c = this.container.find(".options-links.layout");
        c.find(".active").removeClass("active"), c.find("a[data-layout-type=" + a + "]").addClass("active"), "wide" == a ? ($("html").removeClass("boxed"), $("#addBoxedClassInfo").hide()) : ($("html").addClass("boxed").removeClass("fixed"), $("#addBoxedClassInfo").show()), $.event.trigger({
    ...
    setLogo: function(a) {
        ...
        a || ("#" + $.cookie("colorPrimary")).toUpperCase() == this.defaults.colorPrimary.toUpperCase() && "dark" != $.cookie("backgroundColor") ? b.attr("src", "img/logo-default.png") : "dark" == $.cookie("backgroundColor") || "dark" == $.cookie("headerColor") ? b.attr("src", "img/logo-light.png") : b.attr("src", "img/logo.png"), $.event.trigger({
            type: "styleSwitcher.setLogo"
        })
    },
    modifyVars: function() {
        var a = this;
        window.clearTimeout(a.timer), a.timer = window.setTimeout(function() {
            less.modifyVars({
                "@border-radius": a.options.borderRadius,
                "@color-primary": a.options.colorPrimary,
                "@color-secondary": a.options.colorSecondary,
                "@color-tertiary": a.options.colorTertiary,
                "@color-quaternary": a.options.colorQuaternary
            }), a.options.saveToStorage && "undefined" != typeof localStorage && localStorage.setItem("skin-admin.css", $('style[id^="less:"]').text()), $.event.trigger({
