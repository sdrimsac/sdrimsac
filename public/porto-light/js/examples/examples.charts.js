		...
		if( $('#gaugeBasic').get(0) ) {
			var target = $('#gaugeBasic'),
				opts = $.extend(true, {}, {
					...
					colorStart: '#409EFF', // Colors
					colorStop: '#409EFF', // just experiment with them
	...
	*/
	...
	if( $('#meter, #meterDark').get(0) ) {
		...
		if (typeof($.browser) != 'undefined') {
			if($.browser.mobile) {
				$('#meter, #meterDark').liquidMeter('color', '#409EFF');
			}
		}
	}
