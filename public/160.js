            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _this.$msgbox({
                  ...
                  }, "".concat(_this.difference == 0 ? "¿Está seguro de cerrar la caja?" : "¿Está seguro de cerrar la caja,  sin realizar el conteo en efectivo?"))]),
                  showCancelButton: true,
                  confirmButtonText: "Aceptar",
                  cancelButtonText: "Cancelar",
                  beforeClose: function () {
                    var _beforeClose = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.mark(function _callee(action, instance, done) {
                        ...
                        while (1) {
                          switch (_context.prev = _context.next) {
                            case 0:
                              ...
                              instance.confirmButtonText = "Cerrando..."; //  console.log(this.count);

                              _context.next = 5;
                              return _this.createRegister(instance, done);
                    ...
                    function beforeClose(_x, _x2, _x3) {
