...
var ConsignmentForm = function ConsignmentForm() {
  return __webpack_require__.e/* import() */(193).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/consignment_modal.vue"));
};

var QuotationForm = function QuotationForm() {
  return __webpack_require__.e/* import() */(180).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/quotation_modal.vue"));
};

var CreditForm = function CreditForm() {
  return __webpack_require__.e/* import() */(191).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/credit_modal.vue"));
};

var CashForm = function CashForm() {
  return __webpack_require__.e/* import() */(196).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/cash/form.vue"));
};

var CloseCash = function CloseCash() {
  return __webpack_require__.e/* import() */(161).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/cash/closecash.vue"));
};

var OrdenPullApart = function OrdenPullApart() {
  return __webpack_require__.e/* import() */(183).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/ordens_pull_apart.vue"));
};

var TableOrdensPending = function TableOrdensPending() {
  return __webpack_require__.e/* import() */(186).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/list_pending_ordens.vue"));
};

var ObservationForm = function ObservationForm() {
  return __webpack_require__.e/* import() */(160).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/partials/observation_form.vue"));
};

var ExpensesIncomes = function ExpensesIncomes() {
  return __webpack_require__.e/* import() */(150).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/expenses_incomes.vue"));
};

var ShowSeriesProduct = function ShowSeriesProduct() {
  return __webpack_require__.e/* import() */(178).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/show_series_product.vue"));
};

var ShowLotesProduct = function ShowLotesProduct() {
  return __webpack_require__.e/* import() */(179).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/show_lotes_product.vue"));
};

var TransfersModal = function TransfersModal() {
  return __webpack_require__.e/* import() */(175).then(__webpack_require__.bind(null, "./modules/Restaurant/Resources/assets/js/views/pos/partials/transfer_modal.vue"));
};
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    clearCommercialTreatment: function clearCommercialTreatment() {
    ...
    getCommercialTreatment: function getCommercialTreatment() {
      var _this2 = this;

      if (this.commercialTreatmentId) {
        var commercialTreatment = this.commercialTreatments.find(function (c) {
          return c.id == _this2.commercialTreatmentId;
        });

        if (commercialTreatment) {
          var commercial_treatment_categories = commercialTreatment.commercial_treatment_categories;

          if (commercial_treatment_categories.length > 0) {
            var is_amount = commercialTreatment.is_amount == 1;

            var ordens = _toConsumableArray(this.localOrden);

            ordens.forEach(function (orden) {
              var category = orden.food.category;
              ...
              var price = orden.original_price;
              var factor = commercial_treatment_categories.find(function (c) {
                return c.category_item_id == category_id;
              });

              if (factor) {
                var amount = Number(factor.amount);
    ...
    getCommercialTreatments: function getCommercialTreatments() {
      var _this3 = this;

      this.$http.get("/commercial_treatment/records?all=true").then(function (res) {
        _this3.commercialTreatments = res.data;
        console.log("🚀 ~ file: list_ordens.vue:2419 ~ getCommercialTreatments ~ this.commercialTreatments:", _this3.commercialTreatments);
      })["catch"](function (err) {
        console.log(err);
      });
    },
        ...
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                conf = _this4.establishments.conf;
                _context2.prev = 1;
                _context2.next = 4;
                return _this4.$http.post("/establishments/update_conf", _objectSpread({}, conf));
        ...
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return _this5.$http("../observations/records");
        ...
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.prev = 0;
                _this7.deleteOrdenLoading = true;
                id = _this7.ordens[0].orden_id;
                form = {
                  id: id,
                  pin: _this7.pin,
                  reason: _this7.reasonToDelete
                };
                _context5.next = 6;
                return _this7.$http.post("cancel-orden", form);
              ...
              case 6:
                ...
                if (response.status == 200) {
                  ...
                  if (success) {
                    _this7.$toast.success(message);

                    _this7.$eventHub.$emit("reloadData");

                    _this7.$emit("ordenDeleted");

                    _this7.deleteGeneralOrden = false;
                    _this7.showPinRequest = false;
                    _this7.reasonToDelete = null;

                    _this7.directSale();
                  } else {
                    _this7.$toast.error(message);
                  }
                }
              ...
              case 13:
                _context5.prev = 13;
                _this7.pin = "";
                _this7.deleteOrdenLoading = false;
        ...
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                if (!_this8.configuration.pin_orden_delete) {
                  _context6.next = 4;
                  break;
                }

                _this8.cancelGeneralOrdenPin();
              ...
              case 4:
                _context6.prev = 4;
                _context6.next = 7;
                return _this8.$confirm("Desea cancelar toda la orden?", "Cancelar", {
              ...
              case 7:
                ...
                _context6.next = 13;
                return _this8.$http.post("cancel-orden", form);
              ...
              case 13:
                ...
                if (response.status == 200) {
                  ...
                  _this8.$toast.success(message);

                  _this8.$eventHub.$emit("reloadData");

                  _this8.$emit("ordenDeleted");
              ...
              case 17:
                ...
                if (_context6.t0 != "cancel") {
                  ...
                  _this8.$toast.error("Ocurrió un error");
                }
    ...
    allToCarry: function allToCarry() {
      ...
      ord = ord.map(function (o) {
        ...
        var factor = _this9.to_carry ? 1 : -1;
        ...
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _this10.ordenLoading = true;
                _context7.prev = 1;
                _context7.next = 4;
                return _this10.printTicket(_this10.clientTableData.orden_id);
              ...
              case 6:
                ...
                _this10.$toast.error("No se pudo imprimir");

              case 9:
                _context7.prev = 9;
                _this10.ordenLoading = false;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 3:
                orden = {
                  status_orden_id: 1,
                  table_id: _this11.clientTableData.table_id,
                  to_carry: _this11.to_carry
                };
                _this11.ordenLoading = true;
                _context8.prev = 5;
                _context8.next = 8;
                return _this11.$http.post("/caja/worker/send-orden", {
                  id: _this11.clientTableData.orden_id,
                  ref: _this11.clientTableData.ref,
                  items: _this11.localOrden,
                  caja: true,
                  printing: true,
                  saleDirect: false,
                  orden: orden
              ...
              case 8:
                ...
                _this11.$toast.warning("Ocurrió un error");

                return _context8.abrupt("return");

              case 14:
                _this11.to_carry = false;

                _this11.$emit("cancelOrden");

                _this11.$emit("update:isCreatingOrden", false);

                msg = "";

                if (_this11.clientTableData.orden_id) {
                  msg = "Se agregaron los pedidos a la orden ".concat(ordenId);
                } else {
                  msg = "La orden ".concat(ordenId, " fue creada.");
                }

                _this11.$toast.success(msg);
              ...
              case 22:
                ...
                _this11.ordenLoading = false; //no jala el clientdata tble - ref // lo guarda con el id mesa caja

                _this11.$toast.error("Ocurrió un error");
        ...
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                _context9.next = 2;
                return _this12.$http("/caja/tables/check");
        ...
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 3:
                if (!_this13.cash_id) {
                  _this13.$toast.error("Abra una caja");
                } else {
                  _this13.showExpensesIncomes = true;
                }

                return _context10.abrupt("break", 38);

              case 5:
                _this13.showTransfers();
              ...
              case 7:
                ...
                if (!_this13.configuration.ordens_cash) {
                  _context10.next = 28;
                  break;
                }

                _context10.next = 11;
                return _this13.checkTables();
              ...
              case 16:
                ...
                _context10.prev = 17;
                _context10.next = 20;
                return _this13.$confirm("Existen ".concat(ordenes, " ordenes pendientes por cobrar, con un total de ").concat(total, " soles. Desea emitir una nota de venta por el total?"), "Cerrar Caja", {
              ...
              case 20:
                _this13.$emit("sendOrdensAllTables", items);
              ...
              case 31:
                _this13.showDialogCash = true;

              case 32:
                return _context10.abrupt("break", 38);

              case 33:
                _this13.showOrdensPending();

                return _context10.abrupt("break", 38);

              case 35:
                if (_this13.ordenInBox.length > 0) {
                  _this13.listApart = true;
                } else {
                  _this13.$toast.warning("Sin ventas apartacadas.");
                }
    ...
    pullApartOrden: function pullApartOrden() {
      ...
      if (!this.numberCustomerApart && this.numberCustomerApart.length <= 1) {
        ...
        return f.ref.toLowerCase() == _this14.numberCustomerApart.toLowerCase();
      })) {
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                _context11.prev = 0;
                _context11.next = 3;
                return _this15.$confirm("Desea cancelar este pedido?", "Cancelar", {
                  confirmButtonText: "Ok",
                  cancelButtonText: "Cancelar",
                  type: "warning"
                });
              ...
              case 3:
                ...
                if (res) {
                  _this15.isConsignment = false;

                  _this15.$emit("cancelOrden");
                }
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                _context12.prev = 0;
                _context12.next = 3;
                return _this16.$http.get("/caja/worker/record/".concat(id));
              ...
              case 13:
                ...
                _this16.$toast.error(_context12.t0.message);
        ...
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee13$(_context13) {
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                if (!_this17.checkIsExistSerie()) {
                  _context13.next = 3;
                  break;
                }

                _this17.$toast.error("Producto sin serie seleccionada");
              ...
              case 3:
                ...
                _this17.$toast.error("No tiene una caja abierta");

                return _context13.abrupt("return");

              case 6:
                if (!_this17.clientTableData.table) {
                  _context13.next = 12;
                  break;
                }

                if (!(_this17.ordens.length == 0)) {
                  _context13.next = 10;
                  break;
                }

                _this17.$toast.warning("Orden sin productos");
              ...
              case 12:
                if (!(_this17.localOrden.length == 0 && !_this17.variation)) {
                  _context13.next = 15;
                  break;
                }
              ...
              case 15:
                _this17.disableSend = true;
                form_submit = {
                  id: null,
                  caja: true,
                  printDocument: _this17.printing,
                  printing: _this17.configuration.print_commands,
                  commands_fisico: _this17.commands_fisico,
                  print_kitchen: _this17.configuration.print_kitchen,
                  to_carry: _this17.to_carry,
                  orden: {
                    table_id: 1,
                    status_orden_id: 1
                  },
                ...
                if (_this17.clientTableData.table) {
                  form_submit.items = _this17.ordens;
                } else {
                  form_submit.items = _this17.localOrden;
                }

                form_submit.items = _this17.mergeItems(form_submit.items);
                _this17.loading = true;
                _this17.commands_fisico = "";
                _this17.to_carry = false;
                _this17.loading = false;
                _this17.disableSend = false;

                if (_this17.variation) {
                  form_submit.variationItems = _this17.foodDefaults;
                }
                ...
                if (_this17.variation) {
                  _this17.$emit("paymentsOrden", form_submit, _this17.foodDefaults);
                } else {
                  _this17.$emit("paymentsOrden", form_submit);
                }
        ...
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee15$(_context15) {
          while (1) {
            switch (_context15.prev = _context15.next) {
              case 0:
                if (!(_this19.pin.length > 3 && _this19.reasonToDelete)) {
                  _context15.next = 23;
                  break;
                }

                if (!_this19.deleteGeneralOrden) {
                  _context15.next = 5;
                  break;
                }

                _this19.deleteGeneralOrdenPin();
              ...
              case 5:
                _context15.prev = 5;
                _this19.deleteOrdenLoading = true;
                _context15.next = 9;
                return _this19.$http.post("delete-orden-pin", {
                  id: _this19.ordenIdToDelete,
                  pin: _this19.pin,
                  reason: _this19.reasonToDelete
                });
              ...
              case 9:
                ...
                if (response.status == 200) {
                  if (response.data.success) {
                    message = response.data.message;
                    newOrdenItems = _toConsumableArray(_this19.ordens);
                    newOrdenItems = newOrdenItems.filter(function (n) {
                      return n.id != _this19.ordenIdToDelete;
                    });

                    _this19.$emit("update:ordens", newOrdenItems);

                    _this19.$eventHub.$emit("reloadData");

                    _this19.$toast.success(message);

                    _this19.reasonToDelete = null;
                    _this19.showPinRequest = false;
                  } else {
              ...
              case 17:
                _context15.prev = 17;
                _this19.pin = "";
                _this19.deleteOrdenLoading = false;
              ...
              case 23:
                _this19.$toast.error("Ingrese el pin");
        ...
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee16$(_context16) {
          while (1) {
            switch (_context16.prev = _context16.next) {
              case 0:
                if (!_this20.configuration.pin_orden_delete) {
                  _context16.next = 5;
                  break;
                }

                _this20.showPinRequest = true;
                _this20.ordenIdToDelete = id;
                _context16.next = 20;
                break;
              ...
              case 5:
                _context16.prev = 5;
                _context16.next = 8;
                return _this20.$confirm("Est\xE1 apunto de cancelar un producto de una orden.", "Mensaje de Advertencia", {
              ...
              case 8:
                ...
                _context16.next = 12;
                return _this20.$http["delete"]("delete-orden/".concat(id));
              ...
              case 12:
                ...
                if (response.status == 200) {
                  ...
                  _this20.$emit("update:ordens", newOrdenItems);

                  _this20.$eventHub.$emit("reloadData");

                  _this20.$toast.success(message);
                }
              ...
              case 16:
                ...
                if (_context16.t0 != "cancel") {
                  _this20.$toast.error("Ocurrió un error");
                }
          ...
          while (1) {
            switch (_context17.prev = _context17.next) {
              case 0:
                ...
                _context17.prev = 1;
                _context17.next = 4;
                return _this21.$http.get("ordens-ready/".concat(id));

              case 4:
                response = _context17.sent;
                _response$data2 = response.data, success = _response$data2.success, message = _response$data2.message;
                success ? _this21.$toast.success(message) : _this21.$toast.error(message);

                if (success) {
                  cloneOrdenItems = _toConsumableArray(_this21.ordens);
                  ...
                  _this21.$emit("update:ordens", cloneOrdenItems);
                }
              ...
              case 10:
                ...
                _this21.$toast.error("Ocurrió un error");
          ...
          while (1) {
            switch (_context18.prev = _context18.next) {
              case 0:
                ...
                _this22.loadingObservation = true;
                _context18.next = 3;
                return _this22.$http.post("change-observation", {
                  observation: _this22.observation,
                  id: _this22.currentOrden
                });
              ...
              case 3:
                ...
                if (response.status == 200) {
                  _this22.$eventHub.$emit("reloadData");

                  newOrdenItems = _toConsumableArray(_this22.ordens);
                  newOrdenItems.find(function (n) {
                    return n.id == _this22.currentOrden;
                  }).observations = _this22.observation;
                }

                _this22.loadingObservation = false;

                _this22.closeObservationDialog();
          ...
          _c("div", { staticClass: "d-flex align-items-center p-1 m-2" }, [
            _c(
              ...
              [
                ...
                _vm._v(" "),
                _vm.commercialTreatments.length > 0
                  ? [
                      _c(
                        "el-select",
                        {
                          ...
                          on: {
                            change: _vm.getCommercialTreatment,
                            clear: _vm.clearCommercialTreatment
                          },
                          model: {
                            value: _vm.commercialTreatmentId,
                            callback: function($$v) {
                              _vm.commercialTreatmentId = $$v
                            },
                            expression: "commercialTreatmentId"
                          }
                        },
                        _vm._l(_vm.commercialTreatments, function(item, index) {
                          return _c("el-option", {
                            key: index,
