...
class DentalNew extends Migration
{
    ...
    public function up()
    {
        ...
        if (!Schema::hasTable('disease_types')) {
        ...
        if (!Schema::hasTable('physical_exploration')) {
        ...
        if (!Schema::hasTable('allergies_types')) {
        ...
        if (!Schema::hasTable('diagnosis_types')) {
