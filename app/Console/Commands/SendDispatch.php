...
class SendDispatch extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:dispatches';
     ...
     * @var string
     */
    protected $description = 'Enviar las guias';
        ...
        if (Configuration::firstOrFail()->cron) {
            ...
            foreach ($documents as $document) {
                ...
                curl_setopt_array($curl, array(
                    CURLOPT_URL => "https://{$hostname->fqdn}".'/service/dispatch/send/'.$document->external_id,
