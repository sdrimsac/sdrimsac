...
class ViewServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        view()->composer(
            'tenant.layouts.worker',
            'App\Http\ViewComposers\Tenant\CompanyViewComposer'
        );
        view()->composer(
            'tenant.layouts.restaurant',
            'App\Http\ViewComposers\Tenant\CompanyViewComposer'
        );
        view()->composer(
            'tenant.layouts.pos',
        ...
        view()->composer(
            'tenant.layouts.partials.sidebar_pos',
            'App\Http\ViewComposers\Tenant\UserViewComposer'
        );
        view()->composer(
            'tenant.layouts.partials.header',
        ...
        view()->composer(
            'tenant.layouts.partials.header_pos',
            'App\Http\ViewComposers\Tenant\UserViewComposer'
        );
        view()->composer(
            'tenant.layouts.partials.sidebar',
