        ...
        Inventory::created(function ($inventory) {
            ...
            switch ($inventory->type) {
                case 1:
                    ...
                    $inventory_kardex_initial = $this->saveInventoryKardex($inventory, $inventory->item_id, null, $inventory->quantity, $inventory->warehouse_id, $date_of_issue);
                ...
                case 2:
                    ...
                    //partida
                    $inventory_kardex_exit = $this->saveInventoryKardex($inventory, $inventory->item_id, null, -$inventory->quantity, $inventory->warehouse_id, $date_of_issue);
                    $this->updateStock($inventory->item_id, null, -$inventory_kardex_exit->quantity, true, $inventory->warehouse_id);


                    //destino
                    $inventory_kardex_entry = $this->saveInventoryKardex($inventory, $inventory->item_id, null, $inventory->quantity, $inventory->warehouse_destination_id, $date_of_issue);
                ...
                case 3:
                    ...
                    $inventory_kardex_remove = $this->saveInventoryKardex($inventory, $inventory->item_id, null, -$inventory->quantity, $inventory->warehouse_id, $date_of_issue);
