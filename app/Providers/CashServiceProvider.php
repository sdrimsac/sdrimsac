...
class CashServiceProvider extends ServiceProvider
{
    ...
    private function expense_payment(){
        ...
        \Modules\Expense\Models\ExpensePayment::created(function ($expense_payment) {
            ...
            if($expense_payment->expense_method_type_id === 1){
                ...
                if(!$cash){
                    throw new Exception("Para el método de gasto usado, primero debe aperturar caja general");
                }
