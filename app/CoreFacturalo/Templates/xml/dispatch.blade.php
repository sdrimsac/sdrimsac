...
<DespatchAdvice xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema"
    ...
    <cbc:DespatchAdviceTypeCode listURI="urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo01" listName="Tipo de Documento"
    ...
    <cac:DespatchSupplierParty>
        <cac:Party>
            <cac:PartyIdentification>
                <cbc:ID schemeURI="urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo06" schemeAgencyName="PE:SUNAT"
                    schemeName="Documento de Identidad" schemeID="6">{{ $document['company_number'] }}</cbc:ID>
            </cac:PartyIdentification>
    ...
    <cac:Shipment>
        ...
        <cbc:ID>1</cbc:ID>
        <!-- MOTIVO DEL TRASLADO -->
        <cbc:HandlingCode listURI="urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo20" listName="Motivo de traslado"
        ...
        <cac:ShipmentStage>
            ...
            <cbc:TransportModeCode listURI="urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo18"
                listName="Modalidad de traslado" listAgencyName="PE:SUNAT">{{ $document['transport_mode_type_id'] }}</cbc:TransportModeCode>
                ...
                <cac:CarrierParty>
                    <cac:PartyIdentification>
                        <cbc:ID schemeURI="urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo06"
                            schemeAgencyName="PE:SUNAT" schemeName="Documento de Identidad"
                    ...
                    <cac:PartyLegalEntity>
                        ...
                        <cbc:RegistrationName>
                            <![CDATA[{{ $document['dispatcher_name'] }}]]></cbc:RegistrationName>
        ...
        <cac:Delivery>
            ...
            <cac:DeliveryAddress>
                ...
                @if ($document['customer_identity_document_type_id'] === '6')
                    <cbc:AddressTypeCode listAgencyName="PE:SUNAT" listName="Establecimientos anexos"
                        listID="{{ $document['customer_number'] }}">0000</cbc:AddressTypeCode>
                @endif
                <cac:AddressLine>
                    <cbc:Line>
                        <![CDATA[{{ $document['delivery_address'] }}]]></cbc:Line>
                </cac:AddressLine>
            </cac:DeliveryAddress>
            <cac:Despatch>
                ...
                <cac:DespatchAddress>
                    ...
                    <cbc:AddressTypeCode listName="Establecimientos anexos" listAgencyName="PE:SUNAT"
    ...
    @foreach ($document['items'] as $row)
        <cac:DespatchLine>
            ...
            <cbc:DeliveredQuantity unitCode="{{ $row['unit_type_id'] }}"
                unitCodeListAgencyName="United Nations Economic Commission for Europe" unitCodeListID="UN/ECE rec 20">{{ $row['quantity'] }}</cbc:DeliveredQuantity>
