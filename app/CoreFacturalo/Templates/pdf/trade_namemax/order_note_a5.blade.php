...
<body>
<table class="full-width" style="margin-top:15px !important; ">
    <tr>
        @if($company->logo)
            <td width="20%">
                <div class="company_logo_box">
                    <img src="data:{{mime_content_type(public_path("storage/uploads/logos/{$company->logo}"))}};base64, {{base64_encode(file_get_contents(public_path("storage/uploads/logos/{$company->logo}")))}}" alt="{{$company->trade_name}}" class="company_logo" style="max-width: 200px;">
                </div>
            </td>
        @else
            <td width="20%">
        ...
        <td width="30%" class="border-box py-4 px-2 text-center">
            <h5 class="text-center">NOTA DE PEDIDO</h5>
...
<table class="full-width mt-5">
    ...
    <tr>
        ...
        <td class="align-top">Telefonos:</td>
...
<table class="full-width mt-10 mb-10">
    <thead class="">
    <tr class="bg-grey">
        <th class="border-top-bottom text-center py-2" width="9%">CANT.</th>
        <th class="border-top-bottom text-center py-2" width="10%">UNIDAD</th>
        <th class="border-top-bottom text-left py-2">DESCRIPCIÓN</th>
        <th class="border-top-bottom text-right py-2" width="11%">P.UNIT</th>
        <th class="border-top-bottom text-right py-2" width="8%">DTO.</th>
        <th class="border-top-bottom text-right py-2" width="11%">TOTAL</th>
    </tr>
    </thead>
    <tbody>
