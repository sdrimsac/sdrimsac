...
<body>
    ...
    @if ($is_chifa_china)
    <div class="text-center company_logo_ticket" style="padding-top:2rem;width: 400px;">    
        @if ($stablishment->document_logo)
        <img src="data:{{ mime_content_type(public_path("storage/uploads/logos/{$stablishment->document_logo}")) }};base64, {{ base64_encode(file_get_contents(public_path("storage/uploads/logos/{$stablishment->document_logo}"))) }}" alt="{{ $company->trade_name }}" class="
        contain" style=" max-width: 400px;max-height: 150px">
        @else
        <img src="data:{{ mime_content_type(public_path("storage/uploads/logos/{$stablishment->logo}")) }};base64, {{ base64_encode(file_get_contents(public_path("storage/uploads/logos/{$stablishment->logo}"))) }}" alt="{{ $company->trade_name }}" class="
        contain" style=" max-width: 400px;max-height: 150px">
        @endif
    </div>
    @else
    <div class="text-center company_logo_ticket">
        @if ($stablishment->document_logo)
        <img src="data:{{ mime_content_type(public_path("storage/uploads/logos/{$stablishment->document_logo}")) }};base64, {{ base64_encode(file_get_contents(public_path("storage/uploads/logos/{$stablishment->document_logo}"))) }}" alt="{{ $company->trade_name }}" class="company_logo_ticket contain">
        @else
        <img src="data:{{ mime_content_type(public_path("storage/uploads/logos/{$stablishment->logo}")) }};base64, {{ base64_encode(file_get_contents(public_path("storage/uploads/logos/{$stablishment->logo}"))) }}" alt="{{ $company->trade_name }}" class="company_logo_ticket contain">
        @endif
    </div>
    @endif
    @else
    @if ($company->logo)
    @if ($is_chifa_china)
    <div class="text-center company_logo_ticket" style="padding-top:1rem;width: 400px;">
        @if ($company->document_logo)
        <img src="data:{{ mime_content_type(public_path("storage/uploads/logos/{$company->document_logo}")) }};base64, {{ base64_encode(file_get_contents(public_path("storage/uploads/logos/{$company->document_logo}"))) }}" alt="{{ $company->trade_name }}" class="
        contain" style=" max-width: 400px;max-height: 150px">
        @else
        <img src="data:{{ mime_content_type(public_path("storage/uploads/logos/{$company->logo}")) }};base64, {{ base64_encode(file_get_contents(public_path("storage/uploads/logos/{$company->logo}"))) }}" alt="{{ $company->trade_name }}" class="
        contain" style=" max-width: 400px;max-height: 150px">
        @endif
    </div>
    @else
    <div class="text-center company_logo_ticket">
        @if ($company->document_logo)
        <img src="data:{{ mime_content_type(public_path("storage/uploads/logos/{$company->document_logo}")) }};base64, {{ base64_encode(file_get_contents(public_path("storage/uploads/logos/{$company->document_logo}"))) }}" alt="{{ $company->trade_name }}" class="company_logo_ticket contain">
        @else
        <img src="data:{{ mime_content_type(public_path("storage/uploads/logos/{$company->logo}")) }};base64, {{ base64_encode(file_get_contents(public_path("storage/uploads/logos/{$company->logo}"))) }}" alt="{{ $company->trade_name }}" class="company_logo_ticket contain">
        @endif
    </div>
    @endif
    @endif
    ...
    <!-- NUEVO TITULO PARA LA BOLETA  -->
        <tr>
            <td class="border_redondeado text-center">
                <h6>{{ $document->document_type->description }}</h6>
            </td>
        </tr>
        <tr>
    ...
    <table class="full-width" style="margin-left:15px;margin-right:15px;">
        ...
        <tr>
            <td class="desc pt-2">
                <strong>Vendedor: </strong>{{ $document->user->name }}</td>
    ...
    <table class="full-width" style="margin-left:15px;margin-right:15px;">
            <tr>
                <td class="text-center" style="vertical-align: top;"><img style="width: 80px;" src="data:image/png;base64, {{ $document->qr }}" /></td>
            </tr>
    </table>
