...
if ($document_base) {
$affected_document_number = $document_base->affected_document ? $document_base->affected_document->series . '-' .
str_pad($document_base->affected_document->number, 8, '0', STR_PAD_LEFT) :
$document_base->data_affected_document->series . '-' . str_pad($document_base->data_affected_document->number, 8, '0',
STR_PAD_LEFT);
} else {
    ...
    <div>
                ...
                <table class="logo">
                    <tr>
                        ...
                        <td width="60%" height="20px">
                            <div>
                                ...
                                <img src="data:{{ mime_content_type(public_path("storage/uploads/logos/{$stablishment->document_logo}")) }};base64, {{ base64_encode(file_get_contents(public_path("storage/uploads/logos/{$stablishment->document_logo}"))) }}" alt="{{ $company->trade_name }}" class="company_logo" style="max-width: 230px;">
                                @else
                                <img src="data:{{ mime_content_type(public_path("storage/uploads/logos/{$stablishment->logo}")) }};base64, {{ base64_encode(file_get_contents(public_path("storage/uploads/logos/{$stablishment->logo}"))) }}" alt="{{ $company->trade_name }}" class="company_logo" style="max-width: 230px;">
                                @endif
                            </div>
                        </td>
                        @else
                        ...
                        <td width="60%" height="20px">
                            <div>
                                ...
                                <img src="data:{{ mime_content_type(public_path("storage/uploads/logos/{$company->document_logo}")) }};base64, {{ base64_encode(file_get_contents(public_path("storage/uploads/logos/{$company->document_logo}"))) }}" alt="{{ $company->trade_name }}" class="company_logo" style="max-width: 230px;">
                                @else
                    ...
                    <tr>
                        <td class="text-center">
                            ...
                            <h5>{{ $establishment->telephone !== '-' ? 'Cel.:' . $establishment->telephone : '' }} / {{ $establishment->email !== '-' ? 'Email: ' . $establishment->email : '' }} </h5>
        ...
        <table>
            <tr>
                ...
                <td class="font-bold">
                    <p><strong>{{ $customer->identity_document_type->description }} </strong>{{ $customer->number }}</p>
                </td>
            </tr>
            <tr>
                <td class="font-bold">
        ...
        <div class="mt-3">
            <table class="full-width bordes_impuesto">
                <tr>
                    ...
                    ><b>O. DE COMPRA</b></td>
                    <td  class="border-top-bottom text-center py-2 bordes  text-center" 
                    ><b>FECHA DE EMISIÓN</b></td>
                    <td  class="border-top-bottom text-center py-2 bordes  text-center" 
                    ><b>FECHA VCTO.</b></td>
                    <td  class="border-top-bottom text-center py-2 bordes  text-center" 
                    ><b>GUIA N°</b></td>
                ...
                <td>
                    <table class="table">
                        <tr>
                            ...
                            <td class="border-top-bottom text-center py-2 bordes text-center observation-container" colspan="3">
            ...
            <tr>
                <td width="50%">
                    <table class="full-width bordes_impuesto">
                        ...
                        <tr>
                            <td class="border-top-bottom text-center py-2 bordes  text-center desc-11" width="14px" height="20px">
                                EMPRESA
                            </td>
                            <td class="border-top-bottom text-center py-2 bordes  text-center font-bold" width="14px" height="20px">
                                {{ $company->trade_name }}
                            </td>
                        </tr>
                        @foreach ($accounts as $account)
                        <tr>
                            <td class="border-top-bottom text-center py-2 bordes  text-center desc-11" width="14px" height="20px">BANCO:</td>
                            <td class="border-top-bottom text-center py-2 bordes  text-center font-bold background-color: blue;" width="14px" height="20px">{{ $account->description }}</td>
                        </tr>
                        <tr>
                            <td class="border-top-bottom text-center py-2 bordes  text-center desc-11" width="14px" height="20px">CTA CTE EN {{ $account->currency_type_id }} </td>
                            <td class="border-top-bottom text-center py-2 bordes  text-center font-bold" width="14px" height="20px"> {{ $account->number }}</td>
                        </tr>
                        <tr>
                            <td class="border-top-bottom text-center py-2 bordes  text-center desc-11" width="14px" height="20px">CTA CTE CCI EN {{ $account->currency_type_id }} </td>
                            <td class="border-top-bottom text-center py-2 bordes  text-center font-bold" width="14px" height="20px">{{ $account->cci }}</td>
                        </tr>
                        @endforeach
                    </table>
                </td>
                <td>
                    <img src="data:image/png;base64, {{ $document->qr }}" style="margin-right: -10px; padding: 10px;" width="90px" height="90px" />
                    <!-- <table>
                        <tr>
                ...
                <td width="30%" valign="top">
                    ...
                    <table class="full-width bordes_impuesto">
                        ...
                        <tr>
                            <td colspan="7" class="border-top-bottom text-center py-2 bordes  text-center desc-12">OP. EXPORTACIÓN:
                        ...
                        <tr>
                            <td colspan="7" class="border-top-bottom text-center py-2 bordes  text-center desc-12">OP. GRATUITAS:
                                {{ $document->currency_type->symbol }}
                            </td>
                        ...
                        <tr>
                            <td colspan="7" class="border-top-bottom text-center py-2 bordes  text-center desc-12">OP. INAFECTAS:
                                {{ $document->currency_type->symbol }}
                            </td>
                            <td class="border-top-bottom text-center py-2 bordes  text-center desc-12">
                        ...
                        <tr>
                            <td colspan="7" class="border-top-bottom text-center py-2 bordes  text-center desc-12">OP. EXONERADAS:
                                {{ $document->currency_type->symbol }}
                            </td>
                            <td class="border-top-bottom text-center py-2 bordes  text-center desc-12">
                        ...
                        <tr>
                            <td colspan="7" class="border-top-bottom text-center py-2 bordes  text-center desc-12">OP. GRAVADAS:
                                {{ $document->currency_type->symbol }}
                            </td>
                            <td class="border-top-bottom text-center py-2 bordes  text-center desc-12">
                        ...
                        <tr>
                            <td colspan="7" class="border-top-bottom text-center py-2 bordes  text-center desc-12">ICBPER:
                                {{ $document->currency_type->symbol }}
                            </td>
                            <td class="border-top-bottom text-center py-2 bordes  text-center desc-12">
                        ...
                        @endif
                        <tr>
                            <td colspan="7" class="border-top-bottom text-center py-2 bordes  text-center desc-12">IGV:
                                {{ $document->currency_type->symbol }}
                            </td>
                            <td class="border-top-bottom text-center py-2 bordes  text-center desc-12">
                        ...
                        <tr>
                            <td colspan="7" class="border-top-bottom text-center py-2 bordes  text-center desc-12"> IMPORTE TOTAL:
                                {{ $document->currency_type->symbol }}
                            </td>
                            <td class="border-top-bottom text-center py-2 bordes  text-center desc-12">
                        ...
                        <tr>
                            <td colspan="7" class="border-top-bottom text-center py-2 bordes  text-center desc-12">PERCEPCIÓN:
                                {{ $document->currency_type->symbol }}
                            </td>
                            <td class="border-top-bottom text-center py-2 bordes  text-center desc-12">
                        ...
                        <tr>
                            <td colspan="7" class="border-top-bottom text-center py-2 bordes  text-center desc-12 font-bold">TOTAL A PAGAR:
                                {{ $document->currency_type->symbol }}
                            </td>
                        ...
                        @else
                        <tr>
                            <td colspan="7" class="border-top-bottom text-center py-2 bordes  text-center font-bold desc-12">TOTAL A VENTA:
                                {{ $document->currency_type->symbol }}
                            </td>
                            <td class="border-top-bottom text-center py-2 bordes  text-center desc-12">
                                {{ number_format($document->total, 2) }}
                        ...
                        <tr>
                            <td colspan="7" class="border-top-bottom text-center py-2 bordes  text-center desc-12">REDONDEO:
                                {{ $document->currency_type->symbol }}
                            </td>
                            <td class="border-top-bottom text-center py-2 bordes  text-center desc-12">
                        ...
                        <tr>
                            ...
                            <td class="border-top-bottom text-center py-2 bordes  text-center desc-12 font-bold">
                        ...
                        @if ($balance < 0) <tr>
                            <td colspan="7" class="border-top-bottom text-center py-2 bordes  text-center desc-12">VUELTO:
                                {{ $document->currency_type->symbol }}
                            </td>
                            <td class="border-top-bottom text-center py-2 bordes  text-center desc-12">
