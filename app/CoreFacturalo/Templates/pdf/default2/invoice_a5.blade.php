...
<table class="full-width">
    <tr>
        @if($company->logo)
            <td width="20%">
                <div class="company_logo_box">
                    <img src="data:{{mime_content_type(public_path("storage/uploads/logos/{$company->logo}"))}};base64, {{base64_encode(file_get_contents(public_path("storage/uploads/logos/{$company->logo}")))}}" alt="{{$company->name}}" class="company_logo" style="max-width: 120px;">
                </div>
            </td>
        @else
            <td width="20%">
        ...
        <td width="50%" class="pl-3">
            <div class="text-left">
            <h4 style="font-size:12px !important;display:block !important">{{ $company->name }}</h4>
