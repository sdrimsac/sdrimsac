            ...
            @foreach ($document->items as $row)
                <tr>
                    ...
                    <td class="text-left desc-9 align-top">
                        ...
                        @if (!empty($row->additional_information) && is_iterable($row->additional_information))
                ...
                <div>
                    @foreach ($promotion_items as $item)
                        <div class="voucher-item"
                            style="border:1px solid #222; margin:4px 0; padding:2px; text-align:center;">
                            ...
                            @php
                                ...
                                $candidatePublicPath = $imageFile
                                    ? public_path('storage/uploads/items/' . $imageFile)
                                    : null;
                            ...
                            <div style="text-align:center; margin:4px 0;">
                                ...
                                <div style="font-size:12px;">Puntos requeridos: <span
                                        style="font-weight:bold;">{{ $item['item_points_value'] }}</span></div>
                                <div style="font-size:12px;">Cantidad: <span
                                        style="font-weight:bold;">{{ $item['item_quantity'] }}</span></div>
                                <div style="font-size:12px;">Fecha de vencimiento: <span
                                        style="font-weight:bold;">{{ $item['promotion_end_date'] }}</span></div>
                            </div>
                        </div>
                    @endforeach
                </div>
