...
<table class="full-width">
    ...
    <tr>
        <td class="text-center"><h5>{{ 'R.U.C. '.$company->number }}</h5></td>
    </tr>
    <tr>
...
<table class="full-width mt-10 mb-10 ml-2 mr-2 border">
    <thead class="">
    <tr>
...
<table class="full-width">
    ...
    @foreach($payments as $row)
        <tr><td>- {{$row->payment_method_type->description}}: {{ $row->date_of_payment->format('d/m/Y') }} {{ $document->currency_type->symbol }} {{ $row->payment }}</td></tr>
        @php
