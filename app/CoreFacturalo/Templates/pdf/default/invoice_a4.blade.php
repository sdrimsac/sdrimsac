    ...
    <tr>
        ...
        <td width="60%" class="align-top"  height="20px">
            <div class="text-left">
                ...
                @endisset
                <h6>Telefonos:{{ ($establishment->telephone !== '-')? $establishment->telephone : '' }}</h5>
...
<table class="full-width" >
    ...
    <tr>
      ...
      <tr>
        ...
        @else
        <tr>
            <td colspan="7" class="text-right font-bold border_detalles">TOTAL A VENTA: {{ $document->currency_type->symbol }}</td>
            <td class="text-right font-bold border_detalles">{{ number_format($document->total, 2) }}</td>
        </tr>
