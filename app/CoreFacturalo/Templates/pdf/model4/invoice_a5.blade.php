...
<table class="full-width mt-0 mb-0">
    <tr>
        ...
        @if ($document->detraction)
            ...
            <td width="140px">N. CTA DETRACCIONES</td>
    ...
    @if($invoice)
        <tr>
            <td width="140px">TELEFONOS</td>
            <td width="8px" class="align-top"> :</td>
            <td class="align-top">{{$customer->telephone}}</td>
        </tr>
    @endif
...
<table class="full-width mt-0 mb-0">
    <thead class="">
    <tr class="bg-grey">
        <th class="border-top-bottom text-center py-0" width="8%">CANT.</th>
        <th class="border-top-bottom text-center py-0" width="8%">UNIDAD</th>
        <th class="border-top-bottom text-left py-0">DESCRIPCIÓN</th>
        <th class="border-top-bottom text-right py-0" width="12%">P.UNIT</th>
        <th class="border-top-bottom text-right py-0" width="8%">DTO.</th>
        <th class="border-top-bottom text-right py-0" width="12%">TOTAL</th>
    </tr>
    </thead>
    <tbody>
    @foreach($document->items as $row)
        <tr>
            <td class="py-0 text-center align-top" >
            ...
            <td class="py-0 text-right align-top">{{ number_format($row->unit_price, 2) }}</td>
            <td class="py-0 text-right align-top">
                @if($row->discounts)
                    @php
            ...
            <td class="py-0 text-right align-top">{{ number_format($row->total, 2) }}</td>
        </tr>
        <tr>
...
<table class="full-width">
    <tr>
        ...
        <td width="35%" class="text-right">
            <img src="data:image/png;base64, {{ $document->qr }}" style="margin-right: -10px;" width="11%"/>
