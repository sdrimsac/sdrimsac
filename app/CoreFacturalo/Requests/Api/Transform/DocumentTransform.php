...
//            'establishment' => EstablishmentTransform::transform($inputs['datos_del_emisor']),
            ...
            'total_taxes' => Functions::valueKeyInArray($totals, 'total_operaciones_gravadas'),
            ...
            'total_rounded' => Functions::valueKeyInArray($inputs, 'total_rounded'),
          //  'tasadefault' => $inputs['tasadefault'],
            'total_payment' => Functions::valueKeyInArray($inputs, 'total_payment'),
