...
class ListVehicle implements FromCollection, WithHeadings, ShouldAutoSize, WithChunkReading, WithCustomStartCell, WithStyles
{
    protected $records;
    protected $company;
    ...
    public function collection()
    {
        ...
        foreach ($this->records as $record) {
            $data->push([
            'customer_id' => $record->customer ? $record->customer->name : 'N/A',
            'placa' => $record->placa,
            'marca' => $record->marca,
            ...
            'motor' => $record->motor,
            'color' => $record->color,
            'anio_fabricacion' => $record->anio_fabricacion,
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->setCellValue('A1', 'Lista_de_Vehiculos');
