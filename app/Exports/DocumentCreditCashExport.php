...
class DocumentCreditCashExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents
{
    use Exportable;
    protected $records;
    protected $company;
    ...
    public function collection()
    {
        return $this->records->map(function($record) {
            ...
            $remain = $total - $payed;
            return [
                'Fecha' => ($record->date_of_issue) ? Carbon::parse($record->date_of_issue)->format('Y-m-d') : null,
