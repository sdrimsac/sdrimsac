...
class PurchaseResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        if($purchase->number!=null && $purchase->series!=null){
           $number_full=$this->number_full;
        }else{
            $number_full=$purchase->series_guia."-".$purchase->number_guia;
        }
        return [
            'id' => $this->id,
            'number_guia'=>$this->number_guia,
            'series_guia'=>$this->series_guia,
    ...
    public static function getTransformItems($items){
        ...
        return $items->transform(function($row, $key){ 
            return [
                ...
                'unit_price_igv'=>$row->unit_price_igv,
