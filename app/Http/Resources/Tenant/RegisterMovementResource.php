...
class RegisterMovementResource extends JsonResource
{
    ...
    function get_model_type($model)
    {
        ...
        switch ($model) {
            case Orden::class:
                $detail = self::orden_description();
                break;
            case Table::class:
                $detail = self::table_description();
                break;
            case OrdenItem::class:
                $detail = self::orden_item_description();
                break;
            case SaleNote::class:
                $detail = self::sale_note_description();
                break;
            case Document::class:
                $detail = self::document_description();
                break;
            default:
                $detail = self::box_description();
                break;
        }
        return $detail;
    }
