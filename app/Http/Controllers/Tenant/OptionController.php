...
class OptionController extends Controller
{
    ...
    public function deleteDocuments(Request $request)
    {
        ...
        DB::connection('tenant')->transaction(function () {
            DB::table('credit_lists')->delete();
            DB::table('invoices')->delete();
            DB::table('hotel_rent_documents')->delete();
            DB::table('hotel_rent_item_services')->delete();
            DB::table('tables')->update(['status_table_id' => 1]);
            DB::table('kardex')->delete();
            DB::table('sale_notes_promotions')->delete();
            DB::table('sale_note_credits')->delete();
