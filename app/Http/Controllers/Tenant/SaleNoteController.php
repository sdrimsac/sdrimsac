    ...
    public function store(SaleNoteRequest $request)
    {
        ...
        return [
            ...
            'data' => [
                ...
                'print_web_ticket' => url('') . "/sale-notes/print/{$this->sale_note->external_id}/ticket",
                'print_web_a4' => url('') . "/sale-notes/print/{$this->sale_note->external_id}/a4",
                'print_web_a5' => url('') . "/sale-notes/print/{$this->sale_note->external_id}/a5",
                'schedule' => url('') . "/sale-notes/schedule/{$this->sale_note->id}",
                'print_ticket' => url('') . "/api/sale-note/print/{$this->sale_note->external_id}/ticket",
