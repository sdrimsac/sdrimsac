...
class DispatchController extends Controller
{
    ...
    public function tables(Request $request)
    {
        ...
        $countries = $this->func_get_countries();
        $locations = $this->func_get_locations();
        $identityDocumentTypes = $this->func_get_identity_document_types();
        ...
        $unitTypes = UnitType::query()
            ...
            ->whereIn('id', ['KGM', 'TNE'])->get()->transform(function ($r) {
                return [
                    'id' => $r->id,
                    'name' => $this->func_str_to_upper_utf8($r->description)
                ];
            });
