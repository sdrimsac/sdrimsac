...
class StaffPersonController extends Controller
{
    ...
    {
// Ensure this retrieves the correct user type
        return view('tenant.person_staff.index');
    }
    ...
    public function getRecords( Request $request)
    {
        ...
        $records = Person::where('is_staff', 1);
