...
class ServiceController extends Controller
{
    ...
    public function exchangeRateTest($date)
    {
        ...
        if ($date <= now()->format('Y-m-d')) {
            $ex_rate = \App\Models\ExchangeRate::where('date', $date)->first();
            if ($ex_rate) {
                $sale = $ex_rate->sale;
            } else {
                ...
                if ($res) {
                    $ex_rate = \App\Models\ExchangeRate::create([
                        'date' => $date,
                    ...
                    $last_ex_rate = \App\Models\ExchangeRate::orderBy('date', 'desc')->first();
                    if ($last_ex_rate) {
