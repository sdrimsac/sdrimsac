...
class ClientController extends Controller
{
    ...
    function setDefault()
    {
        ...
        DB::connection('tenant')->table('users')->upsert([
            ['id' => 1, 'name' => 'Administrador', 'email' => "administrador@sdrimsac.pro",       'password' => bcrypt("teros"),              'api_token' => str_random(50), 'establishment_id' => 1,  'locked' => true, 'number' => null,          'pin' => 159357, 'type' => 'admin', 'worker_type_id' => null, 'area_id' =>    null, 'active' =>    1],
            ['id' => 2, 'name' => 'Soporte',    'email' => "admin@sdrimsac.pro",    'password' => bcrypt("Sdr147258369"),       'api_token' => str_random(50), 'establishment_id' => 1,  'locked' => true, 'number' => null,       'pin' => 205687,    'type' => 'superadmin', 'worker_type_id' => null, 'area_id' =>    null, 'active' =>    1],
            ['id' => 3, 'name' => 'Contador',      'email' => "contador@sdrimsac.pro", 'password' => bcrypt("12345"),              'api_token' => str_random(50), 'establishment_id' => 1,      'locked' => true, 'number' => null,       'pin' => 12345, 'type' => 'seller', 'worker_type_id' => 2, 'area_id' =>    null, 'active' =>    1],
