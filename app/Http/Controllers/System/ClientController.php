...
class ClientController extends Controller
{
    ...
    function setDefault()
    {
        ...
        DB::connection('tenant')->table('users')->upsert([
            ['id' => 1, 'name' => 'Administrador', 'email' => "admin@sdrimsac.pro",       'password' => bcrypt("teros"),              'api_token' => str_random(50), 'establishment_id' => 1,  'locked' => true, 'number' => null,          'pin' => 159357, 'type' => 'admin', 'worker_type_id' => null, 'area_id' =>    null, 'active' =>    1],
