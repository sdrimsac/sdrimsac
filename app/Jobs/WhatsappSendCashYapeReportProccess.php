...
class WhatsappSendCashYapeReportProccess implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            $resource = "http://" . $this->fqdn . "/caja/report-boxes/reports_resumen_yape?cash_id=" . $this->cash_id;
            ...
            $request = new Request(
                [
                    ...
                    'number' => null,
                    'resource' => $resource,
                    'file_name' => 'Reporte_yape' . Carbon::now()->format("Y-m-d"),
                    'message' => "*".$company_name."*: Reporte de yape caja cerrado " . $this->user_name." en ".$establishment_name,
                ]
            );
            // if ($number_activity) {
