<template>
    <div class="card mb-0 pt-2 pt-md-0">
        <div class="card-header bg-primary">
            <h6 class="my-0 text-white">Cuentas por cobrar</h6>
        </div>
        <div class="card mb-0">
            <div class="card-body">
                <div class="row">
                        ...
                        <section>
                            <div>
                                <div class="row">
                                    ...
                                    <!-- <div class="col-md-3" style="margin-top:29px" v-if="records.length > 0">
                                    <label class="control-label">Exportar Cliente Seleccionado</label>
                                    <el-button-group>
                                        <el-button
...
export default {
    ...
    methods: {
        ...
        loadUnpaid() {
            ...
            this.$http
                .post(`/${this.resource}/records`, this.form)
                .then(response => {
        ...
        clickOpen(type) {
            ...
            window.open(
                `/${this.resource}/unpaidall/${type}?${query}`,
                "_blank"
            );
        },
