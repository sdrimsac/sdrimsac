<template>
    <div class="card mb-0 pt-2 pt-md-0">
        <div class="card-header bg-primary">
            <h6 class="my-0 text-white">Nuevo Ingreso</h6>
        </div>
            ...
            <form autocomplete="off" @submit.prevent="submit">
                <div class="form-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group" :class="{'has-danger': errors.customer}">
                                ...
                                <el-input v-model="form.customer"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                    ...
                    <div class="row mt-2" v-if="form.items.length > 0">
                        ...
                        <div class="col-md-12">
                            <h6 class="text-end" v-if="form.total > 0"><b>TOTAL: </b>{{ currency_type.symbol }} {{ form.total }}</h6>
                        </div>
                    </div>
                </div>
        ...
        methods: {  
            ...
            submit() {
                ...
                if(validate.acum_total != parseFloat(this.form.total) || validate.error_by_item > 0) {
                    return this.$toast.error('Los montos ingresados no coinciden con el monto total o son incorrectos');
                }
