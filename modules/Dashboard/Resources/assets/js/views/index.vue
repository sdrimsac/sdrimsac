<template>
    <div>
        <div class="row">
            <div class="col-12">
                <div class="page-title-container">
                    <h1 class="mb-0 pb-0 display-4" id="title">Dashboareed</h1>
                    <nav
        ...
        <div class="row">
                ...
                <div class="mb-5">
                    <div class="row g-2">
                        <div class="col-12 col-sm-3 col-lg-3">
                            <div
                                class="card sh-11 hover-scale-up cursor-pointer"
                            >
                                <div
                                ...
                                >
                                    <div class="col-auto pe-3">
                                        ...
                                        >
                                            <i
                                                data-cs-icon="navigate-diagonal"
                                                class="text-white"
                                            ></i>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div
                                            class="row gx-2 d-flex align-content-center"
                                        >
                                            <div class="col-12 col-xl d-flex">
                                                <div
                                                    class="p mb-0 d-flex align-items-center lh-1-25"
                                                >
                                                    Pedidos enviados
                                                </div>
                                            </div>
                            ...
                            <div class="widget-summary-col">
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="summary">
                                            <h4
                                                class="small-title text-success"
                                            >
                                                Utilidad
                                            </h4>
                                            <div class="info">
                          ...
                          <h4 class="title">
                            <div class="form-group">
                                ...
                                <div class="row m-t-20">
                                    <div class="col-md-12">
                                        <graphApex
                                            v-if="seriesUtilidad.length > 0"
                                            :allData.sync="seriesUtilidad"
                                            :labels.sync="labels_utilidad"
                                            :colors.sync="
                                                utilities.graph.datasets[0]
                                                    .backgroundColor
                                            "
            ...
            <!-- Purchase End -->
            <div class="col-xl-3 col-md-3">
                <h2 class="small-title mb-3 mt-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <template
                                        v-for="(row, index) in items_by_sales"
                                    >
                                        <tr :key="index">
                                            <td>{{ index + 1 }}</td>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <template
                                        v-for="(row, index) in top_customers"
                                    >
                                        <tr :key="index">
                                            <td>{{ index + 1 }}</td>
                                            <td>
        ...
        async loadData() {
            await this.$http
                ...
                .then(response => {
                    ...
                    this.seriesDocuments =
                        response.data.data.document.graph.datasets[0].data;
                    this.labels_douments =
                        response.data.data.document.graph.labels;
                    for (
                        let index = 0;
                        index <
                        response.data.data.balance.graph.datasets[0].data
                            .length;
                        index++
                    ) {
                        this.seriesBalance.push(
                            parseFloat(
                                response.data.data.balance.graph.datasets[0]
                                    .data[index]
                            )
                        );
                    }
