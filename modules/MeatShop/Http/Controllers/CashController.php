...
class CashController extends Controller
{
    ...
    public function print_report(Request $request)
    {
        ...
        $configuration = Configuration::first();
        try {
            $pdf = PDF::loadView('workshop::cash.ticket_cash', compact(
                "configuration",
                "categories",
                "totalCategory",
                "grouped",
    ...
    public function index()
    {
        ...
        return view('workshop::cash.index', compact('userid', 'cajaOpen'));
    }
    ...
    public function final_balance_last_principal()
    {
        ...
        if ($cash) {
            ...
            $balance = (new GrifoController)->total_sales($request);
