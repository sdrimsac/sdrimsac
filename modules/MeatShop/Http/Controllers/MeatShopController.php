...
namespace Modules\MeatShop\Http\Controllers;
...
class MeatShopController extends Controller
{
    /**
    ...
    public function expenses()
    {
        ...
        if ($cash == null) {
            return redirect()->route('meatshop.cash.index');
        }
        ...
        $cashid = $cash->id;
        //dd($categoryid);
        return view('meatshop::expenses.index', compact(
            'cashid',
            'groupid',
            'categoryid',
            'userid',
    ...
    public function expenses_admin()
    {
        ...
        if ($cash == null) {
            return redirect()->route('meatshop.cash');
        }
        $group = Group::where('type', '2')->first();
        $category = Category::where('type', '2')->first();
    ...
    /* public function pos()
    {
        ...
        $pending_order = 0;
        return view('grifo::worker.pos', compact('pending_order', 'area_id', 'cash_id', 'worker', 'establishments', 'configuration', 'auth_login', 'company', 'desarrollador'));
    } */
    ...
    public function pos()
    {
        ...
        $pending_order = 0;
        return view('meatshop::worker.pos', compact('pending_order', 'area_id', 'cash_id', 'worker', 'establishments', 'configuration', 'auth_login', 'company', 'desarrollador'));
    }
    ...
    public function income()
    {
        ...
        $soaptypeid = $company->soap_type_id;
        //dd($categoryid);
        return view('meatshop::income.index', compact('groupid', 'categoryid', 'userid', 'subcategoryid', 'soaptypeid'));
    }
