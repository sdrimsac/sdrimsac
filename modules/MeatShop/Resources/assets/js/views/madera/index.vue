          ...
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">
                <span class="text-muted">Maderera</span>
              </li>
            </ol>
          </div>
        </div>
    ...
    <div class="container-fluid p-l-0 p-r-0">
      <div class="card mb-0">
        <div class="card-header bg-primary">
          <h6 class="my-0 text-white">Maderera</h6>
        </div>
        <div class="card-body">
          <div class="col-md-12 col-lg-12 col-xl-12">
            <div class="row mt-2">
              ...
              <div class="col-lg-8 col-md-8 col-md-8 col-sm-12 d-flex align-items-end">
                <el-button
                  class="submit"
                  type="primary"
                ...
                <template v-if="records.length > 0">
                  <!-- <el-button class="submit" type="danger" @click.prevent="clickDownload('pdf')">
              ...
              <table class="table">
                ...
                <tbody>
                  <tr v-for="(row, index) in records" :key="index">
                    ...
                    <td>
                      {{ row.description }}
                      <template v-if="row.unique">(x{{ Number(row.factor) }})</template>
                    ...
                    <!-- <td>
                      <template v-if="row.max_quantity_item">{{ formatUnit(row) }}</template>
                      <template v-else>
                        {{ Number(row.count) }}
                        <template v-if="row.unit_item">{{ row.unit_item }}</template>
                      </template>
                    </td> -->
                    <td>
                      {{ row.totalFeetSold}} {{row.unit_item}}
                    </td>
                    <td v-if="!isService">
                      {{
                      Number(
