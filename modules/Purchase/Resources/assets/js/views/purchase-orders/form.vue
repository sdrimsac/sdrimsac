                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group" :class="{'has-danger': errors.exchange_rate_sale}">
                                    ...
                                    <el-input v-model="form.exchange_rate_sale" :readonly="true"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                    ...
                    .then(response => {
                        ...
                        if (response.data.success) {
                            ...
                            if(this.saleOpportunity){
                                ...
                                this.$toast.success(`La orden de compra ${response.data.data.number_full} fue generada`)
                                this.close()
