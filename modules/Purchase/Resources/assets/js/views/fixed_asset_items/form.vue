                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group" :class="{'has-danger': errors.name}">
                            ...
                            <el-input v-model="form.name" dusk="name"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="col-md-9">
                        <div class="form-group" :class="{'has-danger': errors.description}">
                            ...
                            <el-input v-model="form.description" dusk="description"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                    ...
                    <div class="col-md-3">
                        <div class="form-group" :class="{'has-danger': errors.internal_id}">
                            ...
                            <el-input v-model="form.internal_id" dusk="internal_id"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                    ...
                    <div class="col-md-3">
                        <div class="form-group" :class="{'has-danger': errors.purchase_unit_price}">
                            ...
                            <el-input v-model="form.purchase_unit_price" dusk="purchase_unit_price"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
