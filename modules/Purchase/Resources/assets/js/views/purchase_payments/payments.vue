        ...
        <div class="form-body">
            <div class="row">
                ...
                <div
                    ...
                    v-if="showAddButton && purchase.total_difference > 0"
                >
                    <el-button
                        type="primary"
                        icon="el-icon-plus"
...
export default {
    ...
    methods: {
        ...
        async getData() {
            this.initForm();
            await this.$http
                .get(`/${this.resource}/purchase/${this.purchaseId}`)
                .then(response => {
                    this.purchase = response.data;
                    this.title =
                        "Pagos de la compra: " + this.purchase.number_full;
                });
            await this.$http
                .get(`/${this.resource}/records/${this.purchaseId}`)
                .then(response => {
        ...
        clickSubmit(index) {
            if (
                ...
                parseFloat(this.purchase.total_difference)
            ) {
                this.$toast.error(
