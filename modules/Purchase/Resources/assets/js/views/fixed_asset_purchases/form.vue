<template>
    <div class="card mb-0 pt-2 pt-md-0">
        <div class="card-header bg-primary">
            <h6 class="my-0 text-white">{{ title_form }}</h6>
        </div>
        <div v-loading="loader" class="tab-content  p-3">
...
export default {
    ...
    async created() {
        this.title_form = this.id ? "Editar Compra" : "Nuevo Registro  Compra";
        await this.initForm();
