<template>
    <div class="card">
        <div class="card-header bg-primary">
            <h6 class="my-0 text-white">Modo offline</h6>
        </div>
        <div class="card-body">
                ...
                <div class="row mt-4" v-if="form.is_client">
                    ...
                    <div class="col-md-6"> 
                        ...
                        <div class="form-group" :class="{'has-danger': errors.url_server}">
                            <el-input v-model="form.url_server" > <i slot="prefix" class="el-icon-edit-outline"></i></el-input>                                
                    ...
                    <div class="col-md-6"> 
                        ...
                        <div class="form-group" :class="{'has-danger': errors.token_server}">
                            <el-input v-model="form.token_server" > <i slot="prefix" class="el-icon-edit-outline"></i></el-input>                                
