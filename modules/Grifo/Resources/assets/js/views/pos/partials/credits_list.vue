    ...
    >
        ...
        <div class="card mb-1 shadow-sm">
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-lg-4 col-md-6 mb-3">
                        ...
                        <el-select
                            ...
                            clearable
                            placeholder="Ingrese Nombre de Cliente o número de Comprobante"
            ...
            >
                <div class="row gx-2">
                    ...
                    <div
                        class="col-lg-8 col-md-6 mb-3 d-flex align-items-center flex-wrap gap-2"
                    >
                        <el-button
                            class="btn_buscarsmall"
                            type="primary"
        ...
        <!-- <div class="card mb-1 shadow-sm">
            <div class="card-body">
                ...
                >
                    <div
                        class="col-lg-4 col-md-4 mb-3 d-flex flex-column justify-content-center"
                    >
                    ...
                    <div
                        class="col d-flex flex-column align-items-start mb-3"
                        style="width: auto;"
                    >
                        <el-button
                            class="btn_buscarsmall"
