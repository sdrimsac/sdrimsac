                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><span class="text-muted">Comprobantes pendientes de envío
                                    OSE/SUNAT</span></li>
                        </ol>
                    </div>
        ...
        <div class="container-fluid p-l-0 p-r-0">
            <div class="card mb-0" v-loading="loading_submit">
                <div class="card-header bg-primary d-flex align-items-center">
                    ...
                    <h6 class="my-0 text-white mb-0">Comprobantes pendientes de envío OSE/SUNAT</h6>
                </div>
                <div class="card-body ">
                            ...
                            <td class="text-center">
                                ...
                                <template v-else>
                                    <el-tooltip class="item" effect="dark" :content="row.text_tooltip" placement="top">
                                        <el-button type="info" class="btn btn-sm"><i
