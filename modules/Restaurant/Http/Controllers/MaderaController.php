...
use Modules\Report\Exports\MaderaReportExport;
...
class MaderaController extends Controller
{
    ...
    public function index_madera()
    {
        return view('tenant.madera.index');
    ...
    public function report_cash_export($type, Request $request)
    {
        ...
        if ($type == 'pdf') {
            $pdf = PDF::loadView('report::madera.report_pdf_madera', compact(
                "establishment",
                "total",
                "company",
                "items",
            ...
            return (new MaderaReportExport)
                ...
                ->download('ReporteMadera' . Carbon::now() . '.xlsx');
        }
    }

    public function report_madera(Request $request)
    {
        $categoria_id = $request->categoria_id;
        $item_id = $request->item_id;
        $establishment_id = $request->establishment_id;
