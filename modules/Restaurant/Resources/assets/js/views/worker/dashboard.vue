            ...
            <div class="row">
                <div class="col-12 col-sm-5">
                    <h1 class="mb-1 pb-0 display-4 user_online">
                        <div class="btn-group">
                            <div class="dropdown">
                                <a class="dropdown-toggle mb-1" href="javascript:void(0)" role="button"
                                ...
                                <!-- <div class="dropdown-menu w-300" aria-labelledby="dropdownMenuLink"> -->
                                    ...
                                    "><i class="icofont-prestashop"></i>
                                        Visualizar Pedidos Realizados</a>
                ...
                <div class="col-12 col-sm-6 pt-2 pb-2" v-if="show == 'create'&& screenWidth > 678">
                    <template>
                        ...
                        <el-input v-model="item" @focus="clearinput()" @input="searchOrden()" ref="item"
                            ...
                            <el-button :class="
                                optionsSelected == 0
                                    ...
                                    : ''
                            " slot="append" icon="el-icon-tickets" @click="selectSearch(0)"></el-button>
                            <el-button :class="
                                optionsSelected == 1
                                    ? 'bg-secondary text-white'
                                    : ''
                            " slot="append" icon="el-icon-s-order" @click="selectSearch(1)"></el-button>
                        </el-input>
                    </template>
                </div>
                <div class="col-12 col-sm-6 pt-2 pb-2" v-if="show == 'create' && screenWidth > 678">
                    <template>
                        <span slot="label">
                            ...
                            Producto</span>
                        <el-select v-model="category" filterable placeholder="Selecionar aqui...."
