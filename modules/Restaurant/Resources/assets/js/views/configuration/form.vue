...
<template>
            ...
            <template v-if="type == 'caja/tables' || type == 'caja/rooms' || type == 'caja/billar'">
                ...
                <div class="col-md-4" v-if="type == 'caja/rooms'">
                    <div class="form-group" :class="{ 'has-danger': errors.tower_id }">
                        ...
                        <el-select v-model="form.tower_id" @change="filterFloorsByTower(form.tower_id)">
                            <el-option v-for="(data, index) in towers" :key="index" :label="data.name" :value="data.id"></el-option>
                        </el-select>
                ...
                <div class="col-md-4" v-if="type == 'caja/rooms'">
                    <div class="form-group" :class="{ 'has-danger': errors.floor_id }">
                        ...
                        <el-select v-model="form.floor_id">
                            <el-option v-for="(data, index) in floors" :key="index" :label="data.name" :value="data.id"></el-option>
                        </el-select>
                        <small class="form-control-feedback" v-if="errors.floor_id" v-text="errors.floor_id[0]"></small>
                    </div>
                </div>
                <div class="col-md-4" v-if="type == 'caja/rooms'">
                    <div class="form-group" :class="{ 'has-danger': errors.type_id }">
                        <label class="control-label">
                            <i class="fas fa-bed mr-2"></i> Tipo
                        </label>
                        <el-select v-model="form.table_type_id">
                            <el-option v-for="(data, index) in types" :key="index" :label="data.name" :value="data.id"></el-option>
                        </el-select>
                        <small class="form-control-feedback" v-if="errors.type_id" v-text="errors.type_id[0]"></small>
                    </div>
                </div>
                <div class="col-md-4" v-if="type == 'caja/rooms'">
                ...
                <div class="col-md-4">
                    <div class="form-group" :class="{ 'has-danger': errors.status_table_id }">
                        ...
                        <el-select :disabled="recordId != null" v-model="form.status_table_id">
                            <el-option v-for="(data, index) in statusTable" :key="index" :label="data.description" :value="data.id"></el-option>
                        </el-select>
                        <small class="form-control-feedback" v-if="errors.status_table_id" v-text="errors.status_table_id[0]"></small>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <template v-if="type == 'caja/rooms' && all_services.length > 0">
                    <div class="col-12 my-2">
                        <el-checkbox v-model="form.has_frigobar" label="Frigobar">
                            <i class="fas fa-snowflake mr-2"></i> ¿Tiene frigobar?
                        </el-checkbox>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="d-flex flex-wrap justify-content-center p-2">
                        <el-tag role="button" :type="data.selected ? 'success' : 'primary'" style="margin-right:5px;margin-top:5px" v-for="(data, idx) in all_services" :key="idx" :disable-transitions="true" @click="selectService(idx)">
                ...
                <template v-if="type == 'caja/rooms'">
                    <div class="col-12">
                        <div class="form-group" :class="{ 'has-danger': errors.description }">
                            <label class="control-label">
                                <i class="fas fa-list mr-2"></i> Contiene
                            </label>
                            <el-input v-model="detail" type="textarea" readonly :rows="3"></el-input>
                            <small class="text-danger" v-if="errors.description" v-text="errors.description[0]"></small>
                        </div>
                    </div>
                    <div class="d-flex flex-wrap justify-content-center p-2">
                        <el-tag role="button" :type="data.selected ? 'success' : 'primary'" style="margin-right:5px;margin-top:5px" v-for="(data, idx) in tags" :key="idx" :disable-transitions="true" @click="select(idx)">
                            {{ data.description }}
                        </el-tag>
                    ...
                    <div class="d-flex justify-content-end align-items-center">
                        <div class="col-md-3 col-lg-3 col-6">
                            <el-input class="input-new-tag" @input="search" v-model="newTag" placeholder="Nueva obs.." size="medium">
                            </el-input>
                        </div>
                        <div>
                            <el-button class="button-new-tag" size="small" style="margin-left: 10px;" type="primary" @click="handleInputConfirm">+ Agregar</el-button>
                        </div>
                    </div>
                </template>
            </template>
    ...
    <div class="form-actions text-end pt-2 pb-2">
        ...
        <el-button type="primary" icon="fas fa-save fa-lg" native-type="submit" :loading="loading_submit"> Guardar</el-button>
    </div>
</form>
