                    ...
                    <template v-if="type == 'caja/tables' || type == 'caja/rooms' || type !== 'caja/billar'">
                        ...
                        <div class="col-md-4" v-if="type == 'caja/rooms'">
                            <div class="form-group" :class="{ 'has-danger': errors.table_type_id }">
                                ...
                                <small class="form-control-feedback" v-if="errors.table_type_id" v-text="errors.table_type_id[0]"></small>
                            </div>
                        </div>
                        <div class="col-md-4" v-if="type == 'caja/rooms'">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label w-100">
                                    <i class="fas fa-list-ol mr-2"></i> Número inicial de {{
                                        type == "caja/tables" ? "mesa" : "habitación"
                                    }}
                                </label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label w-100">
                                    <i class="fas fa-list-ol mr-2"></i> Número final de {{
                                        type == "caja/tables" ? "mesa" : "habitación"
                                    }}
                                </label>
...
<script>
export default {
    props: ['titleDialog', 'showDialog', 'type', 'configurations', 'form', 'errors', 'towers', 'floors', 'types', 'statusTable', 'areas', 'establishments', 'loading_submit'],
    methods: {
        close() {
            this.$emit('close');
        },
