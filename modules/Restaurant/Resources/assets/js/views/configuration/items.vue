        ...
        <div class="container-fluid p-l-0 p-r-0">
            <div class="card mb-0">
                ...
                <div class="data-table-visible-columns"
                    ...
                    <el-button type="primary" class="btn_buscar" href="javascript:void(0)"
                        @click.prevent="clickCreate()">
                        <i class="fas fa-plus-circle"></i>
                        <span>Nuevo</span>
                    </el-button>
                    <el-button v-if="resource == 'caja/tables' || resource == 'caja/rooms'" type="" class="btn_buscar"
                        href="javascript:void(0)" @click.prevent="clickCreateMassive()">
                        <i class="fas fa-plus-circle"></i>
                ...
                <div class="card-body">
                    <data-table :resource="resource">
                        ...
                        <tr slot-scope="{ index, row }">
                            ...
                            <td v-if="type == 'caja/areas'">
                                <el-switch v-if="row.printer == null" @change="updateSearchPrint(row)"
                                    v-model="row.search_print"></el-switch>
                            </td>
                ...
                <create-form :types="types" :showDialog.sync="showDialog" :areas="areas" :zones="zones" :type="type"
