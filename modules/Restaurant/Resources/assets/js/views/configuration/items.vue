        ...
        <div class="card-body">
          <data-table :resource="resource">
            <tr slot="heading" class="bg-primary">
              ...
              <th class="text-white" v-if="type == 'caja/rooms'">Piso</th>
              <th class="text-white" v-if="type == 'caja/areas'">Impresora</th>
              <th class="text-white" v-if="type == 'caja/areas'">Forzar impresión</th>
              <th class="text-white" v-if="type == 'caja/rooms'">Precio</th>
              <th class="text-white" v-if="type == 'caja/rooms'">Incluye</th>
            ...
            <tr slot-scope="{ index, row }">
              ...
              <td class="text-end">
                ...
                <div class="dropdown-menu dropdown-menu-end" style>
                  ...
                  <a
                    type="button"
                    class="dropdown-item btn waves-effect waves-light btn-sm"
                    :class="row.active
...
export default {
  ...
  methods: {
    ...
    async updateSearchPrint(row) {
      try {
        this.loading_data = true;
        const response = await this.$http.post(`/${this.resource}`, row);
