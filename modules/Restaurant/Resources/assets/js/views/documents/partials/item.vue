<template>
    <el-dialog :title="titleDialog" :visible="showDialog" @open="create" @close="close" top="7vh" :close-on-click-modal="false">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-lg-2 col-xl-2 col-sm-2" >
                        <div class="form-group">
                           ...
                           <b><h6 class="text-center" style="font-size:14px">{{form.stock_disp}}</h6></b>
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="form-group" :class="{'has-danger': errors.unit_price_value}">
                            ...
                            <el-input ref="precio" v-model="form.unit_price_value" @input="calculateQuantity()"  @focus="$event.target.select()" @keyup.enter.native="clickAddItem();focusProducto()" :readonly="typeUser === ''">
                                        ...
                                        <div v-if="attribute_types.length > 0">
                                            ...
                                            <table class="table">
                                                ...
                                                <tr v-for="(row, index) in form.attributes">
                                                    ...
                                                    <td>
                                                        <el-input v-model="row.value" @input="inputAttribute(index)"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                                                    </td>
                                                    <td>
        ...
        <item-form :showDialog.sync="showDialogNewItem"
                   :external="true" @add="addNewItem"></item-form>
...
<script>
    ...
    export default {
        props: ['recordItem','showDialog', 'operationTypeId', 'currencyTypeIdActive','percentage_igv', 'exchangeRateSale', 'typeUser', 'isEditItemNote', 'configuration','restringir_stock'],
