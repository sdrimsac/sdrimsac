...
export default {
    ...
    async created() {
        ...
        /* console.log("🚀 ~ created ~ this.isSeller:", this.isSeller); */ this.isAnalist = this.checkWorkerType(
            "analista"
        );
    ...
    methods: {
        ...
        async getTables() {
            ...
            await this.$http.get(`/${this.resource}/tables`).then(response => {
                ...
                /* console.log("🚀 ~ awaitthis.$http.get ~ this.user:", this.user); */ this
                    .currency_types.length > 0
