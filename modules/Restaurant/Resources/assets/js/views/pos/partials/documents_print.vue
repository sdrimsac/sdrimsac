...
const DispatchCreate = () =>
    import(
        "../../../../../../../../resources/js/views/dispatches/createGuides.vue"
    );
    ...
    methods: {
        ...
        getRecords(page = 1) {
            if (this.activeName == "saleNotes") {
                ...
                this.pagination.quotations.current_page = Number(page);
            } else if (this.activeName == "guides") {
                this.pagination.guides.current_page = Number(page);
            }
            if (this.time) {
