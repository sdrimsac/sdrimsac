    ...
    <div v-loading="loading" class="mb-0">
      <div class="pt-1" v-loading="loading_submit" :element-loading-text="loadingText">
        <div class="d-flex pt-2 justify-content-end">
          <el-button size="mini" type="primary" @click="showListItems = true">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-6 col-lg-5 col-sm-6">
                      <label class="control-label fw-bold">Comprobante de Pago</label>
                      <div class="form-group">
                        ...
                        >
                          <template v-if="!isInterno">
                            <el-radio-button v-if="invoice" label="01">FACTURA</el-radio-button>
                            <el-radio-button v-if="receipt" label="03">BOLETA</el-radio-button>
                          </template>
                          <el-radio-button
                            v-if="
                                                            !variation &&
                    ...
                    <div class="col-4 col-md-4 col-lg-4">
                      <div class="form-group">
                        <label class="control-label fw-bold">Fecha de Emisión</label>
                        <el-date-picker
                          style="width:100%;"
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <template>
                          <div class="el-input el-input-group col-md-6" style="margin-bottom:3px;">
                            <label class="control-label fw-bold" style="margin-right:3px;">
                              <i class="fas fa-regular fa-user"></i>Cliente
                            </label>
                            <el-button
                              :disabled="
                                                                !value ||
                  ...
                  <template v-if=" configuration.show_coins_to_receive">
                    <div class="m-2 d-flex justify-content-center align-items">
                    ...
                    <div class="d-flex justify-content-center align-items-center">
                      <el-button-group class="d-flex flex-wrap justify-content-center">
                        ...
                        <el-button type="danger" @click="clearSumCoins" size="small" round>
                  ...
                  <template v-if="conf.show_discounts_payment">
                    <div class="col-md-4 form-group">
                      <label class="control-label fw-bold">Monto Descuento</label>
                      <el-input-number
                        :min="0"
                    ...
                    >
                      <label class="control-label fw-bold">Tipo de descuento</label>
                ...
                <div class="col-lg-12 m-">
                  ...
                  >
                    <div class="col-md-6 col-lg-6 col-12">
                      <label
                        class="control-label text-left d-flex align-items-start justify-content-start"
                      >N° de operación</label>
                      <el-input v-model="operation_number">
                        <template slot="prepend">
                  ...
                  <div class="row p-2">
                    ...
                    <div class="radio-tile-group2 col-lg-6 col-xl-6 d" style="padding-top: 12px;">
                      <div class="input-container2 border rounded-sm col-lg-3">
                        <input
                          id="imprimir"
                          v-model="printerOn"
                          @change="
                        ...
                        <div class="radio-tile2">
                          ...
                          <label for="cash" class="radio-tile-label2">Imprimir</label>
                        </div>
                      </div>
                      <div class="input-container2 border rounded-sm col-lg-3">
                        <input
                        ...
                        <div class="radio-tile2">
                          ...
                          <label for="Tarjeta" class="radio-tile-label2">No Imprimir</label>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="row p-2" v-if="hasDetraction">
                    <div class="col-md-4">
                      <label for="account">
                        Cta Bancaria
                        <a
                  ...
                  <div class="row">
                    <div class="col-lg-8 d-flex flex-row align-items-end"></div>
              ...
              <div class="card bg-light">
                <div class="card-body">
                  <div class="row">
                    ...
                    >
                      <label class="control-label h1">Total a cobrar:</label>
                      <br />
                      <span
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="d-flex flex-wrap justify-content-around">
                          <div class="col-3 col-lg-2 col-md-2 col-xl-2">
                            <button
                        ...
                        <div class="row col-xl-12 col-12">
                          <div class="col-xl-6 col-md-3 col-lg-3 col-12">
                            <el-input
                              id="inputTotal"
                              ref="enter_amount"
                              v-model="
                          ...
                          <template
                            v-if="
                                                            conf.show_payment_method
                                                        "
                          >
                            <div class="col-xl-2 col-md-2 col-lg-2 col-6">
                              <el-button
                                type="primary"
                                @click="
                                                                    addPayment
                    ...
                    <div class="row col-xl-4">
                      <div class="col-xl-5" style="margin-bottom: 10px"></div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-xl-3"></div>
                    <div class="col-xl-2"></div>
                    <div class="col-xl-3" v-show="conf.show_payment_method">
                      <el-select
                        v-if="
                                                    form.document_type_id ==
                                                        '01' ||
                  ...
                  <div v-if="hasExceedBank" class="d-flex justify-content-center">
      ...
      <div class="p-3">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-12 d-flex align-items-end justify-content-center">
            ...
            <br />
            <div>
              <button class="btn btn-block btn-dark" @click="back(false)">
  ...
  methods: {
    insertReferenceNumber() {
      ...
      if (this.form.reference_number && this.form.bank_account_id) {
        ...
        if (this.form.observation == null || this.form.observation == "") {
    ...
    calculateCharge() {
      ...
      if (this.form.total < this.chargeCredit.total_charge) {
        ...
        this.$toast.error("El monto a adicionar no puede ser mayor al total");
        ...
        if (this.refCustomer != null) {
          ...
          this.customers = [
            ...
            ...this.customers.filter(
              f => f.id != this.refCustomer.id && f.number != "88888888"
            )
          ];
    ...
    async date_of_issue() {
      ...
      this.customers = this.all_customers.filter(n => n.number != "88888888");
      // this.customers = [
      ...
      if (
        ...
        if (detraction_type_id) {
          ...
          if (detraction) {
            let amount = this.form.total * (detraction.percentage / 100);
    ...
    async clickSendWhatsapp(document_type_id, document_id, number, form = {}) {
      if (form.customer_telephone != null) {
        ...
        try {
          ...
          if (this.configuration.xml_whatsapp && document_type_id != "80") {
      ...
      if (this.form.document_type_id == "01") {
        ...
        if (
          moment(this.form.date_of_issue).isBefore(
            date.subtract(days_before_emit, "days").format("YYYY-MM-DD")
          )
        ) {
          this.$toast.error(
    ...
    async diferen() {
      ...
      if (
        ...
        this.$toast.error("El monto de efectivo es menor al total de venta");
      }
    },
    totalPayments() {
    ...
    async enterAmount(amount = 0) {
      ...
      let enter_amount =
        (parseFloat(this.form.enter_amount) || 0) + this.totalPayments();
    ...
    async sendPayment($event, form = null) {
      ...
      if (this.formVariation.items.length != 0) {
        ...
        this.customers = [
          ...this.customers.filter(c => c != this.customer_variation.id),
    ...
    async validOperationNumber(form) {
      ...
      const response = await this.$http.post("/caja/boxes/validation", form);
    ...
    async clickPayment(form) {
      ...
      if (
        (form.document_type_id == "01" || form.document_type_id == "03") &&
        form.total <= 0
      ) {
        this.$toast.error("El monto total no puede ser menor o igual a 0");
        return;
      }
          ...
          if (!this.verifyHasOperationNumber()) {
            ...
            if (
              this.currentPayments
                .filter(p => this.methodsValidate.includes(p.method))
                .map(p => ({
                  method: p.method,
        ...
        if (response.status == 200 && data.data) {
          ...
          if (response.data.success == true) {
            ...
            if (response.data.success == true) {
              ...
              if (ordenId) {
                if (this.configuration.college && this.form.student_id) {
                  const registerCollegeResponse = await this.$http.post(
                    "/college/registers/sale",
                    {
                      ...
                      detail: {
                        items: this.form.items.map(s => s.item)
                      },
    ...
    async deleteHotelRentItem(id) {
      const response = await this.$http.delete(`/caja/rooms/hotel/rents/${id}`);
    },
    back(val = false) {
      // this.$emit()
    ...
    checkCustomers() {
      if (
        ...
        return this.customers.some(c => c.identity_document_type_id == "1");
      }
    },
    setSeries() {
      ...
      this.series.forEach(s => {
        s.full_number =
          `${s.number}-${this.last_number[s.number] || "1"}` || s.number;
      });
    ...
    async filterSeries() {
      ...
      if (this.value != null) {
        currentClient = this.all_customers.find(c => c.id == this.value);
