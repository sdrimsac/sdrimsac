<template>
    <el-dialog
        ...
        top="2vh"
    >
        <div v-loading="loading" class="card mb-0">
                            ...
                            <div class="card-body text-center text-dark p-2">
                                ...
                                >
                                    ...
                                    <div class="col-lg-2 d-flex">
                                        ...
                                        >
                                            <i
                                                class="fa fa-address-card text-white"
                                                aria-hidden="true"
                                            ></i>
                                            Nuevo
                                        </el-button>
                        ...
                        <div class="card card-default border mb-2">
                            <div class="card-body">
                                <div class="row justify-content-between">
                                    <div class="col-lg-6">
                                        <label
                                            class="control-label text-center  d-flex align-items-center justify-content-center"
                                            >Impresión de Comprobante</label
                                        >
                                        <div
                                            class="radio-tile-group2 flex-wrap"
                                        >
...
export default {
    components: { CardBrandsForm, MultiplePaymentForm, PersonForm },
    ...
    async created() {
        ...
        let client = this.all_customers.find(c => {
    ...
    methods: {
        ...
        async clickPayment() {
            if (
                this.customer.identity_document_type_id == "1" &&
