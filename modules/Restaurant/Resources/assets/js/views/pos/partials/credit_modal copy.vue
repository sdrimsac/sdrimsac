            ...
            <div class="card-body">
                <div class="m-2">
                    <div class="row">
                        ...
                        <div
                            class="col-md-3"
                            v-if="credit.type_payment == 'Unico'"
                        >
                        ...
                        <div class="col-md-2" v-if="isSimulate">
                            <label for="total text-primary">Monto base</label>
                            <el-input
                ...
                <div
                    class="row"
                    v-if="configuration.sale_note_credit_confirm && !isSimulate"
                >
                    <div
                ...
                <div slot="footer" class="dialog-footer">
                    <div v-if="form.total" class="d-flex justify-content-end">
                        <div>
                            ...
                            <span class="h6 text-primary"
                                >S/.
                                {{
                                    (form.total - credit.advances).toFixed(2)
                                }}</span
                            >
                        </div>
                    ...
                    <template
                        v-if="
                            configuration.sale_note_credit_confirm && isSimulate
                        "
                    >
                        <el-checkbox
                            class="left-button"
                            v-model="simulateForm.print"
                            >Impresión</el-checkbox
                        >
                        <el-checkbox
                            class="left-button"
                            v-model="simulateForm.pdf"
                            >Pdf</el-checkbox
                        >
                        <el-checkbox
                            class="left-button"
                            v-model="simulateForm.whatsapp"
