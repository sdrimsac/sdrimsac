            ...
            <h5 id="offcanvasRightLabel">
                <p class="h4 txt-info p-10 txt-primary f-w-700">
                    ...
                    >
                        <template
                            v-if="
                                localOrden.length > 0 && localOrden.length <= 9
                            "
                        >
                            0{{ localOrden.length }}
                        </template>
        ...
        <div class="offcanvas-body">
            <section class="scroll-section" id="checkboxes">
                <div
                    ...
                    v-if="configuration.commands_fisico == true"
                >
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label">Nº Comanda</label>
                            <el-input
                                v-model="commands_fisico"
                                autofocus
                                @focus="clear_command()"
                                @keyup.enter.native="sendOrden()"
                            ></el-input>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-start">
                    ...
                    <div class="col-md-6 text-end pt-2 pb-2 font-weight-light">
                        <h3 class="badge text-success lead-font-weight-700">
                            Total Pedido: S/. {{ total.toFixed(2) }}
                        </h3>
                    </div>
                </div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <!--  -->
                                        <div
                                            class="coupon rounded d-flex justify-content-between mb-2"
                                            id="card"
                                        >
                                            <div
...
<script>
import splitPayment from "./split_payment.vue";
export default {
        ...
        async sendOrden() {
            if (this.configuration.commands_fisico == true) {
                if (
                    ...
                    this.commands_fisico == null ||
                    this.commands_fisico.length == 0
                ) {
                    return this.$toast.error(
                        "Debe ingresar la comanda fisica"
                    );
                }
            }
