        ...
        <div>
            <div class="d-md-flex flex-wrap justify-content-between ">
                ...
                <div class="pos-action-buttons">
                    ...
                    " class="btn btn-primary pos-btn mb-2" type="button" @click="trigerFunction(3)"
                        style="padding: 5px 5px;">
                        Cerrar
                        Caja
                    </button>
                    <button v-if="true && !isSeller" class="btn btn-primary pos-btn mb-2"
                        :class="boxOperation === 'Cerrar' ? 'btn-primary' : 'btn-danger'" type="button"
                    ...
                    <!-- Recibir Mercaderia -->
                    <button v-if="configuration.receive_merchandise && !isSeller" class="btn btn-primary pos-btn mb-2"
                        type="button" @click="trigerFunction(2)" style="padding: 5px 5px;">
                        <i class="fas fa-people-carry" style="margin-right: 2px;"></i>
                        Recibir <br />
                        Mercadería
                    </button>

                    <button v-if="configuration.restaurant && !configuration.college && !isHotel && !isSeller"
                    ...
                    <button v-if="configuration.show_expenses_incomes_caja && !isSeller"
                    ...
                    <el-badge :value="ordenInBox.length" class="item"
                        v-if="!configuration.college && configuration.aparcado && ordenInBox.length > 0">
                    ...
                    " class="btn btn-primary pos-btn mb-2"
                        :class="cashAvailable < 0 ? 'btn-danger' : 'btn-primary'" type="button"
                        @click="checkCashAvailable" style="padding: 5px 5px;">
