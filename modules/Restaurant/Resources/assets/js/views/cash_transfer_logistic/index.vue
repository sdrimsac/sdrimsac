        ...
        <div class="container-fluid p-l-0 p-r-0">
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-sm-6 d-flex justify-content-end" @click="getCashAvailable">
                        <el-button type="success" icon="el-icon-refresh" size="small">
                            <span class="font-weight-bold">Dinero disponible S/ {{ cashAvailable.toFixed(2) }}</span>
                        </el-button>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid p-l-0 p-r-0">
            <div class="card mb-0">
                ...
                <div class="card-body">
                    ...
                    <data-table :typeUser="typeUser" :resource="resource" :config="config"
                        @clickDownload="clickDownload" class="table-striped">
    ...
    methods: {
        ...
        getCashAvailable() {
            this.$http.get(`/caja/cash-transfer/available-credit`).then(response => {
                ...
                this.cashAvailable = Number(value) || 0;
            });
        },
