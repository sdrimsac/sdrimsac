...
<el-dialog :title="titleDialog" :visible="showDialog" @close="close" @open="create" class="rounded-dialog" :close-on-click-modal="false">
    ...
    <form autocomplete="off" @submit.prevent="submit">
            ...
            <div class="row">
                ...
                <div class="col-md-4" v-if="configuration.principal_cash">
                    <label for="product" class="w-100">
                        ...
                        Usuario arca
                        <el-tooltip class="item" effect="dark" content="si le da click al check  permitira  que el usuario administrador tenga las opciones de usuario arca" placement="top">
                            <i class="fas fa-info-circle"></i>
                        </el-tooltip>
                    </label>
                    <el-checkbox v-model="form.is_arca" label="Es arca"></el-checkbox>
                </div>
        ...
        <div class="form-actions text-end pt-2 pb-2">
            ...
            <el-button type="primary" native-type="submit" :loading="loading_submit" icon="fas fa-save">
                Guardar</el-button>
