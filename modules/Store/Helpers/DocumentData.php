...
class DocumentData
{
    ...
    public function setDocumentCommon($record, $data)
    {
        ...
        $data->document_type_name = $this->func_str_to_upper_utf8($record->document_type->name);
    ...
    public function setEstablishment($establishment)
    {
        ...
        $establishment_entity->address = $this->func_str_to_upper_utf8($establishment->address);
