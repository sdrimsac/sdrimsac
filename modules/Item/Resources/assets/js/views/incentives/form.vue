                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group" :class="{'has-danger': errors.description}">
                            ...
                            <el-input v-model="form.description" readonly> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                    ...
                    <div class="col-md-3">
                        <div class="form-group" :class="{'has-danger': errors.commission_amount}">
                            ...
                            <el-input v-model="form.commission_amount" > <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
