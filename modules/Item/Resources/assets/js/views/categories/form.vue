...
<template>
    ...
    >
        ...
        <form autocomplete="off" @submit.prevent="submit">
            <div class="form-body">
                <div class="row" v-if="configuration.mode_salon">
                    <div class="col-12">
                        <el-checkbox v-model="form.show_count_pos"
                            >Mostrar cantidad en POS
                            <el-tooltip
                                class="item"
                                effect="dark"
                                content="Este contador muestra el total de ventas realizadas en la caja actual para todos los productos/servicios de esta categoría"
                                placement="top"
                            >
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div
                            class="form-group"
                            :class="{ 'has-danger': errors.identifier }"
                        >
                            <label class="control-label">
