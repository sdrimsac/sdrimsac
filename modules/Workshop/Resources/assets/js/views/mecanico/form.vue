            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group" :class="{'has-danger': errors.number}">
                        ...
                        <el-input v-model="form.number" maxlength="8" show-word-limit> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                ...
                <div class="col-md-6">
                    <div class="form-group" :class="{'has-danger': errors.telephone}">
                        ...
                        <el-input v-model="form.telephone" maxlength="9" show-word-limit> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
