...
export default {
    ...
    methods: {
        async avisoOrden(order_item) {

            console.log("🚀 ~ file: dashboard.vue:139 ~ avisoOrden ~ order_item", order_item)

            swal.fire({
                title: "Nueva Orden",
                text: `Nueva Orden de ${order_item.client_name}`,
                icon: "success",
                confirmButtonText: "Aceptar"
            });
            this.notifications.push(order_item);
