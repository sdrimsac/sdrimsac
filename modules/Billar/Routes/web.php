...
use Modules\Billar\Http\Controllers\AreaBillarController;
use Modules\Billar\Http\Controllers\BoxesController;
use Modules\Billar\Http\Controllers\CashController;
use Modules\Billar\Http\Controllers\CasinoController;
...
use Modules\Billar\Http\Controllers\TarifaController;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('billar')->group(function () {
        ...
        Route::get('/tarifa', [TarifaController::class, 'index'])->name('tenant.billar.tarifa');
        /* Route::get('/mecanico/columns', [SellerController::class, 'columns']); */
        Route::get('tarifa/records', [TarifaController::class, 'records']);
        Route::post('tarifa', [TarifaController::class, 'store']);
        Route::get('tarifa/record/{id}', [TarifaController::class, 'record']);
        Route::delete('tarifa/{tarifa}', [TarifaController::class, 'destroy']);

        Route::get('/casino', [CasinoController::class, 'index'])->name('tenant.billar.casino');
        /* Route::get('/mecanico/columns', [SellerController::class, 'columns']); */
        Route::get('casino/records', [CasinoController::class, 'records']);
        Route::post('casino-store', [CasinoController::class, 'store']);
        Route::get('casino/record/{id}', [CasinoController::class, 'record']);
        Route::delete('casino/{tarifa}', [CasinoController::class, 'destroy']);
        ...
        Route::prefix('worker')->group(function () {
            Route::get('/dashboard-pos', [BillarController::class, 'pos']);
        ...
        Route::post('billar_massive', [BillarController::class, 'store_massive']);
        ...
        Route::get('areas', [AreaBillarController::class, 'index'])->name('billar.areas')->middleware("just.super");
        Route::get('areas/columns', [AreaBillarController::class, 'columns']);
        Route::get('areas/records', [AreaBillarController::class, 'records']);
        Route::get('areas/actives', [AreaBillarController::class, 'actives']);
        Route::get('areas/record/{id}', [AreaBillarController::class, 'record']);
        Route::delete('areas/{id}', [AreaBillarController::class, 'active']);
        Route::post('areas', [AreaBillarController::class, 'store']);
