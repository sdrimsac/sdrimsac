...
class OrderNoteController extends Controller
{
    ...
    public function tables() {
        ...
        return compact('customers','users','user_select', 'establishments','currency_types', 'discount_types', 'charge_types','company', 'document_type_03_filter','payment_method_types');
    }
    ...
    public function option_tables()
    {
        ...
        return compact('series', 'document_types_invoice','users','user_select', 'payment_method_types', 'payment_destinations');
    }
    ...
    public function update(OrderNoteRequest $request)
    {
        ...
        DB::connection('tenant')->transaction(function () use ($request) {
          ...
          //  OrderNoteItem::where('order_note_id',$this->order_note->id)->delete();
