    ...
    methods: {
        ...
        async generatePdf() {
            ...
            try {
                ...
                &type=${this.modelType || ""}
                `;
                console.log(endPoint);                const response = await axios.get(endPoint, config);
                    ...
                    iframe.onload = () => {
                        try {
                            setTimeout(() => {
                                ...
                                this.$toast.success("Enviado a impresión. Por favor seleccione la impresora: " + etiquetadora);
                            ...
                            this.$toast.error("Error al imprimir. Descargando PDF");
                ...
                if (printWindow) {
                    ...
                    printWindow.addEventListener('load', () => {
                        try {
                            ...
                            setTimeout(() => {
                                printWindow.print();
                                this.$toast.success(`Seleccione la impresora "${printerName}" para imprimir las etiquetas`);
                            ...
                            console.error("Error al imprimir:", error);
                            this.$toast.error("Error al imprimir. Intente descargar el PDF manualmente.");
                        }
                    });
                    ...
                    setTimeout(() => {
                        if (printWindow.document.readyState !== 'complete') {
                            this.$toast.warning("El PDF está tardando en cargar. Por favor, espere...");
                        }
                    }, 3000);
                    
                } else {
                    this.$toast.error("El navegador bloqueó la apertura del PDF. Verifique la configuración de ventanas emergentes.");
                    return false;
                }
