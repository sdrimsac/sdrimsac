        ...
        <div class="col-sm-6">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
              <span class="text-muted">Preparación de etiquetas</span>
            </li>
          </ol>
        </div>
      </div>
      ...
      <div class="card-body">
        <div class="row">
          ...
          >
            ...
            <el-button class="m-2" type="primary" @click="$refs.file.click()">Subir imagen</el-button>
            <el-button v-if="imageSaved" class="m-2" type="danger" @click="delete_image">
          ...
          >
            ...
            <div class="el-input el-input-group el-input-group--append mb-2">
              <el-select
                v-if="!lector_barcode"
                v-model="product_id"
                @change="changeItem"
              ...
              <el-checkbox v-model="lector_barcode">Lector de código de barras</el-checkbox>
            </div>
            ...
            <div class="row d-flex justify-content-center mt-2">
              <el-radio-group
                ...
                v-model="type"
              >
                <el-radio-button label="Precio venta"></el-radio-button>
                <el-radio-button label="Precio compra"></el-radio-button>
              </el-radio-group>
            </div>
            <div
            ...
            >
              <div class="mt-2 col-12 col-lg-8 col-md-8">
                ...
                <el-select v-model="sale_type" @change="debounce" :disabled="!product_id">
                  <el-option
                    v-for="code in codes"
                    :key="code.id"
                    :value="code.id"
              ...
              <div v-if="sale_type == 1" class="mt-1 col-12 col-lg-8 col-md-8">
                <label
                  class="control-label text-primary"
                  role="button"
                  @click="openDialogForm"
                >Nuevo +</label>
                <el-select @change="debounce" v-model="sale_murc">
                  <el-option
                    v-for="word in words"
                    :key="word.id"
                    :value="word.id"
              ...
              <div v-if="sale_type == 1" class="mt-1 col-12 col-lg-8 col-md-8">
                ...
                <el-input type="number" @input="debounce" v-model="sale_murc_val"></el-input>
              </div>
              <div class="mt-1 col-12 col-lg-8 col-md-8">
                <label class="control-label">Valor:</label>
                <el-input :disabled="!product_id" v-model="sale_code"></el-input>
              </div>
            </div>
            <div
              v-else
            ...
            >
              <div class="mt-2 col-12 col-lg-8 col-md-8">
                <label class="control-label">Tipo de código</label>
                <el-select :disabled="!product_id" @change="debounce" v-model="purchase_type">
                  <el-option
                    v-for="code in codes"
                    :key="code.id"
                    :value="code.id"
              ...
              <div v-if="purchase_type == 1" class="mt-1 col-12 col-lg-8 col-md-8">
                <label
                  class="control-label text-primary"
                  role="button"
                  @click="openDialogForm"
                >Palabras base [Agregar +]</label>
                <el-select @change="debounce" v-model="purchase_murc">
                  <el-option
                    v-for="word in words"
                    :key="word.id"
                    :value="word.id"
              ...
              <div v-if="purchase_type == 1" class="mt-1 col-12 col-lg-8 col-md-8">
                <label class="control-label">Números:</label>
                <el-input type="number" @input="debounce" v-model="purchase_murc_val"></el-input>
              </div>
              <div class="mt-1 col-12 col-lg-8 col-md-8">
                <label class="control-label">Valor</label>
                <el-input :disabled="!product_id" v-model="purchase_code"></el-input>
              </div>
            </div>
          </div>
        </div>
        <div class="row d-flex justify-content-center">
          <div v-if="!product_id" class="col-12 col-lg-4 col-md-4 text-center">
            <el-alert :closable="false" title="Busque y/o seleccione un producto" type="error"></el-alert>
          </div>
        </div>
        ...
        <div v-if="modeloSeleccionado === 'Modelo2'" class="d-flex flex-row justify-content-center">
        ...
        <div v-if="modeloSeleccionado === 'Modelo3'" class="d-flex flex-row justify-content-center">
          <div class="border d-flex flex-column align-items-center h150 w300 overflow-hidden">
            <div class="d-flex flex-fill flex-column justify-content-center align-items-center">
              <img v-show="product_id" id="barcode" alt="barcode" />
              <span></span>
        ...
        >
          ...
          <div
            ...
            :class="
                        ...
                        "
          >
            <div class="bg-white m-1 border col-5 text-center">1</div>
            <div class="bg-white m-1 border col-5 text-center">2</div>
          </div>
          <div
            role="button"
        ...
        <template v-if="typeUser == 'superadmin'">
          <div class="row">
            <div class="col-md-6 col-12">
              ...
              <el-input type="number" v-model="config.density"></el-input>
            </div>
          ...
          <div class="row">
            <div class="col-md-3 col-12">
              ...
              <el-input type="number" v-model="config.margins.top"></el-input>
            </div>
            <div class="col-md-3 col-12">
              <label for="left">Izquierda</label>
              <el-input type="number" v-model="config.margins.left"></el-input>
            </div>
            <div class="col-md-3 col-12">
              <label for="right">Derecha</label>
              <el-input type="number" v-model="config.margins.right"></el-input>
            </div>
            <div class="col-md-3 col-12">
              <label for="bottom">Abajo</label>
              <el-input type="number" v-model="config.margins.bottom"></el-input>
            </div>
          </div>
        </template>
        <div v-if="product_id" class="d-flex justify-content-center mt-2">
          <el-button type="success" @click="generate">Imprimir</el-button>
          <el-button type="danger" @click="generatePdf">Exportar</el-button>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async delete_image() {
      try {
        this.loading = true;
        const response = await this.$http.get(`${this.resource}/delete_image`);
    ...
    async generatePdf() {
      ...
      try {
        ...
        let endPoint = `${this.resource}/generate?stock=${
          ...
          this.paperType
        }&format=${this.QSticker}&barcode=${encodeURIComponent(
          this.product.barras
        )}&type_barcode=${encodeURIComponent(this.typeBarcode)}&location=${this
          .product.location || ""}
                &type=${this.modelType || ""}
                `;
    ...
    async generate() {
      ...
      try {
        ...
        if (etiquetadora) {
          ...
          this.$toast.error("No se ha configurado la impresora de etiquetas.");
        }
    ...
    async Printer(Printer, linkpdf) {
      ...
      console.log("🚀 ~ file: index.vue:868 ~ Printer ~ linkpdf:", linkpdf);
    ...
    changeFormat(quantity) {
      if (this.limitFormat && quantity != 1) {
        this.$toast.error("Código de barra largo, formato no disponible.");
        return;
      }
