                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group" :class="{'has-danger': errors.passenger_fullname}">
                            ...
                            <el-input v-model="transport.passenger_fullname"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                    ...
                    <div class="col-md-3">
                        <div class="form-group" :class="{'has-danger': errors.seat_number}">
                            ...
                            <el-input v-model="transport.seat_number"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                    ...
                    <div class="col-md-3">
                        <div class="form-group" :class="{'has-danger': errors.passenger_manifest}">
                            ...
                            <el-input v-model="transport.passenger_manifest"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                    ...
                    <div class="col-md-6">
                        <div class="form-group" :class="{'has-danger': errors.origin_address}">
                            ...
                            <el-input v-model="transport.origin_address"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                    ...
                    <div class="col-md-6">
                        <div class="form-group" :class="{'has-danger': errors.destinatation_address}">
                            ...
                            <el-input v-model="transport.destinatation_address"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
