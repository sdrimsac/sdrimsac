            ...
            <div class="form-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div
                            class="form-group"
                            :class="{ 'has-danger': errors.sex }"
                        >
                            <label class="control-label">Sexo</label>
                            <el-select v-model="form.sex" filterable>
                                <el-option
                                    v-for="option in sexs"
                                    :key="option.id"
                                    :value="option.id"
                                    :label="option.description"
                                ></el-option>
                    ...
                    <div class="col-md-3">
                        <div
                            class="form-group"
                            :class="{ 'has-danger': errors.ocupation }"
                        >
                            <label class="control-label">Ocupación</label>
                            <el-input v-model="form.ocupation">
                                <i
                                    slot="prefix"
                                    class="el-icon-edit-outline"
                                ></i
                            ...
                            <small
                                class="form-control-feedback"
                                v-if="errors.ocupation"
                                v-text="errors.ocupation[0]"
                            ></small>
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div
                            class="form-group"
                            :class="{ 'has-danger': errors.civil_status }"
                        >
                            <label class="control-label">Estado civil</label>
                            <el-select v-model="form.civil_status" filterable>
                                <el-option
                                    v-for="option in civil_status"
                                    :key="option.id"
                                    :value="option.id"
                                    :label="option.description"
                                ></el-option>
                    ...
                    <div class="col-md-6">
                        <div
                            class="form-group"
                            :class="{ 'has-danger': errors.nacionality }"
                        >
                            <label class="control-label">Nacionalidad</label>
                            <el-input v-model="form.nacionality">
                                <i
                                    slot="prefix"
                                    class="el-icon-edit-outline"
                                ></i
                            ...
                            <small
                                class="form-control-feedback"
                                v-if="errors.nacionality"
                                v-text="errors.nacionality[0]"
                            ></small>
                        </div>
                    </div>
                    <div class="col-md-6">
...
export default {
    ...
    methods: {
        ...
        async submit() {
            await this.$http
                .post(`/${this.resource}/validate_hotel_guest`, this.form)
                .then(response => {
