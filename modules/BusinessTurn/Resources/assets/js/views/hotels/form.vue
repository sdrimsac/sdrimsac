                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group" :class="{'has-danger': errors.name}">
                            ...
                            <el-input v-model="name"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                    ...
                    <div class="col-md-3">
                        <div class="form-group" :class="{'has-danger': errors.ocupation}">
                            ...
                            <el-input v-model="hotel.ocupation"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                    ...
                    <div class="col-md-3">
                        <div class="form-group" :class="{'has-danger': errors.age}">
                            ...
                            <el-input v-model="hotel.age"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                    ...
                    <div class="col-md-3">
                        <div class="form-group" :class="{'has-danger': errors.room_number}">
                            ...
                            <el-input v-model="hotel.room_number"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                    ...
                    <div class="col-md-6">
                        <div class="form-group" :class="{'has-danger': errors.nacionality}">
                            ...
                            <el-input v-model="hotel.nacionality"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                    ...
                    <div class="col-md-6">
                        <div class="form-group" :class="{'has-danger': errors.origin}">
                            ...
                            <el-input v-model="hotel.origin"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                            ...
                            <tbody>
                                <tr v-for="(row, index) in guests" :key="index" width="100%">
                                    ...
                                    <td class="series-table-actions text-center">
                                        <button  type="button" class="btn waves-effect waves-light btn-sm btn-danger" @click.prevent="clickCancelGuest(index)">
