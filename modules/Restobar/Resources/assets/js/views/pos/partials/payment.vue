<!-- MODULO DE COBRO CAJA Principal de Todos los rubros-->
<template>
    <el-dialog :visible="is_payment" @open="date_of_issue" @close="unlockButton" :close-on-click-modal="false"
        ...
        :width="dialogWidth" top="2vh" :title="`Módulo de Cobro ${variation ? '- Variación' : ''}`">
        ...
        <div v-loading="loading_submit" :element-loading-text="loadingText">
            <div class="">
                <div class="pt-1">
                        ...
                        <div class="card bg-light">
                            <div class="card-body">
                                <div class="row" v-if="configuration.college">
                                    <el-checkbox @change="chageRegister" v-model="notRegister">No registrado
                                    </el-checkbox>
                                </div>
                                <!-- Comprobante de Pago  -->
                                <div
                                    class="form-row d-flex align-items-center justify-content-between flex-wrap no-padding">
                                    <div class="form-group col-12 col-md-6 d-flex flex-column pt-0 pb-0">

                                        <div class="shadow-box d-flex justify-content-between flex-wrap pt-0 pb-0">
                                            <el-button-group v-model="form.document_type_id" @change="filterSeries">
                                                <!-- Botón Factura -->
                                                <el-button v-if="invoice" label="01" class="responsive-btn" :style="{
                                                    backgroundColor:
                                                ...
                                                <!-- Botón Boleta -->
                                                <el-button v-if="receipt" label="03" class="responsive-btn" :style="{
                                                    backgroundColor:
                                                        form.document_type_id ===
                                                            '03'
                                                            ? '#FFC107'
                                                    ...
                                                    " title="BOLETA">
                                                    <i class="fas fa-file-alt fa-lg" style="margin-right: 8px;"></i>
                                                    BOLETA
                                                </el-button>
                                                <!-- Botón Nota de Venta -->
                                                <el-button v-if="sale_note" label="80" class="responsive-btn" :style="{
                                                    backgroundColor:
                                                        form.document_type_id ===
                                                            '80'
                                                            ? '#1E88E5'
                                                    ...
                                                    " title="NOTA">
                                                    <i class="fas fa-file-signature fa-lg"
                                                        style="margin-right: 8px;"></i>
                                                    NOTA
                                                </el-button>
                                            </el-button-group>
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex justify-content-between w-100 align-items-center">
                                            ...
                                            <div class="form-group me-1" style="flex: 1 1 auto;">
                                                <!-- <label class="control-label fw-bold" style="font-size: 1rem;">
                                                    <i class="fas fa-hashtag me-2" style="font-size: 1.2rem;"></i>
                                                    Serie
                                                </label> -->
                                                <el-select v-model="form.series_id"
                                                    ...
                                                    <el-option v-for="option in series" :key="option.id" :label="option.full_number
                                            ...
                                            <div class="form-group me-1" style="flex: 1 1 auto;">
                                                <el-tooltip
                                                    ...
                                                    placement="top">
                                                    <el-button icon="fas fa-eye" size="mini" type="primary" @click="
                                                        showListItems = true
                                                        "
                                                        style="font-size: 1rem; padding: 0 10px; height: 25px; border-radius: 16px; display: flex; align-items: center; justify-content: center;">
                                                    </el-button>
                                                </el-tooltip>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <div class="d-flex align-items-center justify-content-between w-100 mb-1">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <el-tooltip content="Crear Cliente" placement="top">
                                                    ...
                                                    " @click="
                                                        createClient
                                                    " class="btn_guardarsmall me-2" type="primary" size="small">
                                                ...
                                                <el-tooltip content="Editar Cliente" placement="top">
                                                    ...
                                                    " @click="
                                                        openDialogPerson
                                                    " class="btn_excelsmall" type="success" size="small">
                                        ...
                                        <el-select class="w-100" ref="select_person" :loading="loading" v-model="value"
                                            ...
                                            @change="changeCustomer" @keyup.native="
                                                keyupCustomer
                                            ">
                                            <el-option v-for="(option,
                                                idx) in customers" :key="idx" :label="option.description
                                                    " :value="option.id"></el-option>
                                        </el-select>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <el-input v-model="form.customer_telephone
                                            " type="text" class="w-100" placeholder="Número de WhatsApp" maxlength="9"
                    ...
                    <div class="mt-1 mb-2 row g-2 align-items-stretch">
                        <!-- Column 1: Total Venta -->
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="d-flex justify-content-between align-items-center p-3"
                                style="background-color: #f8f9fa; border-radius: 5px; height: 100%;">
                                <label class="control-label text-primary fs-5 fw-bold mb-0">
                                    Total Venta
                                </label>
                                <!-- <label>Total Venta</label> -->
                                <span class="control-label text-primary fs-5 fw-bold mb-0 text-right">
                                    <!-- S/ {{ " " + form.total }} -->
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="p-2" :style="{
                                ...
                                height: 'auto',
                                minHeight: '50px',
                                opacity: conf.show_discounts_payment ? 1 : 0.5,
                                pointerEvents: conf.show_discounts_payment ? 'auto' : 'none'
                            }">
                                <!-- Fila 1: Título "Desc. S/" e input -->
                                <div class="d-flex align-items-center justify-content-start mb-2">
                                    <label class="control-label text-success fs-5 fw-bold me-2">
                                        {{
                                ...
                                <div class="d-flex justify-content-center">
                                    ...
                                    <el-switch v-model="usePercent" @change="togglePercent"
                                        :disabled="!enabled_discount || !conf.show_discounts_payment"
                                        active-text="Porcentaje" inactive-text="Monto" active-color="#073f68"
                                        inactive-color="#ff4949"
                                        style="transform: scale(0.9); margin-right: 10px;"></el-switch>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="d-flex justify-content-between align-items-center p-3"
                                style="border-radius: 5px; height: 100%;" :class="{
                                    'bg-danger text-white': form.difference < 0,
                                    'bg-success text-white': form.difference > 0,
                                    'bg-primary text-white': form.difference === 0
                                }">
                                <label class="control-label fs-5 fw-bold text-white mb-0" v-text="form.difference < 0
                                    ? 'Faltante: '
                                    : 'Vuelto: '
                                    "></label>
                                <span v-if="is_payment == true" class="control-label fs-5 fw-bold text-white">
                                    {{ currencySymbol }}
                                    {{
                                        form.difference
                                            .toFixed(2)
                    ...
                    <div class="row">
                                ...
                                <div class="radio-tile-group2 flex-wrap">
                                    ...
                                    <div class="input-container2 border rounded-sm" v-if="configuration.culqi">
                                        ...
                                        <div class="radio-tile2"
                                            ...
                                            <label for="Tarjeta" class="radio-tile-label2"></label>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-12 mb-2">
                            <div class="row">
                                ...
                                <div>
                                    <template v-if="bank_accounts.length != 0">
                                        <div class="d-flex align-items-center">
                                            <el-checkbox @change="transferPayment"
                                                v-model="form_payment.is_bank"></el-checkbox>
                                        ...
                                        <el-select :disabled="!form_payment.is_bank" v-model="form.bank_account_id"
                                            ...
                                            <el-option v-for="bank in bank_accounts" :key="bank.id"
                                                :label="`${bank.description}-${bank.number}`" :value="bank.id">
                                            </el-option>
                                        </el-select>
                                        <el-input v-if="form_payment.is_bank && form.bank_account_id"
                                            :disabled="!form_payment.is_bank" class="mt-1" placeholder="Nro Operación"
                                            v-model="form.reference_number">
                                        </el-input>
                                    </template>
                                    <template v-else>
                                        <span class="text-danger">No hay cuentas bancarias registradas</span>
                                    </template>
                                </div>

                                <!-- N° de Operación -->
                                <div class="mt-1" v-if="methodsValidate.includes(form.method_pay)">
                                    <div class="d-flex align-items-center">
                                        <el-input placeholder="N° De Operacion" v-model="operation_number" size="mini"
                                            class="d-inline-flex">
                                        </el-input>
                                    </div>
                                </div>
                                ...
                                <!-- Cargos de Tarjeta -->
                                <div class="col-12 mt-1" v-if="hasCreditCardCharge && configuration.credit_mode">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between ">
                                        ...
                                        <span class="h6 font-weight-bold"
                                            ...
                                            S/ {{ chargeCredit.total_charge.toFixed(2) }}
                                        </span>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="d-flex justify-content-center mx-3">
                                            <el-radio-group @change="calculateCharge" v-model="chargeCredit.credit_type"
                                                size="mini" style="color: #004085; display: flex; align-items: center;">
                                                <el-radio-button label="1"
                                                    style="background-color: #073f68; color: white;">%</el-radio-button>
                                                <el-radio-button label="2"
                                                    style="background-color: #073f68; color: white;">S/</el-radio-button>
                                            </el-radio-group>
                                            <!-- <span class="ms-2 h6 font-weight-bold" v-if="chargeCredit.total_charge !== 0 && chargeCredit.amount">
                                                S/ {{ chargeCredit.total_charge.toFixed(2) }}
                                            </span> -->
                                        </div>
                                    </div>
                        ...
                        <!-- Column 3: Puntos Acumulados -->
                        <div class="col-lg-4 col-md-12 mb-2"
                            v-if="configuration.is_promotion_document || configuration.promotions_by_points">
                            <div class="card bg-light mb-2">
                                <div class="card-header" style="padding: 4px;">
                                    <strong>Puntos del Cliente</strong>
                                </div>
                                <div class="card-body" style="padding: 10px;">
                                    <div class="row">
                                        <div class="col-6 d-flex flex-column align-items-center justify-content-center">
                                            <span class="fw-bold text-center">Acumulados</span>
                                            <el-button type="primary"
                                                style="background-color: #1976d2; color: #fff; border: none; font-weight: bold; display: flex; align-items: center;">
                                                <i class="fas fa-coins" style="margin-right: 6px;"></i>
                                                {{ Number(pointsMessage || 0).toFixed(0) }}
                                            </el-button>
                                        </div>
                                        <div class="col-6 d-flex flex-column align-items-center justify-content-center">
                                            <span class="fw-bold text-center">Ganados Venta</span>
                                            <el-button type="primary"
                                                style="background-color: #1976d2; color: #fff; border: none; font-weight: bold; display: flex; align-items: center;">
                                                <i class="fas fa-coins" style="margin-right: 6px;"></i>
                                                {{ Number(ventalista || 0).toFixed(0) }}
                                            </el-button>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label for="promotion" class="">Promoción</label>
                                        <div class="">
                                            <el-select :disabled="isClientesVarios()" v-model="form.promotion_id"
                                                filterable clearable placeholder="Promoción" @change="changePromotion">
                                                <el-option v-for="(option,
                                        ...
                                        <div class="col-md-12 form-group" v-if="promotionDocument && hasPromotionText">
                                        ...
                                        ">
                                            <el-button class="btn_guardarsmall" @click="Promotion()" type="primary">
                                                Canjear
                                            </el-button>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4" v-if="form_payment.payment_method_type_id == '01'">
                            <div class="d-flex align-items-end mb-2">
                                ...
                                <div>
                                    <template v-if="form.payment_condition_id == '01'">
                                        <el-button class="btn_guardarsmall" type="primary" @click="addPayment"
                                            :disabled="disabledAddPayment()">
                                            <span style="white-space: nowrap;">Agregar</span>
                                        </el-button>
                                    </template>
                                    <template v-else>
                                        <el-button class="btn_guardarsmall" type="primary" @click="addPayment"
                            ...
                            <div class="d-flex justify-content-center">
                                <button type="primary" class="btn_billetessmall me-2" @click="setAmountCash(10)">
                                    10
                                </button>
                                <button type="primary" class="btn_billetessmall me-2" @click="setAmountCash(20)">
                                    20
                                </button>
                                <button type="primary" class="btn_billetessmall me-2" @click="setAmountCash(50)">
                                    50
                                </button>
                                <button type="primary" class="btn_billetessmall me-2" @click="setAmountCash(100)">
                                    100
                                </button>
                                <button type="primary" class="btn_billetessmall me-2" @click="setAmountCash(200)">
                                    200
                                </button>
                            </div>
                        </div>
                        <!-- Pagos y Creditos con CPE -->
                        <div class="col-8">
                            ...
                            <div class="mb-3 d-flex align-items-center">
                                <table class="table" v-if="currentPayments.length != 0">
                                    <thead style="background-color: #073f68; color: #fff;">
                                        <tr>
                                            <th colspan="5" class="text-left text-white">
                                                {{
                                        ...
                                        <tr v-for="(paymnt, idx) in currentPayments" :key="idx"
                                            ...
                                            <td>
                                                <el-button circle size="mini"
                                                    style="background: #073f68; color: #fff; border: none; font-weight: bold;"
                                                    disabled>
                                                    {{ idx + 1 }}
                                                </el-button>
                                            </td>
            ...
            <div class="col-lg-12">
                <div class="card bg-light text-dark p-1">
                    <div class="row">
                        <!-- Columna 1 -->
                        <div class="col-lg-4">
                            <!-- Modo de Pago Contado/Crédito/Crédito a Cuotas -->
                            <div class="mb-3 w-100" v-if="
                                form.document_type_id == '01' ||
                                form.document_type_id == '03'
                            ">
                                <label class="fw-bold">Condición de Pago</label>
                            ...
                            <!-- Detracción -->
                            <div v-if="hasDetraction" class="p-1 border rounded  mb-0">
                                <div class="d-flex align-items-center mb-2">
                                    <h6 class="fw-bold mb-0 me-2">Cta. Detracción</h6>
                                    <label class="flex-grow-1 me-2"
                                        style="padding: 6px 12px; background: #f5f5f5; border-radius: 4px; border: 1px solid #ddd;">
                                        {{ company.detraction_account }}
                                    </label>
                                ...
                                <div class="mb-2 d-flex align-items-center">
                                    <label for="account" class="fw-bold me-2"></label>

                                </div>

                                <div class="d-flex align-items-center">
                                    <label for="amount" class="fw-bold me-2">Monto</label>
                                    <el-input v-model="form.detraction.amount" readonly class="flex-shrink-1"
                                        style="width: 150px;"></el-input>
                                    <button @click="showDialogDocumentDetraction = true"
                        ...
                        <div class="col-lg-4">
                            <!-- Imprimir -->
                            <div class="row">
                                <div class="d-flex mb-1 justify-content-center gap-2">
                                    <el-button :plain="printerOn != 1" @click="printerOn = 1; updateConfigutation()"
                                        class="print-btn" :type="printerOn == 1 ? 'primary' : ''"
                                        :disabled="printerOn == 1"
                                        style="min-width: 140px; font-weight: bold; font-size: 0.9rem;">
                                        <i class="fa fa-print" style="margin-right: 8px;"></i>
                                        Imprimir
                                    </el-button>
                                    <el-button :plain="printerOn != 0" @click="printerOn = 0; updateConfigutation()"
                                        class="no-print-btn" :type="printerOn == 0 ? 'danger' : ''"
                                        :disabled="printerOn == 0"
                                        style="min-width: 140px; font-weight: bold; font-size: 0.9rem;">
                        ...
                        <!-- Columna 3 -->
                        <div class="col-lg-4">
                            <!-- Resumen de Totales de la Boleta -->
                            <div class="card bg-white text-dark p-2 mb-2" style="font-size: 1rem; font-weight: bold;">
                                <div v-if="form.total_exonerated > 0" class="d-flex justify-content-between">
                                ...
                                <div v-if="form.total_free > 0" class="d-flex justify-content-between">
                                    ...
                                    <span class="text-end" style="min-width: 90px;">{{
                                        Number(form.total_free).toFixed(2) }}</span>
                                </div>
                                <!-- <div v-if="form.items && form.items.length > 0"
                                    class="d-flex justify-content-between">
                                    <span>DESC. POR ÍTEM:</span>
                                    <span class="text-end text-danger" style="min-width: 90px;">-{{ 
                                        form.items.reduce((acc, i) => acc + (Number(i.total_discount) || 0), 0).toFixed(2) 
                                    }}</span>
                                </div> -->
                                <div v-if="form.total_discount > 0" class="d-flex justify-content-between">
                                    <span>DESC. TOTAL:</span>
                                    <span class="text-end text-danger" style="min-width: 90px;">-{{
                                        Number(form.total_discount).toFixed(2) }}</span>
                                </div>
                                ...
                                <div v-if="form.difference > 0" class="d-flex justify-content-between">
                                    <span>VUELTO:</span>
                                    <span class="text-end text-success" style="min-width: 90px;">{{
                                        Number(form.difference).toFixed(2) }}</span>
                                </div>
                                ...
                                <div v-if="affectation_optional_id === '10'" class="mt-2 p-2 border rounded bg-light">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <span class="text-info">IGV:</span>
                                        <span>{{ igv10.toFixed(2) }}</span>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <span class="text-info">TOTAL:</span>
                                        <span>{{ totalIgv10.toFixed(2) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <show-split-payment-form :form="form" :series="all_series" :orden_items="orden_items"
            @receivePayments="receivePayments" @receiveProducts="receiveProducts" :total="form.total"
            :showSplitPayment.sync="showSplitPayment" :customer_default="customer_default" @setPayments="setPayments"
            :printerOn="printerOn" :establishments="establishments">
        </show-split-payment-form>
        <person-college-form v-if="showCollegePersonDialog" :showDialog.sync="showCollegePersonDialog" :extern="true"
            :fromPerson="true" :recordId="collegePersonId">
        </person-college-form>
        <document-detraction v-if="form && form.total > 0 && form.detraction"
            :currency-type-id-active="form.currency_type_id" :detraction="form.detraction"
            :exchange-rate-sale="form.exchange_rate_sale" :operation-type-id="form.operation_type_id"
            :showDialog.sync="showDialogDocumentDetraction" :total="form.total"
...
export default {
    ...
    watch: {
        hasExceedBank(newVal) {
            if (newVal) {
                this.$nextTick(() => {
                    this.$swal({
                        icon: 'warning',
                        title: 'Atención',
                        html: `Recuerde que debido al monto deberá hacer esta operación mediante Bancarización.<br>Ingrese en el campo "Observaciones" el número de voucher o número de operación.`,
        ...
        affectation_optional_id(newVal) {
            console.log(newVal, "we3qwrewrfewtewsr");
            this.affectationwindows(newVal);
        },
        'form.total'(newVal) {
    ...
    async created() {
        ...
        console.log("Payment created", this.form);
        await this.$http.get(`/restobar/pos/series`).then(response => {
    ...
    methods: {
        ...
        affectationwindows(newVal) {
            ...
            if (newVal === '10') {
                // Usar percentage_igv si está definido y es numérico, si no usar 0.18
                let igvPercent = (this.percentage_igv !== undefined && this.percentage_igv !== null && this.percentage_igv !== '' && !isNaN(Number(this.percentage_igv)))
                    ? Number(this.percentage_igv) / 100
                    : 0.18;
                this.igv10 = Number(this.form.total) * igvPercent;
                this.opGravadaIgv10 = Number(this.form.total) - this.igv10;
                this.totalIgv10 = Number(this.form.total);
                this.showIgvCalculo = true;
            } else {
                this.showIgvCalculo = false;
            }
            this.$forceUpdate();
        },
        ...
        formatItems(items = [], affectation = null) {
            console.log('[LOG] formatItems - percentage_igv:', this.percentage_igv);
            items = items.map(i => {
        ...
        async searchClientOne(number) {
            let url = `/restobar/search_customers?value=${number}`;
        ...
        async keyupCustomer(e) {
            ...
            this.time = setTimeout(async () => {
                ...
                let url = `/restobar/search_customers?value=${this.input_person.number}`;
                if (this.configuration.college) {
        ...
        async date_of_issue() {
            ...
            if (!this.form.is_room && !this.form.customer_id) {
                this.value = null;
                this.form.customer_id = null;
            }
        ...
        updateIgvAndRecalculate(newIgv) {
            ...
            if (!this.form.items || this.form.items.length === 0) return;
            // Actualiza el IGV de cada item
            this.form.items = this.form.items.map(item => ({
                ...item,
                percentage_igv: newIgv
            }));
            // Recalcula los totales
            this.reCalculateTotal();
        },
        // USO: Llama a este método cuando cambie el IGV desde el componente padre:
        // this.$refs.payment.updateIgvAndRecalculate(nuevo_igv);

        // para recalcular los totales
        reCalculateTotal() {
            console.log('[LOG] reCalculateTotal - percentage_igv:', this.percentage_igv);
