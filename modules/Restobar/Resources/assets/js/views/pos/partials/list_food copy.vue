...
<template>
    <div>
                                    ...
                                    <div @click="
                                        ...
                                        <div
                                            ...
                                            <el-tooltip class="item" effect="dark"
                                                ...
                                                <span :class="`lead-font-weight-600 `" style="color: #fff;">
                                                    {{ data.description.toUpperCase() }}
                                                </span>
                                            </el-tooltip>
                                            <!-- <el-tooltip class="item" effect="dark"
                                            ...
                                            <div class="col-8">
                                                <div class="d-flex justify-content-end align-items-center"
                                                    ...
                                                    <span style="color: red; font-weight: bold;">
                                                        : {{ data.item.location && data.item.location.trim() !== '' ?
                                                            data.item.location.toUpperCase() :
                                                            'S-U' }}
                                                    </span>
                                                </div>
                                                <div v-if="data.types && data.types.length > 0"
                                                ...
                                                <template v-if="(data.item.lots_enabled == 1 && data.item.date_of_due) ||
                                                    ...
                                                    <!-- SI TIENE SERIE -->
                                                    <div v-if="data.item.series_enabled == 1" class="col-12 mb-1"
                                                    ...
                                                    <div v-if="data.item.has_color_size == 1" class="col-12 mb-1"
                                                        style="text-align:right;">
                                                        <span class="badge"
                                                    ...
                                                    <!-- SI ES SERVICIO -->
                                                    <div v-if="data.item.unit_type_id == 'ZZ'" class="col-12 mb-1"
                                                        style="text-align:right;">
                                                        <span class="badge"
                                                    ...
                                                    <template v-if="data.item.stock > 0">
                                                        <div class="d-flex flex-column align-items-end">
                                                            ...
                                                            <span class="badge"
                                                                ...
                                                                <template v-if="data.item.max_quantity">
                                                                    {{ formatedStockPresentation(data.item,
                                                                        data.item.stock).replace(/\bNIU\b/g,
                                                                            'UND').toUpperCase() }}
                                                                </template>
                                                                <template v-else>
                                                                    {{ parseFloat(data.item.stock) }} {{
                                                                        data.item.unit_type && data.item.unit_type.id ?
                                                                            (data.item.unit_type.id === 'NIU' ? 'UND' :
                                                                                data.item.unit_type.id) : '' }}
                                                                </template>
                                                            </span>
                                                        </div>
                                                    </template>
                                                ...
                                                <div class="d-flex justify-content-end align-items-center"
                                                    ...
                                                    <span class="button-container" v-if="configuration.compra_venta"
                                                        style="margin-left: 4px;" @click.stop>
                                                        <el-row>
                                                            <el-button size="mini" class="bg-info custom-el-button"
                                                                round title="Ver historial de compra/venta"
                                                    ...
                                                    <span v-if="configuration.zones_workers" class="button-container"
                                                        style="margin-left: 4px;" @click.stop>
                                                        <el-row>
                                                            <el-button size="mini" class="bg-warning custom-el-button"
                                                                round title="Ver imagen ampliada"
                                ...
                                <div @click="
                                    ...
                                    <div class="overflow-hidden coupon rounded d-flex flex-column justify-content-between p-1 bg-primary text-white"
                                        ...
                                        <el-tooltip class="item" effect="dark" :content="data.description.toUpperCase()"
                                            placement="top-start">
                                            <!-- <span :class="`lead-font-weight-600 fw-bold`" style="color: #fff; ">
                                                <span v-if="data.description && data.description.toUpperCase().length > 30"
                                                        v-html="data.description.toUpperCase().slice(0,30) + '<br/>' + data.description.toUpperCase().slice(30)">
                                                    </span>

                                                <span v-else>{{ data.description.toUpperCase() }}</span>
                                            </span> -->
                                            <span :class="`lead-font-weight-700 ${configuration.trunc_txt
                                                    ? 'd-inline-block text-truncate'
                                                    : ''
                                        ...
                                        <!-- <span
                                            :class="`lead-font-weight-500 ${configuration.trunc_txt ? 'd-inline-block text-truncate' : ''}`"
                                            style="color:#fff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
                                            {{ data.description.toUpperCase() }}
                                        </span>
                                        <template v-if="configuration.trunc_txt">
                                        ...
                                        <div class="col-8">
                                                ...
                                                <template v-if="data.item.stock > 0">
                                                    <div class="d-flex flex-column align-items-end">
                                                        <span class="badge"
                                                            ...
                                                            <template v-if="data.item.max_quantity">
                                                                {{ formatedStockPresentation(data.item,
                                                                    data.item.stock).replace(/\bNIU\b/g, 'UND').toUpperCase()
                                                                }}
                                                            </template>
                                                            <template v-else>
                                                                {{ parseFloat(data.item.stock) }}
                                            ...
                                            <div class="d-flex justify-content-end align-items-center"
                                                ...
                                                <span class="button-container" v-if="configuration.compra_venta"
                                                    style="margin-left:4px;" @click.stop>
                                                    <el-row>
                                                        <el-button size="mini" class="bg-info custom-el-button" round
                                                            title="Ver historial de compra/venta" @click.stop.prevent="clickWarehouseDetail(
                                                                data.id,
                                                                data.has_series,
                                                                data.warehouses,
                                                                data.unit_type,
                                                ...
                                                <span v-if="configuration.zones_workers" class="button-container"
                                                    style="margin-left:4px;" @click.stop>
                                                    <el-row>
                                                        <el-button size="mini" class="bg-warning custom-el-button" round
        ...
        <modal-unit-type-id @selectUnitType="onSeriesConfirm" :showDialog.sync="showDialogUnitType"
            :item="currentItem"></modal-unit-type-id>
        <show-color-size-product :limitQty="limitQty" :idx="currentIdx" :item="currentItem"
            :showDialog.sync="showColorSize" :colorSizeSelected.sync="currentColorSize" :establishments="establishments"
            @updateColorSize="updateColorSize" />
        <show-lotes-product :idx="currentIdx" :orden="ordenLot" :item="currentItem" :showDialog.sync="showLotes"
...
export default {
    ...
    methods: {
        async onAddPromotionItems(items) {
            console.log("onAddPromotionItems llamado con items:", items);
            // Cerrar el modal/promociones
            this.showDialogItemPromotion = false;

            // Procesar secuencialmente para poder await en llamadas asíncronas
            for (const promo of items) {
                ...
                let foundIndex = this.listFoods.findIndex(
                    f => (f.item && f.item.id == promoItemId) || f.id == promoItemId
                );
                let found = foundIndex >= 0 ? this.listFoods[foundIndex] : null;
                if (!found) {
                    found = this.foods.find(
                        f => (f.item && f.item.id == promoItemId) || f.id == promoItemId
                    );
                    if (found) {
                        // si lo encontramos en foods pero no en listFoods, obtener el índice en listFoods si existe
                        foundIndex = this.listFoods.findIndex(
                            f => (f.item && f.item.id == promoItemId) || f.id == promoItemId
                        );
                    }
                }
                ...
                // Antes de agregar, si el item es receta/item-set debemos validar en el servidor
                // Usar los mismos chequeos que addFood: setItemCheckStock / setItemPolicy
                try {
                    // Determinar cantidad ya presente en la orden para este item
                    ...
                    // Para cada unidad solicitada, ejecutar las validaciones y agregar
                    for (let i = 0; i < qty; i++) {
                        // calcular qtyCandidate para validaciones (existing + 1)
                        let qtyCandidate = existingQty + 1;

                        let pass = true;
                        // Si es item-set (receta) o promotions_items flag
                        if ((found.item && found.item.is_set == 1) || (found.item && found.item.promotions_items == 1)) {
                            // Si restaurant usa stock check
                            ...
                            if (this.configuration.sales_stock == true && !quotation_stock && found.item.unit_type_id != "ZZ") {
                                // Para restaurant (stock) usar setItemCheckStock, para otros usar setItemPolicy
                                if (this.configuration.restaurant) {
                                    pass = await this.setItemCheckStock(found.item.id, qtyCandidate);
                                } else {
                                    pass = await this.setItemPolicy(found.item.id, qtyCandidate);
                                }
                            }

                            if (pass === false) {
                                console.info(`Promoción: el check para el item ${found.item.id} falló, no se agregará.`);
                                break; // no intentar más unidades de este promo
                            }

                            // Si el item-set requiere selección (modal abierto) detener y guardar contexto
                            if (this.showDialogItemSet) {
                                this.pendingItemSetAdd = { index: foundIndex >= 0 ? foundIndex : 0, type: null, selectSerie: false, categoria: null, color_size: [], promotion: { promotionId, promoItemId } };
                                console.log("addFood promocional pausado esperando confirmación de item set", this.pendingItemSetAdd);
                                // Abrir modal si no está abierto (la lógica puede ya abrirla desde setItemPolicy)
                                this.showDialogItemSet = true;
                                break; // salir del loop de unidades
                            }
                        }

                        // Clonar objeto para no mutar el original
                        this.selectedFood = JSON.parse(JSON.stringify(found));
                        // Marcar metadatos de promoción para que el padre pueda identificar origen
                        this.selectedFood.promotion = {
                            promotion_id: promotionId,
                            promotion_item_id: promoItemId
                        };

                        console.log("Agregando item de promoción:", this.selectedFood);

                        // Llamar addFood con el índice si está disponible, sino pasar 0
                        const idxToUse = foundIndex >= 0 ? foundIndex : 0;
                        await this.addFood(idxToUse, null, false);

                        // aumentar existingQty para la siguiente iteración
                        existingQty += 1;
                    }
                } catch (err) {
                    console.error("Error procesando promoción:", err);
                    continue;
                }
            }
        },
