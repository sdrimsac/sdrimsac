...
/* Reduce font-size slightly on narrow screens for improved fit and make dialog wider */
@media (max-width: 768px) {
    /* make the dialog occupy ~95% of the viewport width on small screens
       Use 95vw to ensure it reaches near the edges of the viewport while
       preserving a small gutter. Also add overrides for Element UI wrapper
       and transform rules so the dialog truly centers. */
    .items-promotions-dialog,
    .el-dialog__wrapper .items-promotions-dialog,
    .el-dialog__wrapper .items-promotions-dialog .el-dialog {
    ...
    /* override positioning/transform to ensure horizontal centering */
    .items-promotions-dialog,
    .el-dialog__wrapper .items-promotions-dialog {
        left: 50% !important;
        top: 6vh !important; /* bring it a bit down from the top on mobile */
