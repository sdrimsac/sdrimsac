...
export default {
    ...
    async created() {
        ...
        await this.getTags();
        this.$root.$on("addDataMozo", this.addProductToOrder);
    },
    components: {
        swal,
        Pinform,
    ...
    methods: {
        changeNamePdf() {
            ...
            ordens[idx].food.description = this.description;
        ...
        changeName(idx) {
            this.currentIdx = idx;
            let ordens = [...this.localOrden];
            this.description = ordens[idx].food.description;
        ...
        closeDialog(ordenId = null) {
            ...
            //console.log('ordenToAdd:', ordenToAdd); // Log to check the data being emitted
            //this.$root.$emit("addDataMozo", ordenToAdd);
