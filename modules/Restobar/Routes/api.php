...
use Modules\Restobar\Http\Controllers\StatusTableController as ControllersStatusTableController;
...
Route::prefix('restobar')->group(function () {
    ...
    Route::middleware(['auth', 'locked.tenant'])->group(function () {
        ...
        Route::get('status-tables/records', [ControllersStatusTableController::class, 'records']);
