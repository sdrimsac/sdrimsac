...
use Modules\Restobar\Models\StatusTable;
use Modules\Restobar\Http\Resources\TableCollection;
...
class DashboardController extends Controller
{
    ...
    public function pos()
    {
        ...
        $lareaId = $area_id;
        return view('restobar::pos.dashboard', compact(
            'limit_month_amount',
            'month_amount',
            'pending_order',
            'lareaId',
    ...
    public function kitchen()
    {
        ...
        return view('restobar::kitchen.dashboard', compact('configuration', 'areas', 'area_id', 'foods', 'categories', 'status_table'));
    }
    public function index()
    {
        ...
        try {
            ...
            $status_table = StatusTable::all();
            return view('restobar::worker.index', compact('configuration', 'areas', 'tables_active', 'categories', 'status_table', 'company', 'tables_area'));
        } catch (Exception $e) {
            return [
