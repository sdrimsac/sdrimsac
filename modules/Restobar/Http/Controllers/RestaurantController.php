...
use Modules\Restobar\Http\Requests\AreaRequest;
...
class RestaurantController extends Controller
{
    ...
    {
        return view('restobar::create');
    }


    public function workers_type()
    {
        return view('restobar::configuration.workers_type');
    }
    ...
    {
        return view('restobar::configuration.areas');
    }
    ...
    public function login(Request $request)
    {
        ...
        try {
            ...
            if (strtolower($user->worker_type->description) == "mozo") {
                ...
                $restobar = true;
            } else if (strtolower($user->worker_type->description) == "credists") {
                $credists = true;
    ...
    public function loginWorker()
    {
        ...
        return view('restobar::worker.login');
    }
