...
use Modules\Restobar\Http\Requests\IncomesRequest;
...
class IncomesController extends Controller
{
    ...
    public function incomes_admin()
    {
        ...
        return view(
            ...
            'restobar::incomes.admin',
            compact('cashid', 'groupid', 'categoryid', 'userid', 'subcategoryid', 'soaptypeid')
        );
    }
