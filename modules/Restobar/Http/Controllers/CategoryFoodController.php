...
use Modules\Restobar\Http\Requests\CategoryFoodRequest;
use Modules\Restobar\Models\CategoryFood;
...
class CategoryFoodController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('restobar::food.category_food', compact('categories'));
    }
