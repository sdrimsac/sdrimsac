...
use Modules\Restobar\Models\StatusOrden;
use Modules\Restobar\Http\Requests\StatusOrdenRequest;
...
class StatusOrdenController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('restobar::configuration.status_orden', compact('configurations'));
    }
