    ...
    public function __construct($id, $document_type = 0, $printing = true, $area_id = null, $ids = [], $isEmit = false, $isPrecuenta = false, $url = null, $user_id = null, $url_base = null)
    {
        ...
        switch ($document_type) {
            ...
            case "URL":
                ...
                // $documentLink = url('') . $url;
            case "PR":
                $documentLink = $url_base . "/restobar/promotions-document/promotionPointsPdf/{$id}";
                break;
            case "D":
                $documentLink = $url_base . "/restobar/delivery/ticket?id={$id}&establishment_id={$establishment->id}";
                break;
            case "S":
                // $copies = 1;
                ...
                break;
            case "H":
                $documentLink = $url_base . "/restobar/rooms/print_service/{$id}";
                break;
            case "L":
                $documentLink = $url_base . "/restobar/rooms/print_warranty/{$id}";
                break;
            case "00":
                $documentLink = $url_base . "/restobar/worker/print-ticket?id={$id}&area_id={$zone_id}&ids={$ids_string}&precuenta={$isPrecuenta}";
                break;
            case "0":
                $documentLink = $url_base . "/restobar/worker/print-ticket?id={$id}&area_id={$zone_id}&ids={$ids_string}";
                break;
            case "box":
                $documentLink = $url_base . "/restobar/worker/expenses/print-box?box_id={$id}&area_id={$area_id}";
                break;
            case "01":
