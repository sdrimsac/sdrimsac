...
class DentalController extends Controller
{
    ...
    public function expenses()
    {
        ...
        if ($cash == null) {
            return redirect()->route('dental.cash.index');
        }
        ...
        $cashid = $cash->id;
        //dd($categoryid);
        return view('dental::expenses.index', compact(
            'cashid',
            'groupid',
            'categoryid',
            'userid',
    ...
    public function expenses_admin()
    {
        ...
        if ($cash == null) {
            return redirect()->route('dental.cash');
        }
        $group = Group::where('type', '2')->first();
        $category = Category::where('type', '2')->first();
    ...
    /* public function pos()
    {
        ...
        $pending_order = 0;
        return view('dental::worker.pos', compact('pending_order', 'area_id', 'cash_id', 'worker', 'establishments', 'configuration', 'auth_login', 'company', 'desarrollador'));
    } */
    public function pos()
    {
        $user = auth()->user();
    ...
    public function income()
    {
        ...
        $soaptypeid = $company->soap_type_id;
        //dd($categoryid);
        return view('dental::income.index', compact('groupid', 'categoryid', 'userid', 'subcategoryid', 'soaptypeid'));
    }
