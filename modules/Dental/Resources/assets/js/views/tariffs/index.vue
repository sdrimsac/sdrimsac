    ...
    <div class="card">
      <div class="card-header bg-primary">
        <h4 class="my-0 text-white">
          <i class="fas fa-university"></i> Listado De Tarifarios de Servicios
        </h4>
      ...
      <dental-form :showDialog.sync="showDialog" :recordId="recordId"></dental-form>
    </div>
  </div>
</template>

<script>
import DentalForm from "./form.vue";
