        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 role="button" class="text-right" @click="changeView">
                    ...
                    <div v-show="adding" class="container">
                        ...
                        <div class="details">
                                ...
                                <div class="col md-6">
                                    ...
                                    >
                                        <el-checkbox-button
                                            ...
                                            :label="teeth"
                                            :key="teeth"
                                            @change="updateRangeSelected(teeth)"
                            ...
                            <div v-if="side" class="row mb-1">
                                <div class="col md-6">
                                    <el-checkbox-group v-model="sidesSelected">
                                        <el-checkbox-button
                                            v-for="side in sides"
                                            :label="side.name"
                                            :key="side.name"
                                            @change="setCavitie(side)"
                                            >{{ side.name }}</el-checkbox-button
                                        >
                                    </el-checkbox-group>
                                </div>
                            </div>
...
<script>
import results from "../details/tooth-problems";
...
export default {
    ...
    data() {
        return {
            dialogTitle: `Diente N°: ${this.current_tooth}`,
            loading: false,
            observation: "",
            current_item: null,
            optionSelected: null,
    ...
    watch: {
        current_tooth(newVal) {
            this.dialogTitle = `Diente N°: ${newVal}`;
        }
    },
    created() {},
    ...
    methods: {
        open() {
            this.setDetails(this.current_tooth);
        },
        close() {
