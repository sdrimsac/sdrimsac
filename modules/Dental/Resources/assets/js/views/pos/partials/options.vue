    ...
    export default {
        ...
        methods: {
            ...
            clickSendEmail() {
                ...
                if(this.form.customer_email == null || this.form.customer_email == '') return this.$toast.error('Ingrese el correo')
                this.loading = true
                this.$http.post(`/${this.resource}/email`, {
                    ...
                    .then(response => {
                        if (response.data.success) {
                            this.$toast.success('El correo fue enviado satisfactoriamente')
                        } else {
