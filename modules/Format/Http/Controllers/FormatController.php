...
use Modules\Format\Exports\ReportFormatSaleExport;
use Modules\Format\Exports\ReportFormatPurchaseExport;
use Modules\Format\Exports\ReportAccountingConcarExport;
use Modules\Format\Exports\ReportAccountingFoxcontExport;
        ...
        foreach ($documents as $index => $row)
        {
            ...
            foreach ($row->items as $item) {
                ...
                $rows[] = [
                    ...
                    'col_B' => '05',
                    'col_C' => $number_index,
                    'col_D' => \Carbon\Carbon::parse($date_of_issue)->format('d-m-Y'),
