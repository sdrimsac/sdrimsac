<template>
    <div class="card">
        <div class="card-header bg-primary">
            <h6 class="my-0">Cuentas contables (Ventas)</h6>
        </div>
        <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4"> 
                            ...
                            <div class="form-group" :class="{'has-danger': errors.total_pen}">
                                <el-input v-model="form.total_pen" > <i slot="prefix" class="el-icon-edit-outline"></i></el-input>                                
                        ...
                        <div class="col-md-4"> 
                            ...
                            <div class="form-group" :class="{'has-danger': errors.igv_pen}">
                                <el-input v-model="form.igv_pen" > <i slot="prefix" class="el-icon-edit-outline"></i></el-input>                                
                        ...
                        <div class="col-md-4"> 
                            ...
                            <div class="form-group" :class="{'has-danger': errors.subtotal_pen}">
                                <el-input v-model="form.subtotal_pen" > <i slot="prefix" class="el-icon-edit-outline"></i></el-input>                                
                        ...
                        <div class="col-md-4 mt-4"> 
                            ...
                            <div class="form-group" :class="{'has-danger': errors.total_usd}">
                                <el-input v-model="form.total_usd" > <i slot="prefix" class="el-icon-edit-outline"></i></el-input>                                
                        ...
                        <div class="col-md-4 mt-4"> 
                            ...
                            <div class="form-group" :class="{'has-danger': errors.igv_usd}">
                                <el-input v-model="form.igv_usd" > <i slot="prefix" class="el-icon-edit-outline"></i></el-input>                                
                        ...
                        <div class="col-md-4 mt-4"> 
                            ...
                            <div class="form-group" :class="{'has-danger': errors.subtotal_usd}">
                                <el-input v-model="form.subtotal_usd" > <i slot="prefix" class="el-icon-edit-outline"></i></el-input>                                
