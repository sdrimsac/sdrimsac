...
class ReportSaleConsolidatedController extends Controller
{
    ...
    public function index() {
        ...
        //$establimints=Establishment::where('id',)->first();
    ...
    //    $rec=SaleConsolidatedCollection($records->paginate(config('tenant.items_per_page')));
    ...
    public function pdf(Request $request) {
        ...
        $pdf = PDF::loadView('report::sales_consolidated.report_pdf', compact("records", "company", "establishment", "params","user"));
