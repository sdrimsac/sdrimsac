...
Route::middleware(['auth', 'redirect.module', 'locked.tenant'])->group(function () {
    ...
    Route::prefix('reports')->group(function () {
        ...
        Route::get('credits/cash_credit/excel', [ReportCreditController::class, 'index_cash_excel']);
        Route::get('credits/cash_credit_product/filter', [ReportCreditController::class, 'index_cash_filter']);
        Route::get('credits/cash_credit_product/records', [ReportCreditController::class, 'index_product_records']);
        Route::get('credits/cash_credit_product/excel', [ReportCreditController::class, 'index_product_excel']);
        ...
        //    Route::get('margin', 'ReportDocumentController@margin')->name('tenant.margin.index');
        Route::get('margins', 'ReportDocumentController@marginindex')->name('tenant.margin.index');
        Route::get('margin/records', 'ReportDocumentController@marginrecords');
        Route::get('margin/export', 'ReportDocumentController@marginexport');
        Route::get('margin/filter', 'ReportDocumentController@filter');
        Route::get('margin/{type}', 'ReportDocumentController@type');
        ...
        Route::get('no_paid/{type}', 'ReportUnpaidController@type')->name('tenant.reports.no_paid.type');
        ...
        Route::get('customers/pdf', 'ReportCustomerController@pdf')->name('tenant.reports.customers.pdf');
        ...
        Route::get('defeated', 'ReportItemController@view_defeated')->name('tenant.reports.defeated');;
        Route::get('items/defeated/pdf', 'ReportItemController@defeated_pdf');
        Route::get('items/defeated/excel', 'ReportItemController@defeated_excel');
        Route::get('items/defeated/records', 'ReportItemController@defeated');
