...
<html lang="en">
   ...
   <table  style="border-collapse: collapse;border-bottom:1px solid #ddd;">
        <tr>
            ...
            @if($company->logo)
                <img src="{{ asset('storage/uploads/logos/'.$company->logo) }}" width="100" />
            @else
                <img src="{{asset('logo/ 700x300.png')}}" alt="Logo" height="40"/>
            @endif
            </td>
            <td width="30%" height="30" align="right" valign="middle" style="font-size:13px !important;  font-family: sans-serif !important;">Reporte de Boveda</td>
        </tr>
   </table>
</header>
