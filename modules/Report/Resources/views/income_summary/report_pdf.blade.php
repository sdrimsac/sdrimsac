                                ...
                                @if($value->sale_note)
                                    ...
                                    <tr>
                                        @php
                                            ...
                                            $date_time_of_issue = "{$value->sale_note->date_of_issue} {$value->sale_note->time_of_issue}";
                                ...
                                @elseif($value->document)
                                    ...
                                    <tr>
                                        @php
                                            ...
                                            $date_time_of_issue = "{$value->document->date_of_issue} {$value->document->time_of_issue}";
                                            $payment_method_description = $payment->payment_method_type->description;
                                            $total = $payment->payment;
