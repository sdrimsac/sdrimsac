                ...
                <table width="100%" class="">
                   ...
                   // dd($boxes);
                    ...
                    <table>
                       ...
                       <tr>
                           <td class="categoria celda_right">Ingresos - Venta : <b> S/. {{$ingresos+$depositos+$transferencia+$yape+$plin}}</b></td>
                       </tr>
                       <tr>
                       ...
                       @if($yape>0.00)
                       <tr>
                           <td class="categoria celda_right">YAPE : <b> S/. {{number_format($yape,2)}}</b></td>
                       </tr>
                       @endif
                       @if($plin>00)
                       <tr>
                           <td class="categoria celda_right">PLIN : <b> S/. {{number_format($plin,2)}}</b></td>
                       </tr>
                       @endif
