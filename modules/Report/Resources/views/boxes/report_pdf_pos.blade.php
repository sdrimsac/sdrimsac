                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="encabezado" width="80">Fecha</td>
                            <td class="encabezado" width="70">Operacion</td>
                            <td class="encabezado" width="205">Cliente</td>
                            <td class="encabezado" width="205">Concepto</td>
                            <td class="encabezado" width="70">Monto</td>
                            <td class="encabezado" width="70">Usuario</td>
