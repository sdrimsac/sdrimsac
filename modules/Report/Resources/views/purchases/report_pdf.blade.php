...
<html lang="en">
    ...
    <body>
    <div>
        <p align="center" class="title">Reporte Compras Realizadas <strong>de: {{ \Carbon\Carbon::parse($date_start)->format('d-m-Y') }}  hasta: {{ \Carbon\Carbon::parse($date_end)->format('d-m-Y') }}</strong></p>
    </div>
                        ...
                        <tbody>
                            @foreach($records as $key => $value)
                                <tr>
                                    ...
                                    <td class="celda"> {{ \Carbon\Carbon::parse($value->date_of_due)->format('d-m-Y') }}</td>
