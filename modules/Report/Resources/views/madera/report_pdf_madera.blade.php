...
<body>
    ...
    @endphp
    <div>
        <p align="center" class="title"><strong>Reporte Madera</strong></p>
    </div>
                            ...
                            <tr>
                                                ...
                                                <td style="text-align: left">
                                                    <small>
                                                        ...
                                                        @if (isset($count['unit_type_name']))
                                                            <span
                                                                class="small2">({{ $count['unit_type_name'] }})</span>
                                                        @endif
                                                    </small>
                                                </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        @php
                                                            ...
                                                            if (isset($count['factor'])) {
                                                                ...
                                                                $purchase =
                                                                    $value['purchase_unit_price'] * $count['count'];
                                                            }
                                ...
                                @if (!$is_service)
                                    <td class="celda">
                                        @php
                                            $purchase =
                                                floatval($value['count']) * floatval($value['purchase_unit_price']);
