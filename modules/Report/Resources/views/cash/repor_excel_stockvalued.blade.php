...
<body>
    ...
    <table>
        ...
        <div style="margin-top:20px; margin-bottom:20px;">
            <table>
                <tr>
                    <td colspan="9" style="border: 1px solid black !important; background-color: #DCDCDC; font-size: 14px; text-align: center;">
                        <p><strong>Valorización de productos </strong></p>
                    </td>
                </tr>
                <tr>
                    <td colspan="9" style="border: 1px solid black !important; background-color: #DCDCDC; font-size: 13px;">
                        <p><strong>Empresa: </strong>{{$company->name}}</p>
                    </td>
                </tr>
                <tr>
                    <td colspan="5" style="border: 1px solid black !important; background-color: #DCDCDC; font-size: 13px; ">
                        <p><strong>Ruc: </strong>{{$company->number}}</p>
                    </td>
                    <td colspan="4" style="border: 1px solid black !important; background-color: #DCDCDC; font-size: 13px; ">
