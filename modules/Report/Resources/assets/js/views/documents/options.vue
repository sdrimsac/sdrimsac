<template>
    <div>
        <el-dialog :title="titleDialog" :visible="showDialog" 
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12  text-left">
                        ...
                        <el-radio-button label="Depositos Bancario - Transferencia"></el-radio-button>
                    </el-radio-group>
                </div>
             
                <div class="col-lg-12 col-md-12 col-sm-12  text-left" v-if="options2=='Ventas Efectivo'">
        ...
        methods: {
           ...
           async clickGenerar(){
                ...
                if(this.options=="Detallado"){
                     let   link=`boxes/reports_type?${query}`;
                        window.open(`${link}`, '_blank');
                }else{
                     let   link=`boxes/reports_resumen_type?${query}`;
                        window.open(`${link}`, '_blank');
                }
                }else{
                       let   link=`boxes/reports_bancario_type?${query}`;
                        console.log(link)
                        window.open(`${link}`, '_blank');
                }
