...
export default {
    ...
    methods: {
        ...
        clickDownload(type) {
            // Enviar parámetros según el periodo seleccionado
            let params = { isFromAdmin: this.isFromAdmin };
            if (this.form.period === 'month' || this.form.period === 'between_months') {
                params.month_start = this.form.month_start;
                if (this.form.period === 'between_months') {
                    params.month_end = this.form.month_end;
                }
            } else if (this.form.period === 'date' || this.form.period === 'between_dates') {
            ...
            if (this.form.person_id) {
                params.person_id = this.form.person_id;
            }
