                ...
                <div class="row mt-2">
                    <div class="col-lg-3 col-md-3">
                        <div class="form-group">
                            ...
                            <el-select
                                v-model="form.date_range_type_id"
                                filterable
                            >
                                <el-option
                                    v-for="option in date_range_types"
                                    :key="option.id"
                                    :value="option.id"
                    ...
                    <template v-if="resource != 'reports/sales-consolidated'">
                        <div class="col-lg-3 col-md-3">
                            <div class="form-group">
                                ...
                                <el-select
                                    v-model="form.order_state_type_id"
                                    filterable
                                >
                                    <el-option
                                        v-for="option in order_state_types"
                                        :key="option.id"
                                        :value="option.id"
                                        :label="option.description"
                                    ></el-option>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tfoot
                            v-if="
                                resource ==
                                    'reports/order-notes-consolidated' ||
...
export default {
    ...
    methods: {
        ...
        async getRecordsByFilter() {
            if (!this.form.person_id && !this.form.seller_id) {
                return this.$toast.error(
                    "Debe seleccionar un cliente o vendedor"
                );
            }
        ...
        getTotals() {
            this.totals = _.sumBy(this.records, it =>
                parseFloat(it.item_quantity)
            );
        },
        getTotals_import() {
            this.totals_import = _.sumBy(this.records, it =>
                parseFloat(it.total)
            );
        },
        getRecords() {
