                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <div
                      class="form-group"
                      :class="{
                        'has-danger': errors.sale_affectation_igv_type_id,
                      }"
                    >
                      <label class="control-label"
                  ...
                  <div class="col-md-4 center-el-checkbox">
                    <div
                      class="form-group"
                      :class="{ 'has-danger': errors.calculate_quantity }"
                    >
                      <el-checkbox v-model="form.calculate_quantity"
                        >Calcular cantidad por precio</el-checkbox
                      ><br />
                      <small
                        class="form-control-feedback"
                  ...
                  <div class="col-md-4">
                    <div
                      class="form-group"
                      :class="{ 'has-danger': errors.purchase_unit_price }"
                    >
                      <label class="control-label"
                  ...
                  <div class="col-md-8">
                    <div
                      class="form-group"
                      :class="{
                        'has-danger': errors.purchase_affectation_igv_type_id,
                      }"
                    >
                      <label class="control-label"
                      ...
                      <small
                        ...
                        v-text="errors.purchase_affectation_igv_type_id[0]"
                      ></small>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div
                      class="form-group"
                      :class="{ 'has-danger': errors.percentage_of_profit }"
                    >
                      <label class="control-label"
                      ...
                      <el-input
                        ...
                        @input="calculatePercentageOfProfitByPercentage"
                      ></el-input>
                      <small
                        class="form-control-feedback"
...
<script>
export default {
  props: ["worker", "showDialog", "recordId", "external"],
  data() {
    return {
