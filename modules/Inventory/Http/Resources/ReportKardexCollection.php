        ...
        switch ($row->inventory_kardexable_type) {
            ...
            case $models[0]: //venta
                return [
                    ...
                    'series' => optional($row->inventory_kardexable)->series,
                    'operacion_efectuada' => 1,
                    'document_type_id' => optional($row->inventory_kardexable)->document_type_id,
                    'asiento' => "V-1",
                    'view' => ($row->quantity < 0) ? true : false,
            ...
            case $models[1]: //Compra
                $purchase_find = Purchase::where("id", $row->inventory_kardexable_id)->first();
                ...
                if ($purchase_find !== null) {
                    return [
                        ...
                        'number' => optional($row->inventory_kardexable)->number,
                        'series' => optional($row->inventory_kardexable)->series,
                        'view' => ($row->quantity < 0) ? false : true,
                        'asiento' => "C-2",
