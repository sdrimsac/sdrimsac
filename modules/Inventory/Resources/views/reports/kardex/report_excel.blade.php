...
<body>
    <table>
        <div style="margin-top:20px; margin-bottom:15px;">
            <table>
                <tr>
                    <td colspan="9" style="border: 1px solid black !important; background-color: #DCDCDC; font-size: 13px; text-align: center;">
                        <h3 ><strong>Reporte Kardex</strong></h3>
                    </td>
                </tr>
                <tr>
                    <td colspan="5" style="border: 1px solid black !important; background-color: #DCDCDC; font-size: 12px;">
                        <p><strong>Empresa: </strong> {{ $company->name }}</p>
                    </td>
                    <td colspan="4" style="border: 1px solid black !important; background-color: #DCDCDC; font-size: 12px;">
                        <p><strong>Fecha: </strong> {{ date('d/m/Y') }}</p>
                    </td>
                </tr>
                <tr>
                    <td colspan="3" style="border: 1px solid black !important; background-color: #DCDCDC; font-size: 12px;">
                        <p><strong>Ruc: </strong> {{ $company->number }}</p>
                    </td>
                    <td colspan="6" style="border: 1px solid black !important; background-color: #DCDCDC; font-size: 12px;">
                        <p><strong>Establecimiento: </strong> {{ $establishment->address }} - {{ $establishment->department->description }} -
                ...
                <tr>
                    <td colspan="9" style="border: 1px solid black !important; background-color: #DCDCDC; font-size: 12px;">
                ...
                <table class="">
                    <thead>
                        <tr>
                            ...
                            @if (!$item_id)
                            <th style="border: 1px solid black !important; background-color: #DCDCDC;">Producto</th>
                            @endif
                            <th style="border: 1px solid black !important; background-color: #DCDCDC;">Fecha y hora transacción</th>
                            <th style="border: 1px solid black !important; background-color: #DCDCDC;">Tipo transacción</th>
                            <th style="border: 1px solid black !important; background-color: #DCDCDC;">Número</th>
                            <th style="border: 1px solid black !important; background-color: #DCDCDC;">NV. Asociada</th>
                            <th style="border: 1px solid black !important; background-color: #DCDCDC;">Feha emisión</th>
                            ...
                            @if ($item_id)
                            <th style="border: 1px solid black !important; background-color: #DCDCDC;">Saldo</th>
                            @endif
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        @endphp
                        <tr>
                            <td class="celda" style="border: 1px solid black !important;">{{ $loop->iteration }}</td>
                            @if (!$item_id)
                            <td class="celda" style="border: 1px solid black !important;">{{ $value->item->description }}</td>
                            @endif
                            <td class="celda" style="border: 1px solid black !important;">{{ $value->created_at->format('d/m/Y H:i') }}</td>
                            ...
                            <td class="celda" style="border: 1px solid black !important;"> {{$formatQuantity($balance) }}</td>
                            @endif
                        </tr>
                        @endforeach
                    </tbody>
