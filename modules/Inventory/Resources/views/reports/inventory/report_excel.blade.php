...
<body>
    <table>
        <div style="margin-top:20px; margin-bottom:15px;">
            <table>
                <tr>
                    <td colspan="5" style="text-align: center; border: 2px solid black; background-color: #DCDCDC; font-size: 14px;">
                        <h3 align="center" class="title"><strong>Reporte Inventario</strong></h3>
                    </td>
                </tr>
                <tr>
                    <td align="center" colspan="3" style=" border: 2px solid black; background-color: #DCDCDC; font-size: 12px;">
                        <p><strong>Empresa: </strong>{{ $company->name }} </p>
                    </td>
                    <td align="center" colspan="2" style="text-align: center; border: 2px solid black; background-color: #DCDCDC; font-size: 12px;">
                        <p><strong>Fecha: </strong> {{ date('Y-m-d') }} </p>
                    </td>
                </tr>
                <tr>
                    <td align="center" colspan="2" style="border: 2px solid black; background-color: #DCDCDC; font-size: 12px;">
                        <p><strong>Ruc: </strong> {{ $company->number }} </p>
                    </td>
                    <td align="center" colspan="3" style="text-align: center; border: 2px solid black; background-color: #DCDCDC; font-size: 12px;">
        ...
        <table cellpadding="0" cellspacing="0" border="0">
            ...
            <tbody>
                <tr>
                    <th class="" style=" text-align:left !important;color:blue;padding:3px;font-size:16px">
                        {{ $value->name ?? '' }}
                    </th>
                </tr>
                <tr>
                    <td class="celda" align="left">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            ?>
                            <tr>
                                <td valign="top" class="celda" style="text-align: center; border: 2px solid black;">{{ $loop->iteration }}</td>
                                ...
                                <td valign="top" class="celda center" style="text-align: center; border: 2px solid black;">{{ $values->warehouses[$iw]->stock ?? '0.00' }}
                                </td>
                                <td valign="top" class="celda center" style="text-align: center; border: 2px solid black;">
                                </td>
