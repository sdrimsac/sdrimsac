    ...
    <div id="register">
        ...
        <table border="0" style="border:0px solid;width:90%; margin-top: 10px;">
            ...
            <tbody>
                ...
                @foreach ($transfer->formatted_details as $idx => $it)
                    <tr>
                        ...
                        <td class="celda_center description_preparacion">
                            @if (!empty($it['formatted_quantity']))
                                {{ $it['formatted_quantity'] }}
                                <div style="padding:0px">
                                    <small style="padding:0px" class="small">
                                        {{ $it['quantity'] }} unds
                                    </small>
                                    <small style="padding:0px" class="small">
                                        {{ $it['unit_type_id'] }} factor
                                    </small>
                                </div>
                            @else
                                {{ $it['quantity'] }} {{ $it['unit_type_id'] }}
                            @endif
                        </td>
                    </tr>
                @endforeach
                ...
                {{-- @foreach ($transfer->detail as $idx => $it)
                    <tr>
                        ...
                        <td class="celda_center description_preparacion">
                            @if (isset($it->item->formatted_quantity))
                                {{ $it->item->formatted_quantity }}
                                <div style="padding:0px">
                                    <small style="padding:0px" class="small">
                                        {{ $it->quantity }} unds
                                    </small>
