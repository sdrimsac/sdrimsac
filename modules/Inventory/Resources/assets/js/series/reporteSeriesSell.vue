<!-- Reporte de Series Vendidas  Admin-->
<template>
    <div>
                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <el-select v-model="form.personas" clearable filterable placeholder="Cliente">
                                        <el-option v-for="option in ListPersonas" :key="option.id" :value="option.id"
                                            :label="option.degres_desc"></el-option>
                                    </el-select>
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <el-date-picker style="width: 100%" v-model="form.date_start"
                                        value-format="yyyy-MM-dd" placeholder="Fecha Inicio">
                                    </el-date-picker>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <el-date-picker style="width: 100%" v-model="form.date_end"
                                        value-format="yyyy-MM-dd" placeholder="Fecha Final">
                                    </el-date-picker>
                                </div>
                            </div>
                            ...
                            <div class="row mt-1 mb-1">
                                <div class="col-12 d-flex justify-content-end align-items-center">
                                    <el-button class="btn_guardarsmall mr-2" type="primary" @click.prevent="getRecordsByFilter"
                                        :loading="loading_submit" icon="el-icon-search">
                                        Buscar
                                    </el-button>

                                    <template v-if="records.length > 0 || NotasDeventas.length > 0">
                                        <el-button class="btn_excelsmall mr-2" type="success" @click.prevent="clickDownload('excel')">
                    ...
                    <div class="col-md-12">
                        <el-tabs v-model="activeName" type="card" tab-position="top">
                            <el-tab-pane label="Facturas - Boletas" name="documents">
                                    ...
                                    <table class="table table-hover table-striped table-condensed  table-responsive"
                                        ...
                                        <thead>
                                            <tr slot="heading" style="background-color: #073f68;">
                                                <th style="color: #fff; width: 3%;">#</th>
                                                <th style="color: #fff; width: 12%;">Tienda</th>
                                                <th style="color: #fff; width: 30%;">Producto</th>
                                                <th style="color: #fff; width: 10%;">Serie</th>
                                                <th style="color: #fff; width: 20%;">Cliente</th>
                                                <th style="color: #fff; width: 5%;"></th>
                                                <th style="color: #fff; width: 7%;">CPE</th>
                                                <th style="color: #fff; width: 8%;">Fecha</th>
                                                <th style="color: #fff; width: 5%;">Precio Venta</th>
                                            </tr>
                                        </thead>
                                        <tbody>
...
>
                                                ...
                                                <td>
                                                    ...
                                                    <br>
                                                    <span style="font-weight:700; font-size:1.1rem; font-family: Arial, Helvetica, sans-serif; line-height:1.2; color:#222;">
                                                        {{ row.descripcion }}
                                                    </span>
                                                </td>
                                                <td>
                                ...
                                <div class="row">
                                    <el-pagination @current-change="getRecordsByFilter"
                                        layout="total, prev, pager, next" :total="pagination.documents.total"
                            ...
                            <el-tab-pane label="Notas De ventas " name="SalesNotes">
                                    ...
                                    <table class="table table-hover table-striped table-condensed  table-responsive"
                                        ...
                                        <thead>
                                            <tr slot="heading" style="background-color: #073f68;">
                                                ...
                                                <th style="color: #fff;">Almacén</th>
                                                <th style="color: #fff;">Producto</th>
                                                <th style="color: #fff;">Serie</th>
                                                <th style="color: #fff;">Cliente</th>
                                                <th style="color: #fff;"></th>
                                                <th style="color: #fff;">CPE</th>
                                        ...
                                        <tbody>
                                            <tr v-for="(row,
                                                index) in NotasDeventas" :key="index" :style="{ backgroundColor: index % 2 === 0 ? '#ffffff' : '#f0f0f0' }">
                                                <td>{{ index + 1 }}</td>
                                                <td>
                                                    {{
                                                        row.establish_description
                                ...
                                <div class="row">
                                    <el-pagination @current-change="getRecordsByFilter"
                                        layout="total, prev, pager, next" :total="pagination.saleNotes.total"
                        ...
                        <el-dialog title="Enviar Reporte Por Whastapp" :visible.sync="showWhatsappForm" width="30%"
                            @close="showWhatsappForm = false">
                            <div class="row col-12">
                                <el-input class="mt-3" v-model="numeroWhatsapp"
                                    placeholder="ingrese numero para enviar " size="small" clearable>Numero a enviar
                                </el-input>
                            </div>
                            <span slot="footer">
                                <el-button class="btn_cancelarsmall" @click="showWhatsappForm = false">
                                    Cancel
                                </el-button>
                                <el-button class="btn_guardarsmall" :loading="loadbuttonwhats" type="primary"
                        ...
                        <whatsapp-modal :company="company" :documentId="documentId" :documentTypeId="documentTypeId"
                            :documentNumber="documentNumber" :sender="sender" :establishment="establishment"
