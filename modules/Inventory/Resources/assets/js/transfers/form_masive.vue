                ...
                <div class="row">
                  ...
                  <div class="col-12 col-lg-12 col-xl-4">
                    <div class="form-group">
                      ...
                      <a
                        v-if="form_add.item_id && hasColor_size"
                        href="#"
                        class="text-center font-weight-bold text-info"
                        @click.prevent="clickColorcodeOutput"
                  ...
                  <div class="col-12 col-lg-12 col-xl-2">
                    <div class="form-group">
                      ...
                      <el-input
                        :disabled="hasLots || hasColor_size"
                        type="number"
                  ...
                  <tr v-for="(row, index) in form.items" :key="index" width="100%">
                    ...
                    <td>
                      ...
                      >
                        <br />
                        <el-tag
                          v-for="(tag, index) in row.color_size"
                          :key="index"
                        >Color : {{ tag.color }} Talla : {{ tag.size }} Cantidad: {{ tag.selectedQuantity }}</el-tag>
                      </template>
                    </td>
                    <td>
...
export default {
  ...
  methods: {
    ...
    async changeWarehouseInit(query = "", search = false) {
      ...
      this.form.items = [];
      let warehouse = this.warehouses.find(w => w.id == this.form.warehouse_id);
    ...
    async changeItem() {
      this.currentItem = this.items.find(i => i.id == this.form_add.item_id);
      ...
      this.hasLots = this.form_add.lots_enabled || this.form_add.series_enabled;
      this.hasColor_size =
    ...
    async submit() {
      if (!this.form.printer && !this.isDirect) {
        return this.$toast.warning("Recuerde Seleccionar una impresora.");
      }
      if (!this.form.description) {
        return this.$toast.error("Debe agregar el motivo de traslado.");
      }
