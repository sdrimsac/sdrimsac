            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <el-input v-model="form.stock" :readonly="true"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="control-label">Cant. Trasladada</label>
                        <el-input v-model="form.quantity"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label">Almacén Inicial</label>
                        <el-input v-model="form.warehouse_description" :readonly="true"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <div class="form-group" :class="{'has-danger': errors.detail}">
                        ...
                        <el-input v-model="form.detail"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
