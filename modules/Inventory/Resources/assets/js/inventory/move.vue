                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <el-input v-model="form.quantity" :readonly="true"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <el-input v-model="form.quantity_move"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                        </div>
                    </div>
                    <div class="col-md-6">
