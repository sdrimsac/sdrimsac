    ...
    <div class="card mb-0 pt-0 pt-md-0">
        ...
        <div class="card mb-0">
            ...
            <div class="card-body" style="padding: 10px;">
                <data-table :resource="resource" :establecimiento.sync="establecimiento" :configurations="configurations" class="table-striped"
                    ...
                    <tr slot="heading" width="100%" class="bg-primary">
                        ...
                        <th v-if="!item_id" class="text-white" style="width: 15%;">Producto</th>
                        <!-- <th class="text-white" style="width: 8%;"></th> -->
                        <th class="text-white" style="width: 8%;">Usuario</th>
                        <th class="text-white" style="width: 12%;">Tipo transacción</th>
                        <th class="text-white text-center" style="width: 8%;">Número</th>
                        <th class="text-white text-center" style="width: 7%;">NV. Asociada</th>
                        <th class="text-white text-center" style="width: 9%;">Entrada</th>
                        <th class="text-white text-center" style="width: 9%;">Salida</th>
                        <th class="text-white text-center" style="width: 9%;">Saldo</th>
                        
                    </tr>
                    <tr slot-scope="{ index, row }" :class="{ disable_color: !row.active }" :style="{ backgroundColor: index % 2 === 0 ? '#ffffff' : '#f0f0f0' }">
                        <td>{{ index }}</td>
                        <td v-if="!item_id">
                            <template v-if="row.user_avatar">
                                <img :src="row.user_avatar" alt="avatar"
                                    style="width:40px; height:50px; border-radius:40%; margin-right:5px; vertical-align:middle;">
                            </template>
                            <br>
                            {{ row.item_name }}
                        </td>
                        ...
                        <td class="text-left align-middle">
                            <span style="font-weight: bold; font-size: 1.2em;">
                                {{ row.user_name || (row.user && row.user.name) || '—' }}
                            </span>
                            <br>
