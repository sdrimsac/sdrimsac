        ...
        <div class="col-md-12 col-lg-12 col-xl-12 ">
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-3">
                    ...
                    <template>
                        <el-input placeholder="Buscar" v-model="form.item_id" style="width: 100%;" prefix-icon="el-icon-search" @input="getRecords">
                        </el-input>
                    </template>
                </div>
                <!-- <div class="col-md-2">
                ...
                <!-- <div class="col-md-3">
                    <div class="form-group">
                        <el-button type="primary" class="" @click="regularizarStock">
