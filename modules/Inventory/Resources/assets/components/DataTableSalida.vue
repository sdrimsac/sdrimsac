        ...
        <div class="col-md-12 col-lg-12 col-xl-12 ">
            <div class="row mt-2">
                ...
                <div class="col-lg-3 col-md-4 col-sm-12 pb-2">
                    ...
                    <el-date-picker v-model="form.date_start" type="date" style="width: 100%;" placeholder="Fecha inicial" value-format="yyyy-MM-dd" @change="getRecords">
                    </el-date-picker>
                </div>
                <div class="col-md-2 col-lg-3">
                    <label for="date_end">Fecha final</label>

                    <el-date-picker v-model="form.date_end" type="date" style="width: 100%;" placeholder="Fecha final" value-format="yyyy-MM-dd" @change="getRecords">
                    </el-date-picker>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="control-label">Filtro Por Productos</label>
                        <el-select v-model="form.description" clearable filterable>
    ...
    methods: {
        async clickDownload(type) {
            ...
            if (type == "pdf") {
                ...
                const response = await this.$http.get(`/${this.resource}/${type}/?${query}`, {
                    responseType: "blob"
                });
