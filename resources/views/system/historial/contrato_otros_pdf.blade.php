                ...
                <ul>
                    <li><strong>Módulo Caja:</strong>
                        <ul>
                            ...
                            <li>
                                Anulación de comprobantes (Interno y Externo)
                            </li>
                            <li>
                                Notas de Crédito    
                            </li>
                            ...
                            <li>
                                Reporte de Caja por Usuarios
                            </li>
                            <li>
                                Envío de Facturas y Boletas directo a SUNAT
                            </li>
                            <li>
                                Reporte de Cierre de Caja por control de ventas por día y por usuarios, con envíos directo al WhatsApp del administrador de la empresa de EL CONTRATANTE
                            </li>
                        </ul>
                    </li>
                    <li><strong>Módulo Administrador:</strong>
                        <ul>
                            ...
                            <li>
                                Ventas Administrativas (Factura, Boletas y Notas de Venta)
                            </li>
                            <li>
                                Envíos de Factura, Boleta directos a SUNAT
                            </li>
                            <li>
                                Anulación de Comprobantes (Interno y Externo)
                            </li>
                            ...
                            <li>
                                Reporte de Cierre de Caja por Usuarios
                            </li>
                        </ul>
                    </li>
                </ul>
