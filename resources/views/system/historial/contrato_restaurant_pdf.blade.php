    ...
    <div class="content-wrapper">
        <div class="content">
            ...
            <div class="section contract-content">
                ...
                <ul>
                    <li><strong>Módulo Caja:</strong>
                        <ul>
                            <li>
                                Emisión de comprobantes electrónicos ilimitados libre de IGV (Factura, Boleta y Nota de Venta) con envíos directos al WhatsApp del cliente
                            </li>
                            <li>
                                Emisión de comprobantes electrónicos ilimitados con diferentes métodos de pago (Efectivo, Yape, Pling, Izipay, OpenPay, Niubiz, Transferencias y/o Deposito Bancarios)
                            </li>
                            <li>
                            ...
                            <li>
                                Cancelación de ordenes (con PIN de seguridad y motivos de cancelación - se envía     aviso por WhatsApp de la administración)
                            </li>
                            <li>
                                Emisión de documentos por Variación, sin afectar el Stock de platos y productos
                            </li>
                            <li>
                                Ventas aparcadas
                            </li>
                            ...
                            <li>
                                Emisión de Factura con IGV
                            </li>
                            <li>
                                Ingresos y Gastos de Efectivo
                            </li>
                            <li>
                                Envío de Facturas y Boletas directo a SUNAT
                            </li>
                            <li>
                                Anulación de comprobantes (Interno y Externo) Notas de Crédito 
                            </li>
                            <li>
                                Reporte de ventas diarias en pdf más documento Excel con stock de productos (con envíos directo a WhatsApp de la administración) 
                            </li>
                            <li>
                    ...
                    <li><strong>Control Restaurant:</strong>
                        <ul>
                            <li>
                                <strong>MOZO: </strong> (PC, Tablet o Celular) toma de pedidos por mesa, envíos directos a cocina a través de Pantalla o impresión de comandas con ticketera.
                            </li>
                            <li>
                                <strong>COCINA: </strong> Recepción de pedidos con Pc, Laptop, Tablet, Pantalla y/o Ticket
                            </li>
                            <li>
                                <strong>BARRA: </strong> Recepción de pedidos con Pc, Laptop, Tablet, Pantalla y/o Ticket
                            </li>
                        </ul>
                    </li>
