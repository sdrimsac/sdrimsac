<ul class="nav-menus">
    ...
    <h6 class="f-14 f-w-600">{{ $vc_user->name }}</h6></a>
    <p class="mb-0 font-roboto">{{ $vc_user->email }}</p>
    </li>
    <li>
...
<!-- <header class="header">
    <div class="logo-container">
        <a href="{{route('tenant.dashboard.index')}}" class="logo pt-2 pt-md-0">
            ...
            @else
                <img src="{{asset('logo/ 700x300.png')}}" alt="Logo" />
            @endif
        </a>
    ...
    <span class="separator p-0 ml-1 mr-1"></span>
    ...
    <div class="header-right">
        ...
        <div class="switch switch-sm switch-primary" data-toggle="tooltip" data-placement="bottom" title="SUNAT: ENTORNO DE DEMOSTRACIÓN, pulse para ir a configuración">
            ...
            <div class="ios-switch off">
                ...
                <div class="state-background background-fill">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 9px; position: absolute; color: #000;">DEMO</span></div>
        ...
        <ul class="notifications ml-1">
            
            @if($caja_cerrada===false)
            <li class="open text-dark text-center" style="font-size:11px;"  data-toggle="tooltip" data-placement="bottom" title="El Arqueo de Caja esta Pendiente">
                <h5><span class="text-success"><b><i class="fas fa-coins"></i> Aperturada</b></span></h5>
            </li>
            @endif
          

            @if($caja_cerrada===true)
            <li class="open text-dark text-center" style="font-size:11px;" data-toggle="tooltip" data-placement="bottom" title="El Arqueo de Caja esta ya se Realizo">
                <h4><span class="text-danger"><b><i class="fas fa-coins"></i> Caja Cerrada {{$vc_arqueo_date}} {{$vc_arqueo_hora}}</b></span> </h4>
             </li>
        </ul>
        @endif
                ...
                <div class="dropdown-menu notification-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 30px, 0px);">
                    <a href="{{route('tenant.documents.not_sent')}}">
                        <div class="notification-title">
                           <span class="float-right badge badge-default bg-white"><i class="fas fa-arrow-right text-dark "></i></span>Comprobantes pendientes de envío
                        </div>
                    </a>
...
@if($vc_arqueo==false)
<div class="container d-none d-sm-block border">
...
<div class="container d-none d-sm-block">
    <div id="switcher-list" class="d-flex justify-content-center switcher-hover">
        <div class="row">
            ...
            <div class="px-3"><a class="py-3" href="{{ route('tenant.sale_notes.index') }}"><i class="fas fa-fw fa-file-invoice" aria-hidden="true"></i> Nota Venta</a></div>
            <div class="px-3"><a class="py-3" href="{{ route('reports.inventory.index') }}"><i class="fas fa-fw fa-warehouse" aria-hidden="true"></i> Inventario Producto</a></div>
        </div>
    </div>
</div>
@endif  -->
