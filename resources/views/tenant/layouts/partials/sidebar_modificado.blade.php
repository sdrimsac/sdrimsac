...
<style>
/* Responsive: compact horizontal menu at <=1200px
   - reduce icon sizes
   - hide label text to keep menu in the topbar
   - prevent menu from wrapping into a vertical sidebar by forcing nowrap and enabling horizontal scroll if needed
*/
@media (max-width: 800px) {
    ...
    /* Reduce padding of menu items so more icons fit */
    html[data-placement='horizontal'] .nav-container .menu-container .menu > li > a {
        padding: 0 0.4rem !important;
        min-width: auto !important;
    }

    /* Force icon size down (overrides inline styles using !important) */
    html[data-placement='horizontal'] .nav-container .menu-container .menu > li > a i,
    .menu-container .menu > li > a i {
        font-size: 1.2em !important;
        margin-right: 6px !important;
    }

    /* Hide textual labels to keep only icons in compact mode */
    .menu-container .menu > li > a .label {
        display: none !important;
    }

    /* Special case: dashboard (very large icon inline) */
    .menu-container .menu > li > a i.icofont-dashboard {
        font-size: 2.2rem !important;
    }

    /* Keep user and other controls visible but compact */
        ...
        @if (!$roleService->isAccountant($user->worker_type_id))
            ...
            @if (!$roleService->isLogistic() || $roleService->isManagement())
                <li>
                    <a class="{{ $path[0] === 'Dashboard' ? 'active' : '' }}" href="{{ route('tenant.dashboard.index') }}"
                        ...
                        <i class="icofont-dashboard" style="font-size: 3em; color: #ffffff;"></i>
            ...
            <li class="">
                ...
                <a href="#restaurantComponents" data-bs-toggle="collapse" data-role="button"
                    ...
                    <i class="icofont-tools" style="font-size: 1.5em; color: #ffffff; margin-right: 10px;"></i>
                ...
                <ul id="restaurantComponents" class="collapse ">
                     <li>
                            <div
                                style="padding:8px 12px; background: linear-gradient(90deg,#0b5a8a,#032a4a); color:#ffffff; font-size:1.05em; font-weight:700; text-align:center; border-radius:6px; margin:6px 10px;">
                               MANTENIMIENTO
                            </div>
                        </li>
                ...
                <li>
                    <a href="#compras" data-bs-toggle="collapse" data-role="button"
                        ...
                        <i class="icofont-shopping-cart"
                            style="font-size: 1.5em; color: #ffffff; margin-right: 10px;"></i>
            ...
            <li>
                <a href="#invetories" data-bs-toggle="collapse" data-role="button"
                    ...
                    style="padding: 10px !important;">
                    <i class="icofont-box" style="font-size: 1.5em; color: #ffffff; margin-right: 10px;"></i>
        ...
        @if (!$roleService->isLogistic() && !$roleService->isManagement())
            <li>
                <a href="#documents" data-bs-toggle="collapse" data-role="button"
                    ...
                    {{-- <i class="icofont-file-document" style="font-size: 1.5em; color: #ffffff; margin-right: 10px;"></i> --}}
                ...
                <ul id="documents" class="collapse ">
                    ...
                    @if (!$roleService->isAccountant($user->worker_type_id) && $config->cotizaciones)
                        <li>
                            <a class="{{ $path[0] === 'finanzas' ? 'active' : '' }}"
        ...
        @if (!$roleService->isAccountant($user->worker_type_id) && !$roleService->isLogistic() && !$roleService->isManagement() && $noIsArcaProduct )
            <li>
                <a href="#boxes" data-bs-toggle="collapse" data-role="button"
                    ...
                    style="padding: 10px !important;">
                    <i class="icofont-money-bag" style="font-size: 1.5em; color: #ffffff; margin-right: 10px;"></i>
    ...
    @if (!$roleService->isArca() || $user->is_arca)
        <li>
            <a href="#reporte" data-bs-toggle="collapse" data-role="button"
                ...
                style="padding: 10px !important;">
                <i class="icofont-file-alt" style="font-size: 1.5em; color: #ffffff; margin-right: 10px;"></i>
                    ...
                    @if ($user->type == 'superadmin' || ($config->productos_vendidos && !$roleService->isLogistic()))
                        ...
                        <li>
                            <a class="{{ $path[0] === 'documents_ventas' ? 'active' : '' }}"
                                ...
                                <i class="icofont-list" style="font-size: 1.5em;  margin-right: 10px;"></i>
                                <span class="label" style="font-size: 1em; ">Productos Vendidos CPE</span>
                            </a>
                        </li>
                    @endif
                    @if ($user->type == 'superadmin' || ($config->sale_note_venta && !$roleService->isLogistic()))
                        <li>
                            <a class="{{ $path[0] === 'notaventa' ? 'active' : '' }}"
                                ...
                                <i class="icofont-list" style="font-size: 1.5em;  margin-right: 10px;"></i>
                                <span class="label" style="font-size: 1em; ">Productos Vendidos NV</span>
                            </a>
                        </li>
                    @endif
    ...
    @if ($config->credits && $user->is_arca)
        <li>
            <a href="#compras" data-bs-toggle="collapse" data-role="button"
                ...
                data-clicked="{{ $path[0] === 'purchases' ? true : false }}{{ $path[0] === 'purchases' && $path[1] === 'create' ? true : false }}"
                style="padding: 10px !important;">
                <i class="icofont-money" style="font-size: 1.5em; color: #ffffff; margin-right: 10px;"></i>
    ...
    @if ($config->college)
        <li>
            <a href="#college" data-bs-toggle="collapse" data-role="button"
                ...
                style="padding: 10px !important;">
                <i class="icofont-graduate" style="font-size: 1.5em; color: #ffffff; margin-right: 10px;"></i>
    ...
    @if ($config->internet)
        <li>
            <a href="#internetUl" data-bs-toggle="collapse" data-role="button"
                ...
                style="padding: 10px !important;">
                <i class="icofont-wifi-router" style="font-size: 1.5em; color: #ffffff; margin-right: 10px;"></i>
    ...
    @if (
        ...
        <li>
            <a href="#restaurantUl" data-bs-toggle="collapse" data-role="button"
                ...
                data-clicked="{{ $path[0] === 'tasks' ? true : false }}"
                style="padding: 10px !important;">
                <i class="icofont-restaurant" style="font-size: 1.5em; color: #ffffff; margin-right: 10px;"></i>
    ...
    @if ($config->modo_billar && !$roleService->isLogistic())
        <li>
            <a href="#billarUl" data-bs-toggle="collapse" data-role="button"
                ...
                data-clicked="{{ $path[0] === 'tasks' ? true : false }}"
                style="padding: 10px !important;">
                <i class="icofont-billiard-ball" style="font-size: 1.5em; color: #ffffff; margin-right: 10px;"></i>
    ...
    @if ($config->workshop && !$roleService->isLogistic())
        <li>
            <a href="#workshopUl" data-bs-toggle="collapse" data-role="button"
                ...
                <i class="icofont-tools-alt-2" style="font-size: 1.5em; color: #ffffff; margin-right: 10px;"></i>
    ...
    @if ($config->odontologia && !$roleService->isLogistic())
        <li>
            <a href="#dentalUl" data-bs-toggle="collapse" data-role="button"
                ...
                style="padding: 10px !important;">
                {{-- <i class="icofont-billiard-ball icon-parent"></i> --}}
                <i class="fa fas fa-tooth" style="font-size: 1.5em; color: #ffffff; margin-right: 10px;"></i>
    ...
    @if ($user->type == 'superadmin' || ($roleService->isArca() && $config->hotels))
        ...
        <li>
            <a href="#configuration" data-bs-toggle="collapse" data-role="button"
                ...
                style="padding: 10px !important;">
                <i class="icofont-ui-settings" style="font-size: 1.5em; color: #ffffff; margin-right: 10px;"></i>
