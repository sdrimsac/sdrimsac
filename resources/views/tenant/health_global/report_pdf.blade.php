                ...
                <tr>
                    <td width="33%">
                        ...
                        <div>
                            ...
                            <img src="data:{{ mime_content_type(public_path("storage/uploads/logos/{$company->document_logo}")) }};base64, {{ base64_encode(file_get_contents(public_path("storage/uploads/logos/{$company->document_logo}"))) }}" alt="{{ $company->trade_name }}" class="company_logo" style="max-width: 100px;">
                            @else
                            <img src="data:{{ mime_content_type(public_path("storage/uploads/logos/{$company->logo}")) }};base64, {{ base64_encode(file_get_contents(public_path("storage/uploads/logos/{$company->logo}"))) }}" alt="{{ $company->trade_name }}" class="company_logo" style="max-width: 100px;">
                            @endif
                        </div>
                        @endif
                    </td>
                    <td class="text-center">
                        <p class="title text-center">Reporte Global Salud</p>
                    </td>
                    <td width="33%"></td>
                </tr>
            </table>
        ...
        <div class=" ">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="celda" colspan="10" style="background-color: #ccc;">
                            <strong>
                                Total Servicios
                            </strong>
                    ...
                    <tr>
                        <td colspan="9"></td>
                        <td class="celda" colspan="1" style="background-color: #409EFF; color: white;">
                            <strong>
                                Total Medicamentos
                            </strong>
                        </td>
