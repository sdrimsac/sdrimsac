            ...
            <tbody>
                @foreach ($records as $key => $value)
                    <tr>
                        ...
                        <td class="celda" style=" border: 1px solid black;">{{ $value->series }}-{{ $value->number }}
                        </td>
                        ...
                        <td class="celda" style=" border: 1px solid black;">
                            {{ $signal == '07'  ? '-' : '' }}{{ $state == '11' || $state == '09' ? 0 : $value->total_exonerated }}
                        </td>
                        <td class="celda" style=" border: 1px solid black;">
                            {{ $signal == '07' ? '-' : '' }}{{ $state == '11' || $state == '09' ? 0 : $value->total_unaffected }}
                        </td>
                        <td class="celda" style=" border: 1px solid black;">
                            {{ $signal == '07'  ? '-' : '' }}{{ $state == '11' || $state == '09' ? 0 : $value->total_free }}
                        </td>

                        <td class="celda" style=" border: 1px solid black;">
                            {{ $signal == '07'  ? '-' : '' }}{{ $state == '11' || $state == '09' ? 0 : $value->total_taxed }}
                        </td>

                        <td class="celda" style=" border: 1px solid black;">
                            {{ $signal == '07'  ? '-' : '' }}{{ $state == '11' || $state == '09' ? 0 : $value->total_igv }}
                        </td>
                        @php
                            $remain = '';
                        ...
                        <td class="celda" style=" border: 1px solid black;">
                            {{ $signal == '07'  ? '-' : '' }}{{ $state == '11' || $state == '09' ? 0 : $value->total }}
                        </td>
                        @php
            ...
            $acum_total_free += $signal != '07' ? $value->total_free : -$value->total_free ;*/
                ...
                <tr>
                    ...
                    <td style=" border: 1px solid black; background-color: #DCDCDC;">
                        {{ number_format($acum_total_exonerado, 2) }}</td>
                    <td style=" border: 1px solid black; background-color: #DCDCDC;">
                        {{ number_format($acum_total_inafecto, 2) }}</td>
                    <td style=" border: 1px solid black; background-color: #DCDCDC;">
                        {{ number_format($acum_total_free, 2) }}</td>
