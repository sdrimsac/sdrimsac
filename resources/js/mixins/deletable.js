export const deletable = {
    methods: {
        anular_comanda(url, number) {
            return new Promise(resolve => {
                this.$confirm(
                    "¿Desea anular Comanda " + number + " seleccionada?",
                    "Eliminar",
                    {
        ...
        delete(url) {
            return new Promise(resolve => {
                this.$confirm(
                    "¿Desea eliminar permanentemente el registro?",
                    "Anular",
                    {
                        confirmButtonText: "Eliminar",
                        cancelButtonText: "Cancelar",
        ...
        updateStateType(url) {
            return new Promise(resolve => {
                this.$confirm(
                    "¿Desea modificar el estado del registro?",
                    "Modificar",
                    {
