                ...
                <div class="row" v-if="applyFilter">
                    ...
                    <div class="col-md-3 col-lg-3">
                        ...
                        <el-select
                            ...
                            popper-class="el-select-supliers"
                            dusk="suplier_id"
                            placeholder="Escriba el nombre o número de documento del proveedor"
                            :remote-method="searchRemoteSupliers"
...
export default {
    ...
    created() {
        ...
        this.$http.get(`/purchases/tables`).then(response => {
            ...
            console.log("ver si esta llegando los proveedores", this.suppliers);
        });
    },
    async mounted() {
        ...
        await this.$http
            .get(`/${_.head(column_resource)}/columnsShopping`)
            .then(response => {
    ...
    methods: {
        searchRemoteSupliers(input) {
            if (input.length > 0) {
                this.loading_search = true;
                let parameters = `input=${input}`;

                this.$http
                    .get(`/${this.resource}/search/supliers?${parameters}`)
                    .then(response => {
