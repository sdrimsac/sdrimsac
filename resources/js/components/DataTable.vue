        ...
        <div class="row " v-loading="loading">
            ...
            " class="row mb-3">
                <!-- <div v-if="resource == 'caja/worker/expenses'" class="col-md-3">
                    <el-tooltip content="Exportar en PDF" placement="top">
                        <el-button
                            class="btn_pdfsmall"
                            type=""
                ...
                <!-- Botones para superadmin alineados a la derecha -->
                <!-- <div class="col-md-12 d-flex justify-content-end" v-if="resource !== 'caja/cash-transfer'">
                    ...
                    <el-tooltip v-if="resource !== 'restaurant'"
                        :content="resource === 'items' ? 'Exportar productos al formato excel' : 'Exportar Excel'"
                        placement="top">
                        <el-button class="btn_excelsmall" type=""
                            v-if="resource !== 'item-color-size' && resource !== 'caja/worker/expenses'"
                    ...
                    <el-tooltip content="Exportar tallas y colores" placement="top">
                        <el-button class="btn_excelsmall" type="" v-if="resource == 'item-color-size'"
                            icon="icofont-file-excel" @click.prevent="clickDownloadColor('excel')">Exportar TyC
                        </el-button>
                    </el-tooltip>
                    <el-tooltip content="Exportar formato excel para migración de productos" placement="top">
                        <el-button class="btn_excelsmall" type="" v-if="search.warehouse_id && typeUser == 'superadmin'"
                            icon="icofont-file-excel" @click.prevent="clickDownloadForImport('excel')">Exportar
                            2</el-button>
                    </el-tooltip>
                    <el-tooltip content="Agregar todos los productos a los almacenes faltantes" placement="top">
                        <el-button class="btn_politicasmall" type="" v-if="typeUser == 'superadmin'"
                            icon="el-icon-tickets" @click.prevent="clickAddProductsToWarehouses">Item/Almacenes
                        </el-button>
                    </el-tooltip>
                    ...
                    <el-tooltip content="Agregar todas las políticas de precio de productos en todo los almacenes"
                        placement="top">
                        <el-button class="btn_politicasmall" type="" v-if="typeUser == 'superadmin'"
                            icon="el-icon-tickets" @click.prevent="clickAddProductsToPolitica">PPP/Almacenes
                        </el-button>
                    </el-tooltip>
                </div> -->

                <div class="row mb-3" v-if="applyFilter">
                    <div class="col-md-12">
                        <div class="card p-3">
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-12 pb-2"
                                    ...
                                    <el-select v-model="search.cash_id" @change="getRecords"
                                        placeholder="Seleccione la caja">
                                        <el-option v-for="item in cashes" :key="item.id"
                                            :label="`${item.user_name}-${item.description}`" :value="item.id">
                                        </el-option>
                                    </el-select>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-12 pb-2">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12 pb-2">
                                    ...
                                    ">
                                        ...
                                        <template v-else>
                                            <el-date-picker v-model="search.value" type="daterange" range-separator="A"
                                                start-placeholder="Desde" value-format="yyyy-MM-dd"
                                                end-placeholder="Hasta" @change="getRecords">
                                            </el-date-picker>
                                        </template>
                                    </template>
                                    <template v-else-if="search.column == 'district_id'">
                                        <el-select v-model="search.value" @change="getRecords"
                                            ...
                                            <el-option v-for="item in array_district" :key="item.id"
                            ...
                            <div class="col-md-12 d-flex justify-content-end" v-if="resource !== 'caja/cash-transfer'">
                                ...
                                <el-tooltip content="Exportar tallas y colores" placement="top">
                                    <el-button class="btn_excelsmall" type="" v-if="resource == 'item-color-size'"
                                        icon="icofont-file-excel" @click.prevent="clickDownloadColor('excel')">Exportar
                                        TyC
                                    </el-button>
                                </el-tooltip>
                                <el-tooltip content="Exportar formato excel para migración de productos"
                                    placement="top">
                                    <el-button class="btn_excelsmall" type=""
                                        v-if="search.warehouse_id && typeUser == 'superadmin'" icon="icofont-file-excel"
                                        @click.prevent="clickDownloadForImport('excel')">Exportar
                                        2</el-button>
                                </el-tooltip>
                                <el-tooltip content="Agregar todos los productos a los almacenes faltantes"
                                    placement="top">
                                    <el-button class="btn_politicasmall" type="" v-if="typeUser == 'superadmin'"
                                        icon="el-icon-tickets"
                                        @click.prevent="clickAddProductsToWarehouses">Item/Almacenes
                                    </el-button>
                                </el-tooltip>
