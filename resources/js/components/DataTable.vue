            ...
            <div class="col-md-12">
                ...
                <div class="row">
                        ...
                        <template v-else-if="search.column == 'active' && resource == 'caja/workers-type'">
                            <el-select v-model="search.value" @change="getRecords" placeholder="Seleccione el estado">
                                <el-option v-for="(item, idx) in [
                                    ...
                                    { id: 0, description: 'Desactivado' }]" :key="idx" :label="item.description"
                                    :value="item.id">
                                </el-option>
                            </el-select>
                        </template>
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        <div v-if="resource == 'items' && !configuration.restaurant" class="mr-3">
                            <el-checkbox v-model="search.show_inactive" @change="getRecords">Productos Desactivados</el-checkbox>
                        </div>

                        <div class="d-flex align-items-center flex-nowrap" v-if="resource !== 'caja/cash-transfer'">
                            <el-tooltip content="Exportar en PDF" placement="top" v-if="resource == 'caja/worker/expenses'">
                                <el-button class="btn_pdfsmall ml-2" type="" icon="icofont-file-pdf" @click.prevent="clickDownload('pdf')">
                                    Exportar PDF
                                </el-button>
                            </el-tooltip>

                            <el-tooltip v-if="resource !== 'restaurant'" :content="resource === 'items' ? 'Exportar productos al formato excel' : 'Exportar Excel'" placement="top">
                                <el-button class="btn_excelsmall ml-2" type="" v-if="resource !== 'item-color-size' && resource !== 'caja/worker/expenses' && resource !== 'caja/tables'" icon="icofont-file-excel" @click.prevent="clickDownload('excel')">
                                    Exportar
                                </el-button>
                            </el-tooltip>

                            <el-tooltip content="Exportar tallas y colores" placement="top">
                                <el-button class="btn_excelsmall ml-2" type="" v-if="resource == 'item-color-size'" icon="icofont-file-excel" @click.prevent="clickDownloadColor('excel')">
                                    Exportar TyC
                                </el-button>
                            </el-tooltip>

                            <el-tooltip content="Exportar formato excel para migración de productos" placement="top">
                                <el-button class="btn_excelsmall ml-2" type="" v-if="search.warehouse_id && typeUser == 'superadmin'" icon="icofont-file-excel" @click.prevent="clickDownloadForImport('excel')">
                                    Exportar 2
                                </el-button>
                            </el-tooltip>

                            <el-tooltip content="Agregar todos los productos a los almacenes faltantes" placement="top">
                                <el-button class="btn_politicasmall ml-2" type="" v-if="typeUser == 'superadmin'" icon="el-icon-tickets" @click.prevent="clickAddProductsToWarehouses">
                                    Item/Almacenes
                                </el-button>
                            </el-tooltip>

                            <el-tooltip content="Agregar todas las políticas de precio de productos en todo los almacenes" placement="top">
                                <el-button class="btn_politicasmall ml-2" type="" v-if="typeUser == 'superadmin'" icon="el-icon-tickets" @click.prevent="clickAddProductsToPolitica">
                                    PPP/Almacenes
                                </el-button>
                            </el-tooltip>
                        </div>
