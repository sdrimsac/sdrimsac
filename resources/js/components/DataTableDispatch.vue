                ...
                <div class="row " >
                    <div class="col-lg-4 col-md-4 ">
                        <div class="form-group">
                            ...
                            <el-select v-model="search.customer_id" filterable remote popper-class="el-select-customers"
                                clearable placeholder="Ingrese Cliente"
                    ...
                    <div class="col-lg-2 col-md-2">
                        <div class="form-group">
                            ...
                            <el-input placeholder="Número" v-model="search.number">
                            </el-input>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-2 pb-2">
                        <div class="form-group">
                            ...
                            <el-date-picker v-model="search.d_end" type="date" style="width: 100%;" placeholder="Fecha Término"
                    ...
                    <div class="col-12 d-flex justify-content-end align-items-end" >
                        ...
                        <el-button class="btn_guardarsmall" type="info" @click.prevent="cleanInputs"
                            icon="el-icon-delete">
                            Limpiar
                        </el-button>
                    </div>
