                    ...
                    <div
                        ...
                        v-if="
                            resource == 'persons/customers' ||
                                resource == 'persons/suppliers'
                        "
                    >
                        <el-checkbox
                            v-model="search.credit"
                            @change="getRecords"
                            >A cuenta</el-checkbox
                        >
                    </div>
                    <div class="col-md-2" v-if="search.warehouse_id && typeUser == 'superadmin'">
                        <el-button
                            class="submit"
                            type="success"
...
export default {
    ...
    async mounted() {
        console.log("Valor de typeUser:", this.typeUser);
    ...
    methods: {
        clickDownload() {
            window.open(`/${this.resource}/exportclients`, "_blank");
        },
        customIndex(index) {
            return (
