<template>
    <div class="card">
        <div class="card-header bg-primary">
            <h6 class="my-0 text-white">Información Adicional</h6>
        </div>
        <div class="card-body">
                ...
                <div class="form-body">
                    ...
                    <!-- <div class="col-md-4">
                        <div class="form-group" :class="{'has-danger': errors.direct_printing}">
                            <h2><el-switch v-model="form.direct_printing" active-text="Activar Impresion Directa"></el-switch></h2>
                    ...
                    <div class="col-md-4">
                        <div class="form-group" :class="{'has-danger': errors.format_printer}">
                            <label class="control-label">Formato hoja Impresión CPE</label>
