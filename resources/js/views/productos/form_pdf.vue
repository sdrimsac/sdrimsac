...
export default {
    ...
    data() {
        return {
            titleDialog: "Imprimir Pdf Movimiento",
            loading: false,
            resource: "productos",
            errors: {},
            form: {},
        ...
        async create() {
            ...
            try {
                const response = await this.$http.get(
                    `/${this.resource}/recordPdf/${this.recordId}`
                );
                this.data = response.data;

                this.form.print_a4 = this.data.pdf_a4_url || null;
                this.form.ticket = this.data.pdf_80mm_url || null;
