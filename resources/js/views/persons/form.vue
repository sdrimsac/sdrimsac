...
<el-dialog  :title="titleDialog" 
    ...
    <form autocomplete="off" @submit.prevent="submit">
        <div class="form-body">
            <div class="row">
                <div class="col-12 col-lg-6 col-xl-6">
                    <div class="form-group" :class="{
                        ...
                        <small class="text-danger" v-if="errors.identity_document_type_id" v-text="errors.identity_document_type_id[0]"></small>
                    </div>
                </div>
                <div class="col-12 col-lg-6 col-xl-6">
                    <div class="form-group" :class="{ 'has-danger': errors.number }">
                        ...
                        <div v-if="api_service_token != false && form.identity_document_type_id !== '4'">
                            <x-input-service :identity_document_type_id="
                                        form.identity_document_type_id
                                    " v-model="form.number" @search="searchNumber"></x-input-service>
                        </div>
                        <div v-else>
                            <el-input ref="number" v-model="form.number" :maxlength="maxLength" dusk="number" @input="validateNumericInput('number')">
                                <template v-if="
                                            form.identity_document_type_id ===
                                                '6' ||
                                                form.identity_document_type_id ===
                                        ...
                                        ">
                                    <el-button slot="append" :loading="loading_search" icon="el-icon-search" @click.prevent="searchCustomer"></el-button>
                                </template>
            ...
            <div class="row">
                <div class="col-md-4" v-if="form.identity_document_type_id !== '6'">
                    <label class="control-label">
                ...
                <div v-else class="col-md-12">
                    <div class="form-group" :class="{ 'has-danger': errors.trade_name }">
                        ...
                        <el-input v-model="form.trade_name" dusk="trade_name" @input="toUpperCase('trade_name')">
                            <i slot="prefix" class="el-icon-edit-outline"></i>
                        </el-input>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group" :class="{ 'has-danger': errors.adderss_secondary }">
                        ...
                        <el-input v-model="form.adderss_secondary" dusk="adderss_secondary" @input="toUpperCase('adderss_secondary')">
                            <i slot="prefix" class="el-icon-edit-outline"></i>
                        </el-input>
                        <small class="text-danger" v-if="errors.adderss_secondary" v-text="errors.adderss_secondary[0]"></small>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-lg-6 col-xl-6">
                    ...
                    <div class="form-group" :class="{ 'has-danger': errors.client_zone_id }">
                        ...
                        <el-select v-model="form.client_zone_id" filterable dusk="client_zone_id">
                            <el-option v-for="option in zones" :key="option.id" :value="option.id" :label="option.description"></el-option>
                        </el-select>
                        <small class="text-danger" v-if="errors.client_zone_id" v-text="errors.client_zone_id[0]"></small>
                    </div>
                </div>
                <div class="col-12 col-lg-6 col-xl-6">
                    <div class="form-group" :class="{ 'has-danger': errors.telephone }">
                        ...
                        <el-input v-model="form.telephone" dusk="telephone" @input="toUpperCase('telephone')">
                            <i slot="prefix" class="el-icon-edit-outline"></i>
                        </el-input>
            ...
            <div class="row mt-2" v-if="type === 'suppliers'">
                <div class="col-md-6 center-el-checkbox">
                    <div class="form-group" :class="{ 'has-danger': errors.perception_agent }">
                        ...
                        <br />
                        <small class="text-danger" v-if="errors.perception_agent" v-text="errors.perception_agent[0]"></small>
                    </div>
                </div>
            ...
            <div class="row m-t-10" v-for="(row, index) in form.addresses" :key="index">
                ...
                <div class="col-md-6">
                    <div class="form-group" :class="{ 'has-danger': errors.email }">
                        ...
                        <el-input v-model="row.email" @input="toUpperCase('row.email')">
                            <i slot="prefix" class="el-icon-edit-outline"></i>
                        </el-input>
                        <small class="text-danger" v-if="errors.email" v-text="errors.email[0]"></small>
                    </div>
            ...
            <template v-if="
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        <el-input v-model="form.credit_line" :disabled="!form.has_credit_line" type="number" min="0" step="0.01"></el-input>
                    </div>
                </div>
            </template>
            <div class="row" v-if="configuration.consolidated_quotations">
                <div class="col-8 col-lg-8 col-xl-8">
                    ...
                    <el-select v-model="form.document_type_id" filterable popper-class="el-select-document_type" dusk="document_type">
                        <el-option v-for="(option, idx) in document_types" :key="idx" :value="option.id" :label="option.description"></el-option>
                    </el-select>
                </div>
                <div class="col-4 col-lg-4 col-xl-4">
                    <label for="varios">Clientes varios
                        <el-tooltip class="item" effect="dark" content="La boleta o nota se emitirá a nombre de clientes varios." placement="top">
                            <i class="fas fa-info-circle text-danger"></i>
                        </el-tooltip>
                    </label>
            ...
            <div class="row" v-if="configuration.consolidated_quotations">
                <div class="col-8 col-lg-8 col-xl-8">
                    <div class="form-group">
                        ...
                        <el-select v-model="item_unit_type" filterable clearable popper-class="el-select-identity_document_type" dusk="item_unit_type">
                            <el-option v-for="(option, idx) in item_unit_types" :key="idx" :value="option" :label="option"></el-option>
                        </el-select>
                    </div>
                </div>
                <div class="col-4 col-lg-4 col-xl-4">
                    <div class="form-group">
                        <br />
                        <el-button type="primary" @click="clickAddItemUnitType" icon="el-icon-plus">Agregar</el-button>
                    </div>
                </div>
            </div>
            <div class="row" v-if="
                    ...
                    ">
                <el-button-group>
                    <el-button type="primary" icon="el-icon-delete" v-for="(item, index) in form.item_unit_types" :key="index" @click="removeItemUnitType(index)">{{ item }}</el-button>
                </el-button-group>
            </div>
        </div>
