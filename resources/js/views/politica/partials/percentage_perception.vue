    ...
    <el-dialog :title="titleDialog" :visible="showDialog" width="30%"  :close-on-click-modal="false"      append-to-body top="7vh">
        <form autocomplete="off" @submit.prevent="submit">
            <div class="form-body">
                <div class="row">
                    <div class="col-md-12"  >
                        <el-input v-model="local_percentage_perception" > <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
...
<script>
    ...
    export default { 
        ...
        methods: {
            submit(){
                if(!this.local_percentage_perception) return this.$toast.error('Ingrese un porcentaje');
