  ...
  >
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        >
          <el-button
            v-if="form.document_type_id == 1 || form.document_type_id == 4"
      ...
      <div class="col-md-4">
        ...
        <el-input v-model="form.telephone" placeholder="Telefono" :disabled="loading_submit" maxlength="9"  show-word-limit></el-input>
      </div>
    </div>
