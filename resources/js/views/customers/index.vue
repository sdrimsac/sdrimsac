            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><span class="text-muted">Listado de Clientes</span></li>
                    </ol>
                </div>
                <div class="col-sm-6">
                    <div class="bookmark">
    ...
    <div class="container-fluid p-l-0 p-r-0">
        <div class="card mb-0">
            <div class="card-header bg-primary">
                <h4 class="my-0 text-white">Listado de clientes</h4>
            </div>
            <div class="card-body">
                <data-table :resource="resource">
                    ...
                    <tr slot-scope="{ index, row }">
                        ...
                        <td class="text-end">
                            <button icon="fas fa-times" type="button" class="btn waves-effect waves-light btn-sm btn-info" @click.prevent="clickCreate(row.id)">Editar</button>
            ...
            <customers-form :showDialog.sync="showDialog" :recordId="recordId"></customers-form>
        </div>
    </div>
</div>
</template>
