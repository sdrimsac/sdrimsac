                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group" :class="{'has-danger': errors.trade_name}">
                            ...
                            <el-input v-model="form.trade_name"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group" :class="{'has-danger': errors.address}">
                            ...
                            <el-input v-model="form.address"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group" :class="{'has-danger': errors.email}">
                            ...
                            <el-input v-model="form.email"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
