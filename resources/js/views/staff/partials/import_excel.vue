<!-- Modal de Importar  Excel de Asistencia de personal -->
<template>
    <el-dialog
        :title="titleDialog"
        :visible="showDialog"
            ...
            <div class="form-body">
                <div class="row">
                    ...
                    >
                        ...
                        <div
                            class="mt-2 col-md-12 d-flex justify-content-center"
                            :class="{ 'has-danger': errors.file }"
                        >
                            <el-upload
                                ref="upload"
                                :headers="headers"
                                action="/staff/import-person"
                                :show-file-list="true"
                                :auto-upload="false"
                                :multiple="false"
                        ...
                        <div class="col-12 mb-2 d-flex justify-content-center">
                            <a
                                class="mr-auto"
                                href="/formats/import_workers.xlsx"
                                target="_new"
                            >
                                <span class="mr-2">
                                    Descargar AQUÍ el formato</span
                                >
                            </a>
                        </div>
                    </div>
