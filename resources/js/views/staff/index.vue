                    ...
                    <div class="card mb-0">
                        ...
                        <div class="card-body" style="padding: 4px;">
                            <div class="row m-2 d-flex align-items-center">
                                <div class="col-4">
                                    <el-select ref="cliente" filterable remote clearable
                                        popper-class="el-select-customers" dusk="customer_id"
                                        placeholder="Ingrese Personal / Cliente" :remote-method="searchRemoteCustomers"
                                        :loading="loading_search" @change="changeCustomer" v-model="form.person_id">
                                    ...
                                    <table class="table" v-if="records.length > 0">
                                        ...
                                        <tbody>
                                            <!-- <tr v-for="(record, idx) in records" :key="idx"
                                                ...
                                                <td>
                                                    <template v-if="record.seller && record.seller.includes(' - ')">
                                                        <div>{{ record.seller.substring(0, record.seller.lastIndexOf(' -
                                                            ')) }}</div>
                                                        <div>{{ record.seller.substring(record.seller.lastIndexOf(' - ')
                                                            + 3) }}</div>
                                                    </template>
                                                    <template v-else>
                                                        {{ record.seller }}
                                                ...
                                                <td>
                                                    <el-button @click="clickPrint(record.credit_list_id)" type="success"
                                                        size="mini">
                                            ...
                                            <tr slot-scope="{ index, row }">
                                                ...
                                                <td>
                                                    <template v-if="row.seller && row.seller.includes(' - ')">
                                                        <div>{{ row.seller.substring(0, row.seller.lastIndexOf(' - ')) }}</div>
                                                        <div>{{ row.seller.substring(row.seller.lastIndexOf(' - ') + 3) }}</div>
                                                    </template>
                                                    <template v-else>
                                                        {{ row.seller }}
                                                    </template>
                                                ...
                                                <td>
                                                    <el-button @click="clickPrint(row.credit_list_id)" type="success"
                                                        size="mini">
                                                        <i class="fa fa-print"></i>
                                                    </el-button>
                                                </td>
