            ...
            <div class="form-body">
                <div class="row">
                    <div class="col-6" :class="{ 'has-danger': errors.warehouse_id }">
                        <label for="warehouse">
                            <i class="fas fa-warehouse" style="margin-right: 5px;"></i>
                            Seleccionar Almacén
                        </label>
                        ...
                        <div class="mt-2 col-md-12 d-flex justify-content-center" :class="{ 'has-danger': errors.file }">
                            <el-upload ref="upload" :headers="headers" action="/items/import" :show-file-list="true"
