                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2" v-show="
                                ...
                                <div class="form-group" :class="{ 'has-danger': errors.stock }">
                                    <label v-if="!allEstablishment" class="control-label">Stock Inicial</label>
                            ...
                            <div class="col-md-2" v-show="
                                ...
                                <div class="form-group">
                                    <label class="control-label">Cant.Máx
                            ...
                            <div class="col-md-2" v-show="
                                        ...
                                        ">
                                <div class="form-group">
                                    <label class="control-label">Contenedor
                                        <el-tooltip class="item" effect="dark" content="Nombre del contenedor de la cantidad máxima Ej. Botella, Caja, Saco" placement="top">
                                            <i class="fa fa-info-circle"></i>
                                        </el-tooltip>
                                    </label>
                            ...
                            <div class="d-flex row" v-if="showSeries">
                                <div class="col-md-2" v-if="configuration.series_enabled">
                                    ...
                                    <div class="col-md-4 d-flex align-items-end" v-if="
                                        ...
                                        <div class="form-group " :class="{
                                            ...
                                            <el-button  style="margin-top:2%;margin-left:15px;" 
                                                        type="primary" 
                                ...
                                <div class="col-md-3" v-if="configuration.lots_enabled">
                                    ...
                                    <div class="col-md-4" v-show="form.unit_type_id != 'ZZ' && form.lots_enabled">
                            ...
                            <div class="row col-md-12">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group" :class="{
                                        ...
                                        <a      href="#" v-if="form_brand.add == true" 
                                                class="control-label font-weight-bold text-info" 
                                                @click="saveBrand()">
                                                <i class="fas fa-save fa-lg"></i>
                                        </a>
