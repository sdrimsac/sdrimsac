        ...
        <el-tabs tab-position="top">
            ...
            <div class="row">
              ...
              <div class="col-12 col-lg-6 col-xl-3">
                ...
                >
                  ...
                  <el-select :disabled="configuration.college!=0" v-model="form.area_id">
                    <el-option
              ...
              <div class="col-xl-4 col-lg-6" v-if="recordId == null">
                <div
                  class="form-group"
                  :class="{
                ...
                >
                  ...
                  <small v-if="!recordId">
                    <el-checkbox v-model="allEstablishment">Todos los almacenes</el-checkbox>
                  </small>
                </div>
              </div>
              <div
              ...
              >
                <div class="form-group" :class="{ 'has-danger': errors.stock }">
                  ...
                  <label v-else class="control-label">Stock Inicial en cada establecimiento</label>
                  <el-input
                    :disabled="
              ...
              <div class="col-12 col-lg-6 col-xl-2" v-if="form.unit_type_id != 'ZZ'">
              ...
              <div class="d-flex row" v-if="showSeries">
                ...
                <div class="col-12 col-lg-6 col-xl-3" v-if="configuration.color_size_enabled">
                  <div v-if="form.unit_type_id != 'ZZ'" class="col-md-4 center-el-checkbox">
                    <div class="form-group">
                      <el-checkbox :disabled="recordId != null" v-model="form.has_color_size">
                ...
                <div class="col-12 col-lg-6 col-xl-3" v-if="configuration.transform_item">
                  <div v-if="form.unit_type_id != 'ZZ'" class="col-md-3 center-el-checkbox">
                    <div class="form-group">
                      <el-checkbox v-model="form.is_manufactured">
                        ¿Se fabrica?
                        <el-tooltip
                          class="item"
                          effect="dark"
          ...
          <el-tab-pane label="Lista de Precios">
            <div class="row">
              ...
              <div
                v-if="form.unit_type_id != 'ZZ' && form.item_unit_types.length > 0"
                class="col-md-12"
              >
                <div class="table-responsive">
                  <table class="table table-striped">
                    <thead>
                      <tr slot="heading" class="bg-primary">
                        ...
                        <th width="20%" class="text-white text-center">Descripción</th>
                        ...
                        <th width="10%" class="text-white text-center">Total</th>
                        <th class="text-white text-center">Almacén</th>
    ...
    await this.$http.get(`/${this.resource}/tables`).then(response => {
      ...
      if (!this.configuration.restaurant) {
        this.areas = this.areas.filter(
          a =>
            !["BARRA", "COCINA", "MOZO", "MESA"].some(p => p == a.description)
        );
      }
  ...
  methods: {
    updateCommercialTreatmentItem(idx) {
      ...
      this.timer = setTimeout(async () => {
        let commercial_treatment_item = this.form.commercial_treatments[idx];
    ...
    clickDelete(id) {
      this.$http
        ...
        .then(res => {
          if (res.data.success) {
            this.loadRecord();
            this.$toast.success("Se eliminó correctamente el registro");
          }
        })
        .catch(error => {
      ...
      if (this.recordId) {
        this.$http
          ...
          .then(response => {
            ...
            this.has_percentage_perception = this.form.percentage_perception
              ? true
              : false;
            this.changeAffectationIgvType();
      ...
      if (parseFloat(this.form.purchase_unit_price) === 0) {
        ...
        if (this.enabled_percentage_of_profit)
          this.form.percentage_of_profit =
            (difference / parseFloat(this.form.purchase_unit_price)) * 100;
      }
    },
    calculatePercentageOfProfitByPurchase() {
