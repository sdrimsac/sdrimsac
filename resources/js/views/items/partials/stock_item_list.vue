                ...
                <div class="row">
                    <div class="col-6 form-group" :class="{ 'has-danger': errors.warehouse_id }">
                        ...
                        <div class="form-group" :class="{ 'has-danger': errors.file }">
                            <el-upload ref="upload" :headers="headers" action="/items/import_stock_list"
                        ...
                        <div class="col-12 mt-4 mb-2" v-if="form.warehouse_id">
                            <a class=" mr-auto" :href="`/items/import_stock_format?warehouse_id=${form.warehouse_id}`"
                                target="_new">
                                <span class="mr-2">
                    ...
                    <div class="col-6">
                        <div class="form-actions d-flex justify-content-end gap-3 pt-2 pb-2">
                            <el-button class="btn_cancelarsmall" type="pimary" @click.prevent="close()">
...
export default {
    ...
    methods: {
        ...
        create() {
            this.titleDialog = 'Importar Stock de Productos Masivamente para actualizar'
        },
        async submit() {
