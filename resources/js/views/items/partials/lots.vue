                            ...
                            <tr v-for="(row, index) in lots" :key="index" width="100%" >
                                <td>
                                    <div class="form-group mb-2 mr-2"  >
                                        <el-input @blur="duplicateSerie(row.series, index)" v-model="row.series"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                                    </div>
                                </td>
                                 <td>
                                    <div class="form-group mb-2 mr-2"  >
            ...
            clickAddLot() {
                ...
                if(!this.recordId){
                    if(this.lots.length >= this.stock)
                        return this.$toast.error('La cantidad de registros es superior al stock o cantidad');
                }
