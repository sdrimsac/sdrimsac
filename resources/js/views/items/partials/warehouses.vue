                  ...
                  <tbody>
                    <tr v-for="(row, idx) in warehouses" :key="idx">
                      ...
                      <th class="text-end">
                        ...
                        <template v-else>
                          <template v-if="config && config.college">{{ parseInt(row.stock) }}</template>
                          <template v-else>{{ row.stock }}</template>
                        </template>
                      </th>
                      <th>
                        <button
                          v-if="!hasSerie && config && config.item_adjustment"
                          type="button"
                    ...
                    <tr>
                      ...
                      <td class="text-end" v-else>
                        <template
                          v-if="item && item.max_quantity"
                        >{{ stockMaxQuantity(total,item) }}</template>
                        <template v-else>{{ total.toFixed(2) }}</template>
                      </td>
                      <td></td>
                    </tr>
                  </tbody>
