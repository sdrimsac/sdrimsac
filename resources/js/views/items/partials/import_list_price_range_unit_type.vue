    ...
    >
        <form autocomplete="off" @submit.prevent="submit">
            <div class="form-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <a href="/formats/item_price_range_unit_type.xlsx" target="_new"
                    ...
                    <div class="col-md-12 mt-4">
                        ...
                        >
                            <el-upload
                                ref="upload"
                                :headers="headers"
                                action="/items/import_prices_range_unit_type"
                                :show-file-list="true"
                                :auto-upload="false"
                                :multiple="false"
...
export default {
    ...
    methods: {
        ...
        create() {
            this.titleDialog = "Importar listado de precios por rango de cantidad - Política de precio";
        },
        async submit() {
            this.loading = true;
