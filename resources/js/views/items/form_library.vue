<!-- Crear  Productos en Caja  con fotos y detalles -->
<template>
    <el-dialog width="80%" :title="titleDialog" :visible="showDialog" :close-on-click-modal="false" @close="close"
        ...
        <form autocomplete="off" @submit.prevent="submit">
            ...
            <div class="form-body p-2">
                ...
                <el-tabs tab-position="top" v-model="activeTab" class="card-body">
                    <el-tab-pane label="General" name="general">
                                    ...
                                    <div class="row col-12">
                                        ...
                                        <template>
                                            <div class="row align-items-start">
                                                ...
                                                <!-- Almacenes -->
                                                <div class="col-md-6 px-2" v-if="recordId == null">
                                                    <div class="form-group" :class="{
                                                        'has-danger':
                                                            errors.warehouse_id
                                                    }">
                                                        <label class="control-label d-flex align-items-center">
                                                            <i class="fas fa-warehouse red-icon fa-lg me-1"></i>
                                                            Almacén
                        ...
                        <div class="container">
                            <div class="row align-items-center">
                                ...
                                <!-- Delivery -->
                                <div class="col-xl-3 col-lg-4 col-md-6 px-2" v-if="configuration.restaurant">
                                    <div class="form-group">
                                        <label class="control-label d-flex align-items-center">
                    ...
                    <div class="form-actions d-flex justify-content-end gap-3 pt-2 pb-2" style="width: 100%;">
                        <!-- Botón Cancelar -->
