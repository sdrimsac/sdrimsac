                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" :class="{'has-danger': errors.customer_number}">
                                ...
                                <el-input v-model="form.customer_number" :maxlength="11"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                        ...
                        <div class="col-md-6">
                            <div class="form-group" :class="{'has-danger': errors.total}">
                                ...
                                <el-input v-model="form.total"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
