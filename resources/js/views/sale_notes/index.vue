    ...
    <div class="container-fluid p-l-0 p-r-0">
      <div class="card mb-0">
        ...
        <div class="data-table-visible-columns">
          <el-button class href="javascript:void(0)" @click.prevent="clickCreate()">
            <i class="fas fa-file-alt fa-lg"></i>
            <i class="fas fa-plus"></i>
            Nuevo NV
          </el-button>
          <el-button @click.prevent="onOpenModalGenerateCPE" v-if="just_sale_notes" type="button">
        ...
        <div class="card-body">
          <data-table :resource="resource">
            ...
            <tr slot-scope="{ index, row }">
              <td>{{ index }}</td>
              <td class="text-end">
                <div v-if="row.state_type_id != 11" class="btn-toolbar mb-2" role="toolbar">
              ...
              <td class="text-center" v-if="columns.total_paid.visible">{{ row.total_paid }}</td>
              <td>{{ row.advances }}</td>
              <!-- <td>
                                {{ row.advances }}
              </td>-->
              ...
              <td class="text-end">{{ row.pending.toFixed(2) }}</td>
              <template>
  ...
  methods: {
    ...
    async clickCreate(id = "") {
        ...
        if (this.$cashId) {
            ...
            swal.fire({
              title: 'Caja cerrda',
              text: 'No puedes realizar esa accion debido a que tu caja esta cerrado',
              icon: 'error',
              timer: 2000,
