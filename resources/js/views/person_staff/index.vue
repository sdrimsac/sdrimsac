    ...
    <div>
        <div class="container-fluid p-l-0 p-r-0">
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-6">
                        <h6><span>Personal </span></h6>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
                            <li class="breadcrumb-item active"><span class="text-muted">Personal</span></li>
                        </ol>
                    </div>
                    <div class="col-sm-6">
                        <div class="bookmark">
        ...
        <div class="container-fluid p-l-0 p-r-0">
            <div class="card mb-0">
                <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <el-button @click.prevent="clickCreate()">Nuevo personal</el-button>
                    </div>
                </div>
                <div class="card-body">
