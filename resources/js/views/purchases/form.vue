            ...
            <form autocomplete="off" @submit.prevent="submit">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-group" :class="{
                                                ...
                                                <small class="text-danger" v-if="errors.document_type_id"
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group" :class="{ 'has-danger': errors.series }">
                                                    ...
                                                    <el-input v-model="form.series"
                                                        :readonly="this.form.document_type_id == 'NE76'">
                                        ...
                                        <template v-if="form.document_type_id == 'GU75'">
                                            <div class="col-lg-4">
                                                <div class="form-group" :class="{
                                                    ...
                                                    <small class="form-control-feedback" v-if="errors.series_guia"
                                                        v-text="errors.series_guia[0]"></small>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group" :class="{
                                                    ...
                                                    <small class="form-control-feedback" v-if="errors.number_guia"
                                                        v-text="errors.number_guia[0]"></small>
                                                </div>
                                            </div>
                                        </template>
                                    </div>
                                ...
                                <div class="col-md-12" v-if="form.has_payment">
                                    <table class="table table-bordered table-striped table-sm"
                                        ...
                                        <thead class="bg-primary text-white">
                                            <tr>
                                                <th style="padding: 4px; white-space: nowrap;">Forma de pago</th>
                                                <th style="padding: 4px; white-space: nowrap;">Destino</th>
                                                <th style="padding: 4px; white-space: nowrap;">Referencia</th>
                                                <th style="padding: 4px; white-space: nowrap;">Monto</th>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 d-flex justify-content-end mt-4">
                            <div class="form-group d-flex gap-2 justify-content-end" style="width: 100%;">
                                ...
                                <button
                                    type="primary"
                                    class="btn_restaurarsmall "
                                    @click="restoreApart"
                                    data-toggle="tooltip"
                                    title="Restaura la compra previamente aparcada."
                                ...
                                <button
                                    ...
                                    class="btn_aparcarsmall"
                                    @click.prevent="PurchaseApart"
                                    data-toggle="tooltip"
                                    title="Aparca temporalmente esta compra."
                                    style="min-width: 50px;"
                                >
                ...
                <hr class="my-1" />
                    <div class="form-actions d-flex justify-content-end gap-3 pt-2 pb-2">
                        ...
                        <el-button class="btn_guardarsmall" icon="fas fa-cogs" type="primary"
                            native-type="submit" :loading="loading_submit" v-if="form.items.length > 0 && !hide_button">
                            <span> Generar</span>
                        </el-button>
                    </div>
