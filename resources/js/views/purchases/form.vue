      ...
      <form autocomplete="off" @submit.prevent="submit">
        <div class="form-body">
          ...
          <div class="row">
            ...
            <div
              class="col-lg-6 col-md-6 d-flex align-items-end mt-4"
            ...
            <div class="col-lg-6 col-md-6 align-items-end mt-4" style="text-align: right;">
              <div class="form-group">
                <button
                  type="button"
                ...
                <table class="table table-striped">
                  <thead>
                    <tr slot="heading" class="bg-primary">
                      ...
                      <th class="text-white text-end">Costo Unitario</th>
                      <th class="text-end text-white" v-if="form.includes == false">IGV</th>
                  ...
                  <tbody>
                    <tr v-for="(row, index) in form.items" :key="index">
                      ...
                      <td class="text-end" v-if="form.includes == false">{{ row.unit_price_igv }}</td>
                      <td class="text-end">
                        {{ currency_type.symbol }}
                        {{ row.total_discount }}
                      </td>
    ...
    >
      ...
      <div class="p-2">
        ...
        <div class="d-flex justify-content-end">
          <button class="btn btn-light m-1" @click="apartPurchases = false">Cancelar</button>
  ...
  methods: {
    ...
    restoreApart() {
      ...
      if (this.ordenInBox.length > 0) {
        ...
        this.$showSAlert("ALERTA", "No hay compras aparcadas", "warning");
      }
    },
    ...
    pullApartOrden() {
      ...
      if (this.form.items.length == 0) {
        this.$showSAlert("ALERTA", "No hay productos para aparcar", "error");
        return;
      }
      ...
      try {
        localStorage.setItem("purchaseOrdens", JSON.stringify(this.ordenInBox));
        this.$showSAlert(
          "APARCADO",
      ...
      this.form.items.forEach(row => {
        ...
        if (row.affectation_igv_type_id == "10") {
          if (this.form.includes == 0 || this.form.includes == false) {
            ...
            if (row.unit_price_igv === 0 || row.unit_price_igv === undefined) {
              let igv_item = row.unit_price * row.quantity;
              console.log(igv_item, " igv_item");
              row.unit_price_igv = igv_item * (this.percentage_igv / 100);
