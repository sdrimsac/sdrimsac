            ...
            <form autocomplete="off" @submit.prevent="submit">
                <div class="form-body">
                     ...
                     <template v-if="form.document_type_id!='GU75'">
                        <div class="col-lg-2">
                            <div class="form-group" :class="{'has-danger': errors.series}">
                                ...
                                <el-input v-model="form.series" :maxlength="4"   @input="inputSeries"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                        ...
                        <div class="col-lg-2">
                            <div class="form-group" :class="{'has-danger': errors.series}">
                                <label class="control-label">Serie Guia<span class="text-danger">*</span></label>
                                <el-input v-model="form.series_guia" :maxlength="4"   @input="inputSeries"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                        ...
                        <div class="col-lg-2">
                            <div class="form-group" :class="{'has-danger': errors.number}">
                                <label class="control-label">Número Guia<span class="text-danger">*</span></label>
                                <el-input v-model="form.number_guia"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group" :class="{'has-danger': errors.exchange_rate_sale}">
                                ...
                                <el-input v-model="form.exchange_rate_sale"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                                <small class="form-control-feedback" v-if="errors.exchange_rate_sale" v-text="errors.exchange_rate_sale[0]"></small>
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group" :class="{'has-danger': errors.exchange_rate_sale}">
                                <label class="control-label">Incluye IGV</label><br>
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr v-for="(row, index) in form.payments" :key="index">
                                        ...
                                        <td>
                                            <div class="form-group mb-2 mr-2"  >
                                                <el-input v-model="row.reference"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group mb-2 mr-2" >
                                                <el-input v-model="row.payment"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                                            </div>
                                        </td>
                    ...
                    <div class="row" v-if="form.items.length > 0">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-end">Costo Unitario</th>
                                         <th class="text-end" v-if="form.includes==false">IGV</th>
                                    ...
                                    <tr v-for="(row, index) in form.items" :key="index">
                                        ...
                                        <td class="text-end">{{ currency_type.symbol }} {{ getFormatUnitPriceRow(row.unit_price) }}</td>
                                         <td class="text-end" v-if="form.includes==false">{{ currency_type.symbol }} {{ row.unit_price_igv }}</td>
                                        ...
                                        <td class="text-end">{{ currency_type.symbol }} {{ row.total_charge }}</td>
                                         ...
                                         <!--   {{ currency_type.symbol }} {{ parseFloat(row.total)+parseFloat(row.unit_price_igv) }}-->
                                                 {{ currency_type.symbol }} {{ parseFloat(row.total) }}
                                        </td>
                        ...
                        <div class="col-md-12">
                            <p class="text-end" v-if="form.total_exportation > 0">OP.EXPORTACIÓN: {{ currency_type.symbol }} {{ form.total_exportation }}</p>
                            <p class="text-end" v-if="form.total_free > 0">OP.GRATUITAS: {{ currency_type.symbol }} {{ form.total_free }}</p>
                            <p class="text-end" v-if="form.total_unaffected > 0">OP.INAFECTAS: {{ currency_type.symbol }} {{ form.total_unaffected }}</p>
                            <p class="text-end" v-if="form.total_exonerated > 0">OP.EXONERADAS: {{ currency_type.symbol }} {{ form.total_exonerated }}</p>
                            <p class="text-end" v-if="form.total_taxed > 0">OP.GRAVADA: {{ currency_type.symbol }} {{ form.total_taxed }}</p>
                            <p class="text-end" v-if="form.total_igv > 0">IGV: {{ currency_type.symbol }} {{ form.total_igv }}</p>
                            <h6 class="text-end" v-if="form.total > 0"><b>TOTAL COMPRAS: </b>{{ currency_type.symbol }} {{ form.total }}</h6>
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-lg-2 float-right">
                                        <div class="form-group" :class="{'has-danger': errors.perception_number}">
                                            <el-input v-model="form.perception_number"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-lg-2 float-right">
                                        <div class="form-group" :class="{'has-danger': errors.total_perception}">
                                            <el-input v-model="form.total_perception" @input="inputTotalPerception" :readonly="true"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>

                                            <small class="form-control-feedback" v-if="errors.total_perception" v-text="errors.total_perception[0]"></small>
                                        </div>
                                    </div>
                                </div>
                                <h6 class="text-end" v-if="form.total > 0 && !hide_button"><b>MONTO TOTAL : </b>{{ currency_type.symbol }} {{ total_amount }}</h6>
             ...
             calculateTotal() {
                ...
                this.form.items.forEach((row) => {
                    ...
                    if (row.affectation_igv_type_id == '10') {
                        if(this.form.includes==0 ||this.form.includes==false ){
                           let igv_item=(row.unit_price*row.quantity)
                                row.unit_price_igv=_.round(igv_item*(this.percentage_igv/100),2)
                          }else{
                              unit_price_igv=0
                          }
                   ...
                   if(row.affectation_igv_type_id === '10'){
                       if(this.form.includes==false){
                        total_igv += parseFloat((row.total)*(this.percentage_igv/100))
                    }else{
                    ...
                    if (row.affectation_igv_type_id === '10') {
                         if(this.form.includes==false){
                              total  += parseFloat(row.total)+parseFloat(row.unit_price_igv)
                         }else{
