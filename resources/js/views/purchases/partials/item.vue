    ...
    <el-dialog :title="titleDialog" :visible="showDialog" @open="create" @close="close" :close-on-click-modal="false"
        ...
        <form autocomplete="off" @submit.prevent="clickAddItem" @keydown.enter.prevent>
            <div class="form-body">
                            ...
                            <div class="col-9">
                                <div class="form-group">
                                    <div class="d-flex align-items-center" style="gap: 10px;">
                                        <vs-checkbox color="#073f68" v-model="barcode_lector" :style="{
                                            width: 'auto',
                                            boxSizing: 'border-box',
                                            marginRight: '8px',
                                            border: barcode_lector ? 'none' : '2px solid #073f68',
                                            borderRadius: '8px',
                                            transition: 'border 0.2s'
                                        }"></vs-checkbox>
                                        <label class="control-label w-100"
                                            :style="{ color: barcode_lector ? '#073f68' : '#6c757d' }">
                                    ...
                                    <div class="col-11">
                                        <div style="flex: 1;">
                                            <el-select v-if="!barcode_lector" v-model="form.item_id"
                                                :loading="loading_search" :remote-method="searchRemoteItems
                                                    " filterable placeholder="Buscar Producto o Servicio" remote
                    ...
                    <div class="col-6">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <el-input-number style="width: 100%;" v-model="form.sale_unit_price" :precision="2"
                ...
                <div class="row">
                    <div class="col-md-6 mb-1">
                        <div class="form-group" :class="{ 'has-danger': errors.warehouse_id }">
                            <div class="d-flex align-items-center" style="gap: 10px;">
                                <label style="margin-bottom: 0;"><i class="fas fa-warehouse"></i>
                                    Almacén</label>
                            ...
                            <div class="d-flex align-items-center" style="gap: 10px;">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <vs-checkbox color="#073f68" v-model="change_affectation_igv_type_id"
                                                :style="{
                                                    ...
                                                    boxSizing: 'border-box',
                                                    marginRight: '8px',
                                                    border: change_affectation_igv_type_id ? 'none' : '2px solid #073f68',
                                                    borderRadius: '8px',
                                                    transition: 'border 0.2s'
                                                }"></vs-checkbox>
                                            <label class="control-label w-100"
                                                :style="{ color: change_affectation_igv_type_id ? '#073f68' : '#6c757d' }">
                                ...
                                <el-select v-model="form.affectation_igv_type_id"
                                    ...
                                    <el-option v-for="option in affectation_igv_types" :key="option.id"
                                        :value="option.id" :label="option.description" :selected="option.description ===
                ...
                <!-- Fila personalizada con 2 columnas tipo card -->
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group" :class="{
                                            ...
                                            <label class="control-label"><i class="fas fa-sort-numeric-up"></i>
                                                Cantidad</label>
                                            <el-input-number style="width: 100%;" v-model="form.quantity" :min="1"
                                                name="quantity" @input.native="onInput" @change="updateRealQuantity">
                                            </el-input-number>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group" :class="{
                                            ...
                                            <label class="control-label"><i class="fas fa-dollar-sign"></i>
                                                P.Unitario</label>
                                            <el-input-number style="width: 100%;" v-model="form.unit_price" :min="0.001"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group" :class="{
                                            ...
                                            <label class="control-label"><i class="fas fa-dollar-sign"></i>
                                                Total</label>
                                            <el-input-number style="width: 100%;" :disabled="!insertTotalPrice"
                                                :min="0.001" @input="updateUnitPrice"
                                                v-model="form.total_price"></el-input-number>
                                            <small>
                                                <div class="d-flex align-items-center mt-1">
                                                    <vs-checkbox color="#073f68" v-model="insertTotalPrice" :style="{
                                                        width: 'auto',
                                                        boxSizing: 'border-box',
                                                        marginRight: '8px',
                                                        border: insertTotalPrice ? 'none' : '2px solid #073f68',
                                                        borderRadius: '8px',
                                                        transition: 'border 0.2s'
                                                    }"></vs-checkbox>
                                                    <label class="control-label w-100"
                                                        :style="{ color: insertTotalPrice ? '#073f68' : '#6c757d' }">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <vs-checkbox color="#073f68" v-model="noIsUnid" @change="changeNoIsUnid"
                                                    :style="{
                                                        ...
                                                        boxSizing: 'border-box',
                                                        marginRight: '8px',
                                                        border: noIsUnid ? 'none' : '2px solid #073f68',
                                                        borderRadius: '8px',
                                                        transition: 'border 0.2s'
                                                    }"></vs-checkbox>
                                                <label class="control-label w-100"
                                                    :style="{ color: noIsUnid ? '#073f68' : '#6c757d' }">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body" style="padding: 4px;">
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th class="text-center" style="padding: 4px; width: 120px;">
                                                Ingresar
                                            </th>
                                            <th class="text-center" style="padding: 4px; width: 120px;">
                                                Descargar
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center">
                                                    <div class="col-md-4 d-flex justify-content-center" v-if="
                                                        form.item
                                                            .series_enabled
                                                    ">
                                                        <div class="form-group" :class="{
                                                        ...
                                                        <div class="form-group" :class="{
                                                            ...
                                                            <div
                                                                ...
                                                                <el-button class="btn_canjearsmall"
                                                                    icon="fas fa-upload icon" @click.prevent="
                                                                        $refs.file.click()
                                                                        "></el-button>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-4 d-flex justify-content-center" v-if="form.item.lots_enabled">
                                <div class="form-group" :class="{
                                    ...
                                    <el-button
                                        class="btn btnsdr-lotes d-flex align-items-center justify-content-center gap-2"
                                        style="background-color: #e6e6fa; margin-top:2%;" type="primary"
                                        icon="fas fa-sign-in-alt icon" @click.prevent="clickLotGroupCode">
                                        Lotes
                                    </el-button>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 d-flex justify-content-center" v-if="form.item.lots_enabled">
                                <div class="form-group" :class="{
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        <el-tooltip class="item" effect="dark" content="Descargar Formato de Excel"
                                            placement="top">
                                            <a href="/formats/lots_group_compras.xlsx"
                                                class="text-success d-inline-flex align-items-center gap-1">
                                                <i class="fas fa-file-excel fa-2x"></i>
                            ...
                            <div class="col-md-4 d-flex justify-content-center" v-if="form.item.lots_enabled">
                                <div class="form-group" :class="{
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <el-button
                                            class="btn btn-subir w-50 d-flex align-items-center justify-content-center gap-2 bg-light"
                                            icon="fas fa-upload icon" @click.prevent="$refs.file.click()"></el-button>
                                        <input type="file" @change="uploadExcelGroup" style="visibility:hidden;"
                                            ref="file" accept=".xlsx,.xls" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-4 d-flex justify-content-center" v-if="form.item.has_color_size">
                                <div class="form-group" :class="{
                                    ...
                                    <div>
                                        ...
                                        <small class="form-control-feedback" v-if="errors.has_color_size"
                            ...
                            <div class="col-md-4 d-flex justify-content-center" v-if="form.item.has_color_size">
                                <div class="form-group" :class="{
                                    ...
                                    <div class="d-flex gap-3">
                                        ...
                                        <el-tooltip class="item" effect="dark"
                                            content="Descargar Formato de Excel con codigo familia" placement="top">
                                            <a href="/formats/color_talla_compras_code.xlsx"
                                                class="text-success d-inline-flex align-items-center gap-1">
                                                <i class="fas fa-file-excel fa-2x"></i>
                                            </a>
                            ...
                            <div class="col-md-4 d-flex justify-content-center" v-if="form.item.has_color_size">
                                <div class="form-group" :class="{
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <el-button
                                            class="btn btn-subir w-50 d-flex align-items-center justify-content-center gap-2"
                                            icon="fas fa-upload icon" @click.prevent="$refs.file.click()"></el-button>
                                        <input type="file" @change="uploadExcelColorSize" style="visibility:hidden;"
                                            ref="file" accept=".xlsx,.xls" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-4 d-flex justify-content-center" v-if="form.item.series_enabled">
                                <div class="form-group" :class="{ 'has-danger': errors.lot_code }">
                                    <div>
                                        <el-button class="btn btnsdr-series-colores" icon="fas fa-sign-in-alt icon"
                                            style="margin-top:2%;" type="primary" @click.prevent="clickLotcode">
                                            Series
                                        </el-button>
                                        <small class="form-control-feedback" v-if="errors.has_color_size"
                                            v-text="errors.has_color_size[0]"></small>
                                ...
                                <div class="form-group" :class="{ 'has-danger': errors.lot_code }">
                                    <div class="d-flex justify-content-center">
                                        <el-button
                                            class="btn btn-subir w-50 d-flex align-items-center justify-content-center gap-2"
                                            icon="fas fa-upload icon" @click.prevent="$refs.file.click()"></el-button>
                                        <input type="file" @change="uploadExcel" style="visibility:hidden;" ref="file"
                                            accept=".xlsx,.xls" />
                                    </div>
                                </div>
                            </div>
        ...
        <item-form :showDialog.sync="showDialogNewItem" :external="true" :is_prurchase="true"
            @add="addRowItems"></item-form>
        <lots-form :showDialog.sync="showDialogLots" :stock="form.quantity" :lots="lots"
...
export default {
    ...
    methods: {
        ...
        uploadExcelColorSize(event) {
            ...
            readXlsxFile(file).then(rows => {
                rows.shift();
                const colorSizeArr = rows.map(row => {
                    let color = row[0];
                    let size = row[1];
                    let stock = row[2];
                    let price = row[3];
                    let code = row[4];
                    return { color, size, stock, price, code };
                });
                // Validar códigos duplicados
                const codes = colorSizeArr.map(item => item.code);
        ...
        changeItem(changing_name = false) {
            ...
            if (changing_name) {
                ...
                this.input_barcode = this.form.item
                    ? this.form.item.full_description
                    : "";
