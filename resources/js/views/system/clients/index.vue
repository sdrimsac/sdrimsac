...
<div>
                    ...
                    <div class="widget-summary widget-summary-md">
                        ...
                        <div class="widget-summary-col">
                            ...
                            <div class="summary-footer d-block">
                                <a class="text-muted text-uppercase" href="https://docs.google.com/document/d/1hpEQUs9OFha_35yyLb1cMKeluD-dEku5lQsQ3TJFib8/edit" target="BLANK">Incrementar</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="widget-summary widget-summary-md">
                        ...
                        <div class="widget-summary-col">
                            ...
                            <div class="summary-footer d-block">
                                <a class="text-muted text-uppercase" href="https://drive.google.com/open?id=1foPKDI3V3Z9uKTjRc2SPSoztVSOBevPAluT2BqFbfxA" target="BLANK">Limpiar</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <tr slot-scope="{ index, row }">
                        ...
                        <td>
                            <el-dropdown @command="manageIndexCommand" trigger="click">
                                <el-button type="primary" class="bg-secondary">
                        ...
                        <td class="text-center">
                            <el-tooltip class="item" content="Comprobantes enviados / por enviar" effect="dark" placement="top-start">
                                <el-badge :value="row.document_not_sent" class="item" :type="
                                                row.document_not_sent == 0 ? 'primary' : 'danger'">
                                    <i class="far fa-bell text-secondary"></i>
                                </el-badge>
                            </el-tooltip>

                            <el-tooltip class="item" content="Comprobantes pendientes de rectificación" effect="dark" placement="top-start">
                                <el-badge :value=" row.document_regularize_shipping" class="item  ml-4" :type="
                            ...
                            <el-tooltip class="item" content="Comprobantes por anular" effect="dark" placement="top-start">
                                <el-badge :value="row.document_to_be_canceled" class="item  ml-4" :type="
                        ...
                        <td>
                            <template v-if=" row.last_register && row.last_register.user">
                                <span>{{ row.last_register.user }}</span><br />
                                <span :class=" `${ row.last_register.date_time .is24Hours
                                        ? 'text-danger' : ''}`">{{
                        ...
                        <td class="text-center">
                            <template v-if="
                                        ...
                                        ">
                                <el-popover :content="text_limit_users" placement="top-start" trigger="hover" width="220">
                        ...
                        <td class="text-center">
                            <data-limit-notification entity_description="establecimientos" :unlimited="
                                            row.establishments_unlimited
                                        " :quantity="row.quantity_establishments" :max_quantity="
                        ...
                        <td class="text-center">
                            <data-limit-notification entity_description="ventas" style_div="width: 150px !important" :unlimited="row.sales_unlimited" :quantity="row.monthly_sales_total" :max_quantity="row.max_sales_limit">
                            </data-limit-notification>
                        </td>
    ...
    <client-payments :clientId="recordId" :showDialog.sync="showDialogPayments"></client-payments>
