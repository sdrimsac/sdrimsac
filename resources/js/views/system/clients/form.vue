            ...
            <div class="form-body">
                ...
                <el-collapse v-show="false" v-model="collapse">
                    <el-collapse-item name="1" title="Módulos">
                        <div class="row">
                            <span class="ml-4"
                                >Giro de negocio <small>(opcional)</small></span
                            >
                            <div class="col-12">
                                <el-radio-group
                                    v-model="business"
                    ...
                    <el-collapse-item name="2" title="Entorno del sistema">
                        ...
                        <div class="row">
                            ...
                            <div
                                v-show="form.is_update == true"
                                class="col-md-6"
                            >
                                <div class="form-group">
                                    <label class="control-label">
                                        Archivo cargado (Cliente)
                                        {{ form.certificate ? "(1)" : "(0)" }}
                                    </label>
                                    <el-input
                    ...
                    <el-collapse-item name="3" title="Configuracion de correo">
                        <div class="row">
                            <div class="col-md-6">
                                <div
                                    :class="{ 'has-danger': errors.smtp_host }"
                                    class="form-group"
                                >
                                    <label class="control-label">
                            ...
                            <div class="col-md-6">
                                <div
                                    :class="{ 'has-danger': errors.smtp_port }"
                                    class="form-group"
                                >
                                    <label class="control-label">
                            ...
                            <div class="col-md-6">
                                <div
                                    :class="{ 'has-danger': errors.smtp_user }"
                                    class="form-group"
                                >
                                    <label class="control-label">
                            ...
                            <div class="col-md-6">
                                ...
                                >
                                    ...
                                    <el-input v-model="form.smtp_encryption">
                                    </el-input>
                                    <small
                    ...
                    <div class="col-md-6 center-el-checkbox mt-4">
                        <div class="form-group">
                            <el-checkbox v-model="form.config_system_env">
                                ¿ Permitir a la empresa cambiar la configuración
                                de producción ?
                            </el-checkbox>
                            <br />
                        </div>
...
export default {
    ...
    methods: {
        FixChildren(currentObj, treeStatus) {
            ...
            if (currentObj !== undefined) {
                ...
                if (selected !== -1) {
                    ...
                    if (
                        currentObj.childrens !== undefined &&
                        currentObj.childrens.length !== 0
                    ) {
            ...
            if (treeList !== undefined && element !== undefined) {
                ...
                if (treeList.childrens !== undefined) {
                    for (let i = 0; i < treeList.childrens.length; i++) {
                        this.FixSameValueToChild(
                            treeList.childrens[i],
                            isSelected,
                            element
                        );
                    }
        ...
        async submit() {
            ...
            this.button_text = this.form.is_update
