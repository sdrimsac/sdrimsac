<template>
    <div class="card">
      <div class="card-header bg-secondary">
        <h3 class="my-0">URL|Token para la emisión de documentos</h3>
      </div>
      <div class="card-body">
          ...
          <div class="form-body">
              <div class="col-md-12">
                <div class="form-group" :class="{'has-danger': errors.document_emit_url}">
                  ...
                  <el-input v-model="form.document_emit_url"></el-input>
                  <small
              ...
              <div class="col-md-12">
                <div class="form-group" :class="{'has-danger': errors.document_emit_url_token}">
                    ...
                    <el-input v-model="form.document_emit_url_token"></el-input>
                    <small
                    class="form-control-feedback"
