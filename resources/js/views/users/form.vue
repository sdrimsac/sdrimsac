<template>
    <div class="card">
        <div class="card-header bg-primary">
            <h6 class="my-0 text-white">Datos del Usuario <small>Acceso al sistema</small></h6>
        </div>
        <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group" :class="{'has-danger': errors.email}">
                                ...
                                <el-input v-model="form.email" :disabled="true"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group" :class="{'has-danger': errors.api_token}">
                                ...
                                <el-input v-model="form.api_token" readonly> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
