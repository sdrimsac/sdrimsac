...
<div>
    <div class="card">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mt-4">
                                                <div class="form-group">
                                                    ...
                                                    <el-switch v-model="form.college" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                </div>
                                            </div>
                                            <!-- Entorno Restaurant -->
                                            <div class="col-md-3 mt-4">
                                            ...
                                            <div class="col-md-3 mt-4">
                                                <div class="form-group">
                                                    <label class="control-label w-100">
                                                        ...
                                                        Entorno Hotel</label>
                                                    <el-switch v-model="form.hotels" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                </div>
                                            </div>
                                            <!-- Entorno Internet -->
                                            <div class="col-md-3 mt-4">
                                                <div class="form-group">
                                                    ...
                                                    <el-switch v-model="form.internet" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3 mt-4">
                                                <div class="form-group">
                                                    ...
                                                    <el-switch v-model="form.health_network" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card">
                                                <div class="card-header bg-primary">
                                                    <h4 class="my-0 text-white">
                                                        ...
                                                        COMPLEMENTOS DE MODELO DE NEGOCIO
                                                    </h4>
                                                </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <el-switch v-model="form.promotions_sell" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <el-input v-model="form.promotions_cant_purchase" placeholder="Cantidad de ventas para acceder a la promoción " size="normal" @blur="submit">
                                                            </el-input>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3 mt-4">
                                                            <div class="form-group">
                                                                <label class="control-label w-100">
                                                                    ...
                                                                    Habilitar Contabilidad</label>
                                                                <el-switch v-model="form.accounting_mode" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3 mt-4">
                                                            <div class="form-group">
                                                                ...
                                                                <el-switch v-model="form.series_enabled" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3 mt-4">
                                                            <div class="form-group">
                                                                ...
                                                                <el-switch v-model="form.lots_enabled" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3 mt-4">
                                                            <div class="form-group">
                                                                ...
                                                                <el-switch v-model="form.dispatch" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3 mt-4">
                                                            <div class="form-group">
                                                                ...
                                                                <el-switch v-model="form.quotation" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3 mt-4">
                                                            <div class="form-group">
                                                                ...
                                                                <el-switch v-model="form.consignment" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <template id="select-append">
                                                                ...
                                                                <div class="el-input el-input-group el-input-group--append">
                                                                    <el-select :disabled="
                                                                        ...
                                                                        " @change="changeItem" filterable remote placeholder="Buscar......" popper-class="el-select-items" @visible-change="
                                                                            focusTotalItem
                                                                        " slot="prepend" id="select-width" :remote-method="
                                                                            searchRemoteItems
                                                                        " :loading="loading_search">
                                                                        <el-option v-for="option in items" :key="option.id" :value="option.id" :label="
                                                        ...
                                                        <div class="col-md-3 mt-4">
                                                            <div class="form-group">
                                                                ...
                                                                <el-switch v-model="form.transform_item" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 mt-4">
                                                <div class="form-group">
                                                    ...
                                                    <el-switch v-model="form.affectation_optional" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                </div>
                                            </div>
                                            <div class="col-md-3 mt-4" v-if="typeUser != 'integrator'">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mt-4">
                                                ...
                                                <div class="form-group" :class="{ 'has-danger': errors.days_before_emit }">
                                                    <el-select v-model="form.days_before_emit" @change="submit">
                                                        <el-option v-for="day in days" :key="`${day.id}-d`" :value="day.value" :label="`${day.value} ${day.value > 1 ? ' días' : ' día'}`"></el-option>
                                                    </el-select>
                                                                    ...
                                                                    <div class="section-content">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-4 mt-4">
                                                                                <label class="control-label">
                                                                                    <i class="fas fa-redo-alt tab-icon"></i>
                                                                                    Recrear Documento
                                                                                </label>
                                                                            ...
                                                                            <div class="col-md-4 mt-4">
                                                                                <div class="form-group">
                                                                                    <label class="control-label w-100">
                                                                                        ...
                                                                                        <el-tooltip class="item" effect="dark" content="Visualiza Usurios en Administrador" placement="top-start">
                                                                                                <i class="fa fa-info-circle"></i>
                                                                                            </el-tooltip>
                                                                                    </label>
                                                                    ...
                                                                    <div class="section-content">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4 mt-4">
                                                                                <div class="form-group">
                                                                                    <label class="control-label w-100">
                                                                                        <i class="fas fa-cash-register tab-icon"></i>
                                                                                        Multiples Cajas
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                Venta Rapida
                                                                                <el-tooltip class="item" effect="dark" content="Venta Rapida modulo de CAJA (Activar en Establecimientos)" placement="top-start">
                                                                                        <i class="fa fa-info-circle"></i>
                                                                                    </el-tooltip>
                                                                                </label>
                                                                            ...
                                                                            <div class="col-md-4 mt-4">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    Vendedores en caja
                                                                                    <el-tooltip class="item" effect="dark" content="Aciva selección de Vendedores en CAJA" placement="top-start">
                                                                                        <i class="fa fa-info-circle"></i>
                                                                                    </el-tooltip>
                                                                                    </label>
                                                                            ...
                                                                            <div class="col-md-4 mt-4">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="form-group" :class="{'has-danger': errors.quantity_cash}">
                                                                            ...
                                                                            <div class="col-md-4 mt-4">
                                                                                <div class="form-group">
                                                                                    <label class="control-label w-100">
                                                                                        <i class="fas fa-pencil-alt tab-icon"></i>
                                                                                        Editar Subtotal
                                                                                        <el-tooltip class="item" effect="dark" content="Editar Sub Total de venta en CAJA" placement="top-start">
                                                                                            <i class="fa fa-info-circle"></i>
                                                                                        </el-tooltip>
                                                                                    </label>
                                                                    ...
                                                                    <div class="section-content">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4 mt-4">
                                                                                <div class="form-group">
                                                                                    <label class="control-label w-100">
                                                                                        ...
                                                                                        Crear Productos
                                                                                        <el-tooltip class="item" effect="dark" content="Crear Productos en CAJA" placement="top-start">
                                                                                            <i class="fa fa-info-circle"></i>
                                                                                        </el-tooltip>
                                                                                    </label>
                                                                            ...
                                                                            <div class="col-md-4 mt-4">
                                                                                <div class="form-group">
                                                                                    <label class="control-label w-100">
                                                                                        ...
                                                                                        Permitir Ajuste Stock
                                                                                        <el-tooltip class="item" effect="dark" content="Permite Ajustar Stock en Administrador" placement="top-start">
                                                                                            <i class="fa fa-info-circle"></i>
                                                                                        </el-tooltip>
                                                                                    </label>
                                                                            ...
                                                                            <div class="col-md-4 mt-4">
                                                                                <div class="form-group">
                                                                                    <label class="control-label w-100">
                                                                                        <i class="fas fa-pencil-ruler tab-icon"></i>
                                                                                        Editar Producto 
                                                                                        <el-tooltip class="item" effect="dark" content="Editar Productos en CAJA" placement="top-start">
                                                                                                <i class="fa fa-info-circle"></i>
                                                                                        </el-tooltip>
                                                                                    </label>
                                                                            ...
                                                                            <div class="col-md-4 mt-4">
                                                                                <div class="form-group">
                                                                                    <label class="control-label w-100">
                                                                                        <i class="fas fa-cubes tab-icon"></i>
                                                                                        Crear Productos Compuestos
                                                                                        <el-tooltip class="item" effect="dark" content="Crear Productos Compuestos en CAJA" placement="top-start">
                                                                                                <i class="fa fa-info-circle"></i>
                                                                                        </el-tooltip>
                                                                                    </label>
                                                                            ...
                                                                            <div class="col-md-4 mt-4">
                                                                                <div class="form-group">
                                                                                    <label class="control-label w-100">
                                                                                        <i class="fas fa-box-open tab-icon"></i>
                                                                                        Editar Productos Compuestos 
                                                                                        <el-tooltip class="item" effect="dark" content="Modificar Cantidad de Productos Compuestos en CAJA" placement="top-start">
                                                                                                    <i class="fa fa-info-circle"></i>
                                                                                        </el-tooltip>
                                                                                    </label>
                                                                            ...
                                                                            <div class="col-md-4 mt-4">
                                                                                <div class="form-group">
                                                                                    <label class="control-label w-100">
                                                                                        <i class="fas fa-eye tab-icon"></i>
                                                                                        Mostrar Sock de Productos
                                                                                        <el-tooltip class="item" effect="dark" content="Mostrar Stock de productos en CAJA" placement="top-start">
                                                                                                    <i class="fa fa-info-circle"></i>
                                                                                        </el-tooltip>
                                                                                    </label>
                                                                            ...
                                                                            <div class="col-md-4 mt-4">
                                                                                <div class="form-group">
                                                                                    <label class="control-label w-100">
                                                                                        ...
                                                                                        Mostrar Productos X Vencer
                                                                                        <el-tooltip class="item" effect="dark" content="Mostrar Productos por vencer en CAJA" placement="top-start">
                                                                                                 <i class="fa fa-info-circle"></i>
                                                                                        </el-tooltip>
                                                                                    </label>
                                                                            ...
                                                                            <div class="col-md-4 mt-4">
                                                                                <div class="form-group">
                                                                                    <label class="control-label w-100">
                                                                                        <i class="fas fa-align-left tab-icon"></i>
                                                                                        Mostrar Descripción Producto
                                                                                        <el-tooltip class="item" effect="dark" content="Mostrar Nombre o Descripción completa Productos por vencer en CAJA" placement="top-start">
                                                                                                 <i class="fa fa-info-circle"></i>
                                                                                        </el-tooltip>
                                                                            ...
                                                                            <div class="col-md-4 mt-4">
                                                                                <div class="form-group">
                                                                                    <label class="control-label w-100">
                                                                                        ...
                                                                                        <el-tooltip class="item" effect="dark" content="Mostrar Stock de productos de todos los almacenes en CAJA" placement="top-start">
                                                                                            <i class="fa fa-info-circle"></i>
                                                                                        </el-tooltip>
                                                                                    </label>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label class="control-label w-100">
                                                                                    ...
                                                                                    <el-tooltip class="item" effect="dark" content="Recibir Productos por TRASLADO DE MERCADERIA en CAJA" placement="top-start">
                                                                                        <i class="fa fa-info-circle"></i>
                                                                                    </el-tooltip>
                                                                                </label>
                                                                            ...
                                                                            <div class="col-md-4 mt-4">
                                                                                <div class="form-group">
                                                                                    <label class="control-label w-100">
                                                                                        <i class="fas fa-sort-alpha-down tab-icon"></i>
                                                                                        Ordenar Productos X Descripción
                                                                                        <el-tooltip class="item" effect="dark" content="Ordenar Productos por Descripción en CAJA" placement="top-start">
                                                                                            <i class="fa fa-info-circle"></i>
                                                                                        </el-tooltip>
                                                                                    </label>
                                                                            ...
                                                                            <div class="col-md-4 mt-4">
                                                                                <div class="form-group">
                                                                                    <label class="control-label w-100">
                                                                                        ...
                                                                                        Buscar Producto X Series
                                                                                        <el-tooltip class="item" effect="dark" content="Buscar Productos por SERIES en CAJA" placement="top-start">
                                                                                            <i class="fa fa-info-circle"></i>
                                                                                        </el-tooltip>
                                                                                    </label>
                                    ...
                                    <div class="nested-tab-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 mt-4">
                                                <div class="form-group">
                                                    <label class="control-label w-100">
                                                        <i class="fas fa-print"></i> Impresión directa vendedor cotización - Caja
                                                    </label>
                                            ...
                                            <div class="col-md-3 mt-4">
                                                <div class="form-group">
                                                    <label class="control-label w-100">
                                                        <i class="fas fa-tag"></i> Imprimir política de precio - Cotización
                                                    </label>
                                        ...
                                        <div class="col-md-3 mt-4">
                                            <div class="form-group">
                                                <label class="control-label w-100">
                                                    <i class="fas fa-image"></i> Imagenes en cotizaciones
                                                </label>
                                    ...
                                    <div class="nested-tab-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 mt-4">
                                                <div class="form-group">
                                                    <label class="control-label w-100">
                                                        <i class="fa fa-cash-register fa-lg"></i> Manejo de caja principal
                                                    </label>
                                                    <el-switch active-text="Si" inactive-text="No" @change="submit" v-model="form.principal_cash"></el-switch>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3 mt-4">
                                                <div class="form-group">
                                                    <label class="control-label w-100">
                                                        <i class="fa fa-clock fa-lg"></i> Turno inicio
                                            ...
                                            <div class="col-md-3 mt-4">
                                                <div class="form-group">
                                                    <label class="control-label w-100">
                                                        <i class="fa fa-clock fa-lg"></i> Turno final
                                                        <el-tooltip class="item" effect="dark" content="Turno elegido para agrupar las cajas" placement="top-start">
                                                            <i class="fa fa-info-circle fa-lg"></i>
                                                        </el-tooltip>
                                                    </label>
                                            ...
                                            <div class="col-md-3 mt-4">
                                                <div class="form-group">
                                                    <label class="control-label w-100">
                                                        <i class="fa fa-money-check-alt fa-lg"></i> A cuenta
                                                    </label>
                                                    <el-switch v-model="form.credit_list" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3 mt-4">
                                                <div class="form-group">
                                                    <label class="control-label w-100">
                                                        <i class="fa fa-cogs fa-lg"></i> Caja principal automatica
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 mt-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <el-switch v-model="form.show_variation_dcto" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4 mt-4">
                                                                <template id="select-append">
                                                                    ...
                                                                    <div class="el-input el-input-group el-input-group--append">
                                                                        <el-select :disabled="!form.show_variation_dcto" @focus="$event.target.select()" ref="producto" v-model="form.item_variation_id" @change="changeItem" filterable remote placeholder="Buscar..." popper-class="el-select-items" @visible-change="focusTotalItem" slot="prepend" id="select-width" :remote-method="searchRemoteItems" :loading="loading_search">
                                                            ...
                                                            <div class="col-md-4 mt-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <el-switch v-model="form.send_whatsapp_activity" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4 mt-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <el-switch v-model="form.pos_drag_category" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4 mt-4">
                                                                <div class="form-group">
                                                                    <label class="control-label w-100">
                                                                        <i class="fa fa-lock fa-lg"></i> Evitar Cerrar Caja con Ordenes Pendientes
                                        ...
                                        <div class="row">
                                            <template v-if="form.hotels">
                                                <div class="col-md-3 mt-4">
                                                    <div class="form-group">
                                                        <label class="control-label w-100">
                                                            <i class="fas fa-bell fa-lg" style="margin-right: 10px;"></i> Tiempo de alarma de alquileres por vencer
                                                        </label>
                                                ...
                                                <div class="col-md-3 mt-4">
                                                    <div class="form-group">
                                                        <label class="control-label w-100">
                                                            <i class="fas fa-tools fa-lg" style="margin-right: 10px;"></i> Tiempo de mantenimiento
                                                        </label>
                                                ...
                                                <div class="col-md-3 mt-4">
                                                    <div class="form-group">
                                                        <label class="control-label w-100">
                                                            <i class="fas fa-shield-alt fa-lg" style="margin-right: 10px;"></i> Límite de la garantía - frigobar
                                                        </label>
                                                        <el-input-number @change="submit" v-model="form.credit_line_hotel_limit"></el-input-number>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 mt-4">
                                                    <div class="form-group">
                                                        <label class="control-label w-100">
                                                            <i class="fas fa-percent fa-lg" style="margin-right: 10px;"></i> Descuento aplicado por día a cambio del servicio x habitación
                                                        </label>
                                                        <el-input-number @change="submit" v-model="form.discount_amount_instead_service"></el-input-number>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 mt-4">
                                                    <div class="form-group">
                                                        <label class="control-label w-100">
                                                            <i class="fas fa-sign-out-alt fa-lg" style="margin-right: 10px;"></i> Tiempo para aviso de salida de habitación
                                                        </label>
                                                        <el-input-number @change="submit" v-model="form.minute_close_to_leave"></el-input-number>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 mt-4">
                                                    <div class="form-group">
                                                        <label class="control-label w-100">
                                                            <i class="fas fa-broom fa-lg" style="margin-right: 10px;"></i> Tiempo para limpiar la habitación
                                                        </label>
                                                        <el-input-number @change="submit" v-model="form.time_to_clean"></el-input-number>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 mt-4">
                                                    <div class="form-group">
                                                        <label class="control-label w-100">
                                                            <i class="fas fa-clock fa-lg" style="margin-right: 10px;"></i> Tiempo para el cálculo del inicio del día
                                                        </label>
                                                        <el-time-picker style="width: 100%;" value-format="HH:mm:ss" :format="'hh:mm A'" :picker-options="{ format: 'hh:mm A' }" timezone="America/Lima" v-model="form.time_to_enter"></el-time-picker>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 mt-4">
                                                    <div class="form-group">
                                                        <label class="control-label w-100">
                                                            <i class="fas fa-clock fa-lg" style="margin-right: 10px;"></i> Tiempo para el cálculo del final del día
                                                        </label>
                                                        <el-time-picker style="width: 100%;" value-format="HH:mm:ss" :format="'hh:mm A'" :picker-options="{ format: 'hh:mm A' }" timezone="America/Lima" v-model="form.time_to_leave"></el-time-picker>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 mt-4">
                                                    <div class="form-group">
                                                        <label class="control-label w-100">
                                                            <i class="fas fa-check-circle fa-lg" style="margin-right: 10px;"></i> Autorización de descuento
                                                        </label>
                                                ...
                                                <div class="col-md-3 mt-4">
                                                    <div class="form-group">
                                                        <label class="control-label w-100">
                                                            <i class="fas fa-wrench fa-lg" style="margin-right: 10px;"></i> Control de mantenimiento
                                                        </label>
                                                        <el-switch v-model="form.maintenance_workers" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                    </div>
                                                </div>
                                            </template>
                                        </div>
                                    ...
                                    <div class="nested-tab-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 mt-4">
                                                <div class="form-group">
                                                    <label class="control-label w-100">
                                                        <i class="fas fa-gavel fa-lg" style="margin-right: 10px;"></i> Penalidades
                                                    </label>
                                                    <el-switch v-model="form.sale_note_credit_penalty" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                </div>
                                            </div>
                                            <div class="col-md-3 mt-4">
                                                <div class="form-group">
                                                    <label class="control-label w-100">
                                                        <i class="fas fa-check-circle fa-lg" style="margin-right: 10px;"></i> Confirmación de aprobación
                                                    </label>
                                                    <el-switch v-model="form.sale_note_credit_confirm" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                </div>
                                            </div>
                                            <div class="col-md-3 mt-4">
                                                <div class="form-group">
                                                    ...
                                                    <el-switch v-model="form.sale_note_credit_low_pay" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                </div>
                                            </div>
                                            <div class="col-md-3 mt-4">
                                                <div class="form-group">
                                                    ...
                                                    <el-switch v-model="form.sale_note_credit_edit" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                </div>
                                            </div>
                                            <div class="col-md-3 mt-4">
                                                <div class="form-group">
                                                    <label class="control-label w-100">
                                                        <i class="fas fa-whatsapp fa-lg" style="margin-right: 10px;"></i> Enviar whatsapp a clientes
                                                    </label>
                                                    <el-switch v-model="form.sale_note_credit_send_whatsapp" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                </div>
                                            </div>
                                            <div class="col-md-3 mt-4">
                                                <div class="form-group">
                                                    <label class="control-label w-100">
                                                        <i class="fas fa-file-alt fa-lg" style="margin-right: 10px;"></i> Mostrar formatos adicionales
                                                    </label>
                                                    <el-switch v-model="form.sale_note_credit_formats" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                </div>
                                            </div>
                                            <div class="col-md-3 mt-4">
                                                <div class="form-group">
                                                    <label class="control-label w-100">
                                                        <i class="fas fa-percent fa-lg" style="margin-right: 10px;"></i> % de crédito
                                                    </label>
                                            ...
                                            <div class="col-md-3 mt-4">
                                                <div class="form-group">
                                                    <label class="control-label w-100">
                                                        <i class="fas fa-user-edit fa-lg" style="margin-right: 10px;"></i> Whatsapp personalizado
                                                        <el-tooltip class="item" effect="dark" content="Usa su propia app de whatsapp" placement="top-start">
                                                            <i class="fa fa-info-circle"></i>
                                                        </el-tooltip>
                                                    </label>
                                                    <el-switch v-model="form.whatsapp_client" active-text="Si" inactive-text="No" @change="submit"></el-switch>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <el-dialog :visible.sync="showAddNumberwhatsapp" 
