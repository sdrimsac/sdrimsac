                            ...
                            <div class="row">
                                <template v-if="form.hotels">
                                    ...
                                    <div class="col-md-3 mt-4">
                                        <div class="form-group">
                                            <label class="control-label w-100">
                                                Tiempo para el calculo del final
                                                del dia
                                            </label>
                        ...
                        <el-tab-pane v-if="!isArca" name="entorno">
                            <template #label>
                                <div class="tab-label">
                                    ...
                                    <span class="tab-text">Entorno</span>
                                </div>
                            </template>

                            <div class="tab-content">
                                <!-- Tabs anidados dentro del tab de "Configuración de entorno" -->
                                <el-tabs type="card" v-model="modes">
                                    ...
                                    <el-tab-pane name="modes">
                                        ...
                                        <div class="form-group text-center">
                                            <label
                                                class="control-label w-100 text-white bg-primary p-2"
                                            >
                                                Habilitar los Modos que
                                    ...
                                    <!-- Panel Modelo de Negocio -->
                                    <el-tab-pane name="complementos">
                                        <template #label>
                                            <div class="tab-label">
                                                <i
                                                    class="el-icon-s-tools tab-icon"
                                                ></i>
                                                <span class="tab-text"
                                                    >Modelo de Negocio</span
                                                >
                                            </div>
                                        </template>
                                        <div class="card">
                                            ...
                                            <div class="container mt-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2 mt-4">
                                                        ...
                                                        >
                                                            <i
                                                                class="fas fa-sync-alt tab-icon"
                                                            ></i>
                                                            Recrear Documento
                                                        </label>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-2 mt-4">
                                                        ...
                                                        >
                                                            <i
                                                                class="fas fa-piggy-bank tab-icon"
                                                            ></i>
                                                            Detracción por
                                                            defecto
                                                            <el-tooltip
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        ...
                                                                        (Admin)
                                                                        <el-tooltip
                                                                            content="Visualiza Usuarios en Administrador"
                                                                        >
                                                                            <i
                                                                                class="fa fa-info-circle"
                                                                            ></i>
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        <i
                                                                            class="fas fa-file-download tab-icon"
                                                                        ></i>
                                                                        Descargar
                                                                        todos
                                                                        los
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 mt-4">
                                                <div class="form-group">
                                                    ...
                                                    >
                                                        <i
                                                            class="fas fa-receipt fa-lg"
                                                        ></i>
                                                        Imprimir referencia en
                                                        ticket
                                                    </label>
                                                    <el-switch
                                                        v-model="
                                            ...
                                            <div class="col-md-2 mt-4">
                                                <div class="form-group">
                                                    ...
                                                    >
                                                        <i
                                                            class="fas fa-ticket-alt tab-icon"
                                                        ></i>
                                                        Mostrar política precios
                                                        ticket
                                                    </label>
                                                    <el-switch
                                                        v-model="
                                            ...
                                            <div class="col-md-2 mt-4">
                                                <div class="form-group">
                                                    ...
                                                    <el-switch
                                                        ...
                                                        @change="
                                                            submit(
                                                                'Ocultar Nombre Comercial En Los Documentos',
                                                                form.comercial_mane,
                                                                'comercial_mane',
                                                                'ticketAltIcon'
                                                            )
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mt-4">
                                                    <div class="form-group">
                                                        <label for="text-3">
                                                            <i
                                                                class="fas fa-quote-right fa-lg"
                                                            ></i>
                                                            Imprimir Texto pie
                                                            de página
                                                            <el-tooltip
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                <el-switch
                                                                    ...
                                                                    @change="
                                                                        submit(
                                                                            'Listado De Politica De Precios',
                                                                            form.pricing_policy_venta,
                                                                            'Listado De Politica De Precios',
                                                                            'tagsIcon'
                                                                        )
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                <el-switch
                                                                    v-model="
                                                                        form.nuevo_comprobante_electronico
                                                                    "
                                                                    active-text="Si"
                                                                    inactive-text="No"
                                                                    :active-color="
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                <el-switch
                                                                    v-model="
                                                                        form.listado_boleta_factura_nuevo
                                                                    "
                                                                    active-text="Si"
                                                                    inactive-text="No"
                                                                    :active-color="
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                <el-switch
                                                                    ...
                                                                    @change="
                                                                        submit(
                                                                            'Productos Vendidos Boletas y Facturas',
                                                                            form.productos_vendidos,
                                                                            'productos_vendidos Boletas y Facturas',
                                                                            'listIcon'
                                                                        )
                                                                    "
                                                                ></el-switch>
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                <el-switch
                                                                    ...
                                                                    @change="
                                                                        submit(
                                                                            'Reporte Productos Vendidos Nota de Venta',
                                                                            form.sale_note_venta,
                                                                            'Reporte Productos Vendidos Nota de Venta',
                                                                            'fingerprintIcon'
                                                                        )
                                            ...
                                            <div class="row" v-if="form.hotels">
                                                ...
                                                <div class="col-md-3 mt-4">
                                                    <div class="form-group">
                                                        ...
                                                        >
                                                            <i
                                                                class="fas fa-shield-alt tab-icon"
                                                            ></i>
                                                            Límite de la
                                                            garantía - frigobar
                                                        </label>
                                                ...
                                                <div class="col-md-3 mt-4">
                                                    <div class="form-group">
                                                        ...
                                                        >
                                                            <i
                                                                class="fas fa-sign-out-alt tab-icon"
                                                            ></i>
                                                ...
                                                <div class="col-md-3 mt-4">
                                                    <div class="form-group">
                                                        ...
                                                        >
                                                            <i
                                                                class="fas fa-check-circle tab-icon"
                                                            ></i>
                                                            Autorización de
                                                            descuento
                                                        </label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 mt-4">
                                                    <div class="form-group">
                                                        ...
                                                        >
                                                            <i
                                                                class="fas fa-balance-scale tab-icon"
                                                            ></i>
                                                            Penalidades
                                                        </label>
                                                        <el-switch
                                                ...
                                                <div class="col-md-2 mt-4">
                                                    <div class="form-group">
                                                        ...
                                                        >
                                                            <i
                                                                class="fas fa-money-bill-wave tab-icon"
                                                            ></i>
                                                            Aceptar montos
                                                            menores en las
                                                            cuotas
                                                ...
                                                <div class="col-md-2 mt-4">
                                                    <div class="form-group">
                                                        ...
                                                        >
                                                            <i
                                                                class="fab fa-whatsapp tab-icon"
                                                            ></i>
                                                            Enviar whatsapp a
                                                            clientes
                                                        </label>
                                                ...
                                                <div class="col-md-2 mt-4">
                                                    <div class="form-group">
                                                        ...
                                                        >
                                                            <i
                                                                class="fas fa-user-edit tab-icon"
                                                            ></i>
                                                            Whatsapp
                                                            personalizado
                                                            <el-tooltip
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 mt-4">
                                                    <div class="form-group">
                                                        ...
                                                        >
                                                            <i
                                                                class="fas fa-hourglass-end tab-icon"
                                                            ></i>
                                                            Turno final
                                                            <el-tooltip
                                                                class="item"
...
export default {
    ...
    computed: {
        filteredAndSortedItems() {
            ...
            return this.items
                ...
                .sort((a, b) => {
                    const aStartsWithQuery = a.label
                        .toLowerCase()
                        .startsWith(query);
                    const bStartsWithQuery = b.label
                        .toLowerCase()
                        .startsWith(query);
    ...
    methods: {
        ...
        // },
        async removeNumberWhatsapp(idx) {
            let { id, number } = this.numbers[idx];
            const response = await this.$http.post("/whatsapp/remove", {
                number,
                id
            });
