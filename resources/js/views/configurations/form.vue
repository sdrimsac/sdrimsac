                ...
                <template v-if="form.hotels">
                  <div class="col-md-3 mt-4">
                    <div class="form-group">
                      ...
                      <el-input-number @change="submit" v-model="form.alarm_to_end"></el-input-number>
                    </div>
                  </div>
                  <div class="col-md-3 mt-4">
                    <div class="form-group">
                  ...
                  <div class="col-md-3 mt-4">
                    <div class="form-group">
                      <label class="control-label w-100">Tiempo de mantenimiento</label>

                      <el-input-number @change="submit" v-model="form.time_manteniment"></el-input-number>
                    </div>
                  </div>
                          ...
                          <div class="col-md-3 mb-4" v-if="canSee">
                            <div class="form-group">
                              ...
                              <el-switch
                                ...
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="() => submit('Entorno billar', form.modo_billar, 'healthIcon')"
                              ></el-switch>
                            </div>
                          </div>
                          <div class="col-md-3 mb-4" v-if="canSee">
                            <div class="form-group">
                              ...
                              <el-switch
                                ...
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="() => submit('Entorno maderera', form.maderera, 'healthIcon')"
                              ></el-switch>
                            </div>
                          </div>
                          <div class="col-md-3 mb-4" v-if="canSee">
                            <div class="form-group">
                              ...
                              <el-switch
                                ...
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="() => submit('Entorno Mecanica Repuesto', form.workshop, 'healthIcon')"
                              ></el-switch>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col-md-3 mt-4">
                            <div class="form-group">
                              <label class="control-label w-100">
                                ...
                                <i class="fas fa-palette"></i> Habilitar Manejo de Color & Talla
                              </label>
                              <el-switch
                          ...
                          <div class="col-md-3 mt-4">
                            <div class="form-group">
                              <label class="control-label w-100">
                                ...
                                ></i> Habilitar Tratamiento Comercial
                                <el-tooltip
                                  class="item"
                                  effect="dark"
                          ...
                          <div class="col-md-3 mt-4">
                            <div class="form-group">
                              <label class="control-label w-100">
                                ...
                                ></i> Producto Penalidad - Consignación
                              </label>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-2 mt-4">
                            <div class="form-group">
                              ...
                              <el-switch
                                v-model="form.affectation_optional"
                                active-text="SI"
                                inactive-text="NO"
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Cambiar Afectación IGV (CAJA)', form.affectation_optional, 'affectation_optional', 'exchangeIcon')"
                              ></el-switch>
                            </div>
                          </div>
                          ...
                          <div class="col-md-2 mt-4" v-if="typeUser != 'integrator'">
                            ...
                            <div
                              class="form-group"
                              :class="{'has-danger': errors.decimal_quantity}"
                            >
                              <el-input-number
                                v-model="form.decimal_quantity"
                                @change="submit('Cantidad decimales POS', true, 'decimal_quantity', 'numericIcon')"
                                :min="2"
                                :max="10"
                              ></el-input-number>
                              <small
                              ...
                              <small
                                class="text-danger"
                                v-if="errors.decimal_quantity"
                                v-text="errors.decimal_quantity[0]"
                              ></small>
                            </div>
                          </div>
                          ...
                          <div class="col-md-2 mt-4" v-if="typeUser != 'integrator'">
                            ...
                            <div
                              class="form-group"
                              :class="{'has-danger': errors.amount_plastic_bag_taxes}"
                            >
                              <el-input-number
                                v-model="form.amount_plastic_bag_taxes"
                                @change="submit('Impuesto bolsa plástica', true, 'amount_plastic_bag_taxes', 'recycleIcon')"
                                :precision="2"
                                :step="0.1"
                                :max="0.5"
                                :min="0.1"
                          ...
                          <div class="col-md-2 mt-4">
                            ...
                            >
                              ...
                              <el-select
                                ...
                                @change="submit('Tipo de afectación Venta', true, 'affectation_igv_type_id', 'invoiceIcon')"
                                filterable
                              >
                                <el-option
                          ...
                          <div class="col-md-2 mt-4">
                            ...
                            <div class="form-group" :class="{'has-danger': errors.send_auto}">
                              <el-switch
                                ...
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Envío de comprobantes automático', form.send_auto, 'send_auto', 'planeIcon')"
                              ></el-switch>
                              <small
                                class="text-danger"
                          ...
                          <div class="col-md-2 mt-4" v-if="typeUser != 'integrator'">
                            ...
                            <div class="form-group" :class="{'has-danger': errors.cron}">
                              <el-switch
                                ...
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Ejecutar Tareas Programadas', form.cron, 'cron', 'calendarIcon')"
                              ></el-switch>
                          ...
                          <div class="col-md-2 mt-4">
                            ...
                            <div
                              class="form-group"
                              :class="{'has-danger': errors.change_date_emit}"
                            >
                              <el-switch
                                ...
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Cambiar fecha de emisión', form.change_date_emit, 'change_date_emit', 'dateIcon')"
                              ></el-switch>
                              <small
                                class="text-danger"
                                v-if="errors.change_date_emit"
                                v-text="errors.change_date_emit[0]"
                              ></small>
                            </div>
                          </div>
                          ...
                          <div class="col-md-2 mt-4">
                            ...
                            <div
                              class="form-group"
                              :class="{'has-danger': errors.restrict_receipt_date}"
                            >
                              <el-switch
                                v-model="form.restrict_receipt_date"
                                active-text="SI"
                                inactive-text="NO"
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Restringir fecha de comprobante', form.restrict_receipt_date, 'restrict_receipt_date', 'banIcon')"
                              ></el-switch>
                              <small
                                class="text-danger"
                                v-if="errors.restrict_receipt_date"
                                v-text="errors.restrict_receipt_date[0]"
                              ></small>
                            </div>
                          </div>
                          ...
                          <div class="col-md-2 mt-4">
                            ...
                            <div
                              class="form-group"
                              :class="{'has-danger': errors.days_before_emit}"
                            >
                              <el-select
                                v-model="form.days_before_emit"
                                @change="submit('Días transcurridos para emitir dcto', true, 'days_before_emit', 'dayIcon')"
                              >
                                <el-option
                                  v-for="day in days"
                                  :key="`${day.id}-d`"
                                  :value="day.value"
                                  :label="`${day.value} ${day.value > 1 ? 'días' : 'día'}`"
                                ></el-option>
                              </el-select>
                              <small
                                class="text-success"
                              ...
                              <small
                                class="text-danger"
                                v-if="errors.days_before_emit"
                                v-text="errors.days_before_emit[0]"
                              ></small>
                            </div>
                          </div>
                          ...
                          <div class="col-md-2 mt-4">
                            ...
                            <div class="form-group" :class="{'has-danger': errors.include_igv}">
                              <el-switch
                                ...
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Impuesto incluido en registro de productos', form.include_igv, 'include_igv', 'receiptIcon')"
                              ></el-switch>
                              <small
                                class="text-danger"
                          ...
                          <div class="col-md-2 mt-4">
                            ...
                            <div class="form-group">
                              <el-switch
                                ...
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Recrear Documento', form.recreat_document, 'recreat_document', 'syncAltIcon')"
                              ></el-switch>
                            </div>
                          </div>
                          ...
                          <div class="col-md-2 mt-4">
                            ...
                            <div class="form-group">
                              <el-switch
                                ...
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Eliminar Documento', form.delete_document, 'delete_document', 'trashAltIcon')"
                              ></el-switch>
                            </div>
                          </div>
                          ...
                          <div class="col-md-2 mt-4">
                            <div class="form-group">
                              ...
                              <el-switch
                                v-model="form.detraction"
                                active-text="SI"
                                inactive-text="NO"
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Detracciones', form.detraction, 'detraction', 'percentageIcon')"
                              ></el-switch>
                            </div>
                          </div>
                          ...
                          <div class="col-md-2 mt-4">
                            ...
                            <div class="form-group">
                              <el-select
                                v-model="form.detraction_type_id"
                                @change="submit('Detracción por defecto', form.detraction_type_id, 'detraction_type_id', 'piggyBankIcon')"
                                filterable
                                clearable
                              >
                                <el-option
                                  ...
                                  :key="option.id"
                                  :value="option.id"
                                  :label="`${option.percentage}% ${option.description}`"
                                ></el-option>
                              </el-select>
                            </div>
                          </div>
                          ...
                          <div class="col-md-2 mt-4">
                            <div class="form-group">
                              ...
                              <el-switch
                                v-model="form.discount_with_base_variant"
                                active-text="SI"
                                inactive-text="NO"
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Descuentos variante', form.discount_with_base_variant, 'discount_with_base_variant', 'percentageIcon')"
                              ></el-switch>
                            </div>
                          </div>
                        </div>
                  ...
                  <el-tab-pane name="visual">
                    <template #label>
                      <div class="tab-label">
                        ...
                        <span class="tab-text">Configuración General</span>
                      </div>
                    </template>
                    <template>
                      <div class="container mt-8">
                        <div class="form-group">
                          <label class="control-label">Busqueda de Contenido</label>
                          <el-input
                            v-model="searchQueryVisual"
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Habilita Usuarios (Admin)', form.users_views, 'users_views', 'usersCogIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.internal_voided"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Permitir anulado interno', form.internal_voided, 'internal_voided', 'banIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.alias_client"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Mostar Alias Cliente', form.alias_client, 'alias_client', 'banIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.sale_note_credit_cash"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Otorgar Créditos NV (s/cuotas)', form.sale_note_credit_cash, 'sale_note_credit_cash', 'handHoldingUsdIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              <div class="col-md-2 mt-4">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.order_desc_items"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Multiples Cajas', form.multiple_boxes, 'multiple_boxes', 'cashRegisterIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.user_series_independientes_caja"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Usuarios con series independientes', form.user_series_independientes_caja, 'user_series_independientes_caja', 'userCogIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Acciones en Caja', form.caja_actions, 'caja_actions', 'tasksIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Venta Rápida', form.sales_quick, 'sales_quick', 'boltIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Vendedores en Caja', form.seller_caja, 'seller_caja', 'userTieIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Mostrar Gastos e Ingresos', form.show_expenses_incomes_caja, 'show_expenses_incomes_caja', 'eyeIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Editar Precio de Venta', form.edit_price_sales, 'edit_price_sales', 'editIcon')"
                                  ></el-switch>
                                  <small
                                    class="text-danger"
                                    v-if="errors.edit_price_sales"
                                    v-text="errors.edit_price_sales[0]"
                                  ></small>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Editar Cantidad', form.quantity_cash, 'quantity_cash', 'calculatorIcon')"
                                  ></el-switch>
                                  <small
                                    class="text-danger"
                                ...
                                <div class="form-group">
                                  <label class="control-label w-100">
                                    ...
                                    <el-tooltip
                                      class="item"
                                      effect="dark"
                                      content="Editar Subtotal de venta en CAJA"
                                      placement="top-start"
                                    >
                                      <i class="fa fa-info-circle"></i>
                                    </el-tooltip>
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Editar Subtotal', form.edit_subtotal_box, 'edit_subtotal_box', 'pencilAltIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.all_items_pos"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Todos los productos - caja', form.all_items_pos, 'all_items_pos', 'listIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Editar nombre de productos', form.edit_name_product, 'edit_name_product', 'editIcon')"
                                  ></el-switch>
                                  <small
                                    class="text-danger"
                                    v-if="errors.edit_name_product"
                                    v-text="errors.edit_name_product[0]"
                                  ></small>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.list_or_card"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Mostrar lista o tarjeta de productos', form.list_or_card, 'list_or_card', 'thListIcon')"
                                  ></el-switch>
                                  <small
                                    class="text-danger"
                                    v-if="errors.list_or_card"
                                    v-text="errors.list_or_card[0]"
                                  ></small>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.lotgroup_list_or_card"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Lote en lista de productos', form.lotgroup_list_or_card, 'lotgroup_list_or_card', 'boxesIcon')"
                                  ></el-switch>
                                  <small
                                    class="text-danger"
                                    v-if="errors.lotgroup_list_or_card"
                                    v-text="errors.lotgroup_list_or_card[0]"
                                  ></small>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.listprice_list_or_card"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Política de precio en lista de productos', form.listprice_list_or_card, 'listprice_list_or_card', 'tagIcon')"
                                  ></el-switch>
                                  <small
                                    class="text-danger"
                                    v-if="errors.listprice_list_or_card"
                                    v-text="errors.listprice_list_or_card[0]"
                                  ></small>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Barcode en Caja', form.barcode, 'barcode', 'barcodeIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.only_cash_by_establishment"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Una caja por establecimiento', form.only_cash_by_establishment, 'only_cash_by_establishment', 'storeAltIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-select
                                    v-model="user_excluded_id"
                                    placeholder="Seleccione"
                                    filterable
                                    clearable
                                    style="width: 100%"
                                    @change="addUserExcluded"
                                  >
                                    <el-option
                                      v-for="user in users"
                                      :key="user.id"
                                  ...
                                  <el-tag
                                    ...
                                    :key="user.id"
                                    closable
                                    @close="removeUserExcluded(user.id)"
                                  >{{ user.name }}</el-tag>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.report_cash_methods"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Detalle métodos - reporte', form.report_cash_methods, 'report_cash_methods', 'fileAltIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              <!-- Ver venta diaria -->
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Ver venta diaria', form.view_daily_cash, 'view_daily_cash', 'chartLineIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.view_daily_cash_pin"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Ver venta diaria con pin', form.view_daily_cash_pin, 'view_daily_cash_pin', 'lockIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.compra_venta"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Activar historial compra venta', form.compra_venta, 'view_daily_cash_pin', 'lockIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.editar_precio_politica"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Editar Politica de Precios En Caja', form.editar_precio_politica, 'view_daily_cash_pin', 'lockIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              <div class="col-md-2 mt-4">
                              ...
                              <div class="col-md-2 mt-4"> 
                                <div class="form-group">  
                                  ...
                                  <el-switch
                                    @change="submit('Seleccionar política de precio al usar código de barras', form.unit_type_select_barcode, 'unit_type_select_barcode', 'lockIcon')"
                                    v-model="form.unit_type_select_barcode"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                              ...
                              <div class="col-md-2 mt-4"> 
                                <div class="form-group">  
                                  ...
                                  <el-switch
                                    @change="submit('Vender en otras monedas', form.other_currency_pos, 'other_currency_pos', 'lockIcon')"
                                    v-model="form.other_currency_pos"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Enviar whatsapp por pagos YAPE/PLIN', form.send_whatsapp_digital_pay, 'send_whatsapp_digital_pay', 'mobileAltIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.send_whatsapp_daily_cash"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Enviar whatsapp al ver venta diaria', form.send_whatsapp_daily_cash, 'send_whatsapp_daily_cash', 'paperPlaneIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Enviar XML por whatsapp', form.xml_whatsapp, 'xml_whatsapp', 'fileExportIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <small>
                                    <el-tag
                                      ...
                                      :key="idx"
                                      closable
                                      @close="removeNumberWhatsapp(idx)"
                                    >{{ number.number }}</el-tag>
                                  </small>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Whatsapp en Reimpresión de Documentos', form.reprint_whatsapp, 'reprint_whatsapp', 'mobileAltIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Crear Productos en caja', form.product_cash, 'product_cash', 'boxIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Editar Producto en caja', form.edit_product_pos, 'edit_product_pos', 'pencilRulerIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Mostrar descripción Completa del producto en Caja', form.trunc_txt, 'trunc_txt', 'alignLeftIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Mostrar Stock de Productos', form.show_stock_cash, 'show_stock_cash', 'eyeIcon'); stock_control();"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Mostrar productos por vencer en caja', form.items_due_caja, 'items_due_caja', 'hourglassHalfIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.show_second_name_external_code"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Mostrar Nombre secundario - Código externo', form.show_second_name_external_code, 'show_second_name_external_code', 'tagsIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.receive_merchandise"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Recibir Productos (traslado)', form.receive_merchandise, 'receive_merchandise', 'dollyIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Bloquear stock inicial', form.init_stock, 'init_stock', 'lockIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Permitir Ajuste de Stock', form.item_adjustment, 'item_adjustment', 'toolsIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Vender con stock', form.sales_stock, 'sales_stock', 'boxesIcon'); stock_control();"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.observation_translate"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Observación al hacer ajuste de stock', form.observation_translate, 'observation_translate', 'editIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Crear Productos Compuestos en caja', form.item_set_caja, 'item_set_caja', 'cubesIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Editar Productos Compuestos en caja', form.item_set_quantity_pos, 'item_set_quantity_pos', 'boxOpenIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Mostrar Imagenes de Productos en Cotización', form.image_quotation, 'image_quotation', 'imageIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Ordenar Productos por Descripción en Caja', form.ord_dscp, 'ord_dscp', 'sortAlphaDownIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Buscar por series en Caja', form.search_series_pos, 'search_series_pos', 'searchIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.show_stock_establishment_box"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Mostrar Stock Almacénes', form.show_stock_establishment_box, 'show_stock_establishment_box', 'warehouseIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Traslados directos', form.translate_direct, 'translate_direct', 'exchangeAltIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Visualizar administrador - usuarios', form.users_views, 'users_views', 'userCogIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Tratamiento comercial Categoría', form.commercial_treatments, 'commercial_treatments', 'handshakeIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Tratamiento comercial Producto', form.commercial_treatment_items, 'commercial_treatment_items', 'handshakeIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Servicio en todos los establecimientos', form.create_service_all_warehouse, 'create_service_all_warehouse', 'warehouseIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.automatic_principal_cash"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Caja principal automática', form.automatic_principal_cash, 'automatic_principal_cash', 'cashRegisterIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Reporte caja - para llevar', form.carry_cash_report, 'carry_cash_report', 'fileAltIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.show_coins_to_receive"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Billetes/Monedas a recibir caja', form.show_coins_to_receive, 'show_coins_to_receive', 'coinsIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.search_by_second_name"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Culqui', form.culqi, '/images/CulquiIcon.png', 'walletIcon', true)"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Yape', form.yape, '/images/yape-logo-3E473EE7E5-seeklogo.com.png', 'walletIcon', true)"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Izipay', form.izipay, '/images/botonIzipay.png', 'walletIcon', true)"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.openpay"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Openpay', form.openpay, '/images/botonOpenpay.png', 'walletIcon', true)"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Nubiz', form.nubiz, '/images/botonNiubiz.png', 'walletIcon', true)"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Plin', form.plin, '/images/plin-logo-0C4106153C-seeklogo.com.png', 'walletIcon', true)"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Rappi', form.rappi, '/images/botonRappi.png', 'walletIcon', true)"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    v-model="form.pedidosya"
                                    active-text="Si"
                                    inactive-text="No"
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Pedidos-Ya', form.pedidosya, '/images/botonPedidosYa.png', 'walletIcon', true)"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Didi-Foods', form.didi, '/images/botonDidi.png', 'walletIcon', true)"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Requerir número de operación (YAPE/PLIN/TARJETAS)', form.require_code, 'require_code', 'receiptIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                              ...
                              <div class="col-md-2 mt-4">
                                <div class="form-group">
                                  ...
                                  <el-switch
                                    ...
                                    :active-color="'#28a745'"
                                    :inactive-color="'#6c757d'"
                                    @change="submit('Cargo por pago con tarjeta', form.credit_mode, 'credit_mode', 'creditCardIcon')"
                                  ></el-switch>
                                </div>
                              </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                          <label class="control-label w-100">
                            ...
                            <el-tooltip
                              class="item"
                              effect="dark"
                              content="Permite configurar si las impresoras que se usan para la impresión directa en A5/A4 son nuevas o antiguas"
                              placement="top-start"
                            >
                              <i class="fa fa-info-circle"></i>
                            </el-tooltip>
                          ...
                          <el-switch
                            ...
                            :active-color="'#28a745'"
                            :inactive-color="'#6c757d'"
                            @change="submit('Impresoras Nuevas', form.new_old_printer, 'new_old_printer', 'printIcon')"
                          ></el-switch>
                        </div>
                      </div>
                      <!-- alias -->
                        ...
                        <div class="form-group">
                          <label class="control-label w-100">
                            ...
                            <el-tooltip
                              class="item"
                              effect="dark"
                              content="Agrega el alias del cliente en los documentos pdf"
                              placement="top-start"
                            >
                              <i class="fa fa-info-circle"></i>
                            </el-tooltip>
                          ...
                          <el-switch
                            v-model="form.alias_pdf"
                            active-text="Si"
                            inactive-text="No"
                            :active-color="'#28a745'"
                            :inactive-color="'#6c757d'"
                            @change="submit('Alias en pdf', form.alias_pdf, 'alias_pdf', 'printIcon')"
                          ></el-switch>
                        </div>
                      </div>
                      ...
                      <div class="col-md-2 mt-4">
                        <div class="form-group">
                          ...
                          <el-switch
                            ...
                            :active-color="'#28a745'"
                            :inactive-color="'#6c757d'"
                            @change="submit('Orientación A5', form.a5_orientation, 'a5_orientation', 'arrowsAltIcon')"
                          ></el-switch>
                        </div>
                      </div>
                      ...
                      <div class="col-md-2 mt-4">
                        <div class="form-group">
                          ...
                          <el-switch
                            v-model="form.show_logo_in_documents"
                            active-text="Si"
                            inactive-text="No"
                            :active-color="'#28a745'"
                            :inactive-color="'#6c757d'"
                            @change="submit('Mostrar logo en documentos', form.show_logo_in_documents, 'show_logo_in_documents', 'imageIcon')"
                          ></el-switch>
                        </div>
                      </div>
                        ...
                        <div class="form-group">
                          <label class="control-label w-100">
                            ...
                            <el-tooltip
                              class="item"
                              effect="dark"
                              content="Mostrar e Imprimir Código Interno  en TICKET"
                              placement="top-start"
                            >
                              <i class="fa fa-info-circle"></i>
                            </el-tooltip>
                          ...
                          <el-switch
                            v-model="form.show_internal_code_ticket"
                            active-text="Si"
                            inactive-text="No"
                            :active-color="'#28a745'"
                            :inactive-color="'#6c757d'"
                            @change="submit('Mostrar código interno en productos (ticket)', form.show_internal_code_ticket, 'show_internal_code_ticket', 'barcodeIcon')"
                          ></el-switch>
                        </div>
                      </div>
                      ...
                      <div class="col-md-2 mt-4">
                        <div class="form-group">
                          ...
                          <el-switch
                            v-model="form.correo_red_salud_ticket"
                            active-text="Si"
                            inactive-text="No"
                            :active-color="'#28a745'"
                            :inactive-color="'#6c757d'"
                            @change="submit('Imprimir correo en ticket', form.correo_red_salud_ticket, 'correo_red_salud_ticket', 'envelopeIcon')"
                          ></el-switch>
                        </div>
                      </div>
                      ...
                      <div class="col-md-2 mt-4">
                        <div class="form-group">
                          ...
                          <el-switch
                            v-model="form.print_direct_just_different_areas"
                            active-text="Si"
                            inactive-text="No"
                            :active-color="'#28a745'"
                            :inactive-color="'#6c757d'"
                            @change="submit('Impresión en áreas diferentes', form.print_direct_just_different_areas, 'print_direct_just_different_areas', 'printIcon')"
                          ></el-switch>
                        </div>
                      </div>
                      ...
                      <div class="col-md-2 mt-4">
                        <div class="form-group">
                          ...
                          <el-switch
                            ...
                            :active-color="'#28a745'"
                            :inactive-color="'#6c757d'"
                            @change="submit('Impresión Directa', form.print_direct, 'print_direct', 'printIcon')"
                          ></el-switch>
                        </div>
                      </div>
                      ...
                      <div class="col-md-2 mt-4">
                        <div class="form-group">
                          ...
                          <el-switch
                            ...
                            :active-color="'#28a745'"
                            :inactive-color="'#6c757d'"
                            @change="submit('Imprimir referencia en ticket', form.reference_ticket, 'reference_ticket', 'receiptIcon')"
                          ></el-switch>
                        </div>
                      </div>
                      ...
                      <div class="col-md-2 mt-4">
                        <div class="form-group">
                          ...
                          <el-switch
                            v-model="form.print_incomes_expenses"
                            active-text="Si"
                            inactive-text="No"
                            :active-color="'#28a745'"
                            :inactive-color="'#6c757d'"
                            @change="submit('Imprimir gastos/ingresos', form.print_incomes_expenses, 'print_incomes_expenses', 'balanceScaleIcon')"
                          ></el-switch>
                        </div>
                      </div>
                      ...
                      <div class="col-md-2 mt-4">
                        <div class="form-group">
                          ...
                          <el-switch
                            v-model="form.print_document_cash"
                            active-text="Si"
                            inactive-text="No"
                            :active-color="'#28a745'"
                            :inactive-color="'#6c757d'"
                            @change="submit('Reimpresión de documentos - Caja', form.print_document_cash, 'print_document_cash', 'printIcon')"
                          ></el-switch>
                        </div>
                      </div>
                      ...
                      <div class="col-md-2 mt-4">
                        <div class="form-group">
                          ...
                          <el-switch
                            v-model="form.seller_quotation_cash"
                            active-text="Si"
                            inactive-text="No"
                            :active-color="'#28a745'"
                            :inactive-color="'#6c757d'"
                            @change="submit('Impresión directa vendedor Cotización - Caja', form.seller_quotation_cash, 'seller_quotation_cash', 'printIcon')"
                          ></el-switch>
                        </div>
                      </div>
                      ...
                      <div class="col-md-2 mt-4">
                        <div class="form-group">
                          ...
                          <el-switch
                            ...
                            :active-color="'#28a745'"
                            :inactive-color="'#6c757d'"
                            @change="submit('Guardar decisión de Impresión', form.save_pos_printing, 'save_pos_printing', 'saveIcon')"
                          ></el-switch>
                        </div>
                      </div>
                      ...
                      <div class="col-md-2 mt-4">
                        <div class="form-group">
                          ...
                          <el-switch
                            v-model="form.show_unit_types_ticket"
                            active-text="Si"
                            inactive-text="No"
                            :active-color="'#28a745'"
                            :inactive-color="'#6c757d'"
                            @change="submit('Mostrar política precios ticket', form.show_unit_types_ticket, 'show_unit_types_ticket', 'ticketAltIcon')"
                          ></el-switch>
                        </div>
                      </div>
                      <div class="col-md-2 mt-4">
                        <div class="form-group">
                          <label class="control-label w-100">
                            <i class="fas fa-ticket-alt tab-icon"></i>
                            Ocutar Nombre Comercial En Los Documentos
                          </label>
                          <el-switch
                            ...
                            :active-color="'#28a745'"
                            :inactive-color="'#6c757d'"
                            @change="submit('Ocultar Nombre Comercial En Los Documentos', form.comercial_mane, 'comercial_mane', 'ticketAltIcon')"
                          ></el-switch>
                        </div>
                      </div>
                      <div class="col-md-2 mt-4">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-2 mt-4">
                          <div class="form-group">
                            ...
                            <el-switch
                              v-model="form.unit_type_pdf_quotation"
                              active-text="Si"
                              inactive-text="No"
                              :active-color="'#28a745'"
                              :inactive-color="'#6c757d'"
                              @change="submit('Imprimir política de precio - Cotización', form.unit_type_pdf_quotation, 'unit_type_pdf_quotation', 'tagsIcon')"
                            ></el-switch>
                          </div>
                        </div>
                        ...
                        <div class="col-md-2 mt-4">
                          <div class="form-group">
                            ...
                            <el-switch
                              v-model="form.numero_accion_independiente_admin"
                              active-text="Si"
                              inactive-text="No"
                              :active-color="'#28a745'"
                              :inactive-color="'#6c757d'"
                              @change="submit('Imprimir número de whatsapp en ticket', form.numero_accion_independiente_admin, 'numero_accion_independiente_admin', 'phoneIcon')"
                            ></el-switch>
                          </div>
                        </div>
                        ...
                        <div class="col-md-2 mt-4">
                          <div class="form-group">
                            ...
                            <el-switch
                              v-model="form.configurable_impresion_ticket_categoria_caja"
                              active-text="Si"
                              inactive-text="No"
                              :active-color="'#28a745'"
                              :inactive-color="'#6c757d'"
                              @change="submit('Imprimir productos vendidos en reporte ticket', form.configurable_impresion_ticket_categoria_caja, 'configurable_impresion_ticket_categoria_caja', 'listIcon')"
                            ></el-switch>
                          </div>
                        </div>
                        <!-- Texto pie de página -->
                          ...
                          <div class="form-group">
                            <label for="text-3">
                              ...
                              <el-tooltip
                                class="item"
                                effect="dark"
                                content="Imprimir Texto que va en la parte inferior de los documentos"
                                placement="top-start"
                              >
                                <i class="fa fa-info-circle"></i>
                              </el-tooltip>
                        ...
                        <div class="col-md-2 mt-4">
                          <div class="form-group">
                            ...
                            <el-switch
                              ...
                              :active-color="'#28a745'"
                              :inactive-color="'#6c757d'"
                              @change="submit('Manejo de caja principal', form.principal_cash, 'principal_cash', 'cashRegisterIcon')"
                            ></el-switch>
                          </div>
                        </div>
                        ...
                        <div class="col-md-2 mt-4">
                          <div class="form-group">
                            ...
                            <el-switch
                              ...
                              :active-color="'#28a745'"
                              :inactive-color="'#6c757d'"
                              @change="submit('Caja principal automatica', form.automatic_principal_cash, 'automatic_principal_cash', 'cogsIcon')"
                            ></el-switch>
                          </div>
                        </div>
                        ...
                        <div class="col-md-2 mt-4">
                          <div class="form-group">
                            ...
                            <el-select
                              ...
                              @change="submit('Turno inicio', form.turn_principal, 'turn_principal', 'clockIcon')"
                              clearable
                            >
                              <el-option
                                v-for="turn in turns"
                        ...
                        <div class="col-md-2 mt-4">
                          <div class="form-group">
                            ...
                            <el-select
                              ...
                              @change="submit('Turno final', form.turn_end, 'turn_end', 'clockIcon')"
                              clearable
                            >
                              <el-option
                                v-for="turn in turns"
                        ...
                        <div class="col-md-2 mt-4">
                          <div class="form-group">
                            ...
                            <el-switch
                              ...
                              :active-color="'#28a745'"
                              :inactive-color="'#6c757d'"
                              @change="submit('A cuenta', form.credit_list, 'credit_list', 'moneyCheckAltIcon')"
                            ></el-switch>
                          </div>
                        </div>
                      </div>
                            ...
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  ...
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Bancos', form.bancos, 'bancos', 'universityIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  ...
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Cuentas Bancarias', form.cuentas_bancarias, 'cuentas_bancarias', 'creditCardIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  ...
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Vendedores', form.vendedores, 'vendedores', 'usersIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  v-model="form.registro_actividad"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Registro de Actividad', form.registro_actividad, 'registro_actividad', 'tasksIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  ...
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Categorias', form.categorias, 'categorias', 'listAltIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  ...
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Marca', form.marca, 'marca', 'trademarkIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  ...
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Clientes', form.clientes, 'clientes', 'userIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  v-model="form.provedores"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Proveedores', form.provedores, 'provedores', 'truckIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  ...
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Atributos', form.atributos, 'atributos', 'cogsIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  ...
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Unidad de Medida', form.unidad_medida, 'unidad_medida', 'balanceScaleIcon')"
                                ></el-switch>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  v-model="form.lista_compras"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Compras', form.lista_compras, 'lista_compras', 'shoppingCartIcon')"
                                ></el-switch>
                              </div>
                            </div>
                          </div>
                              ...
                              <div class="form-group">
                                <label class="control-label w-100">
                                  ...
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                                    content="Recibir Productos por TRASLADO DE MERCADERIA en CAJA activa 2 modulos en adminsitrador inventario"
                                    placement="top-start"
                                  >
                                    <i class="fa fa-info-circle"></i>
                                  </el-tooltip>
                                ...
                                <el-switch
                                  ...
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Recibir Productos (traslado)', form.receive_merchandise, 'receive_merchandise', 'boxIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                <label class="control-label w-100">
                                  ...
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                                    content="Modulo de productos aquí se encuentra todo los productos registrados y también se puede crear"
                                    placement="top-start"
                                  >
                                    <i class="fa fa-info-circle"></i>
                                  </el-tooltip>
                                ...
                                <el-switch
                                  v-model="form.listado_productos"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Productos', form.listado_productos, 'listado_productos', 'boxesIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                <label class="control-label w-100">
                                  ...
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                                    content="Modulo de guias de remisión aquí puedes generar una guia de remisión por administrador"
                                    placement="top-start"
                                  >
                                    <i class="fa fa-info-circle"></i>
                                  </el-tooltip>
                                ...
                                <el-switch
                                  v-model="form.guias_remision"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Guias de Remisión', form.guias_remision, 'guias_remision', 'truckLoadingIcon')"
                                ></el-switch>
                              </div>
                            </div>
                              ...
                              <div class="form-group">
                                <label class="control-label w-100">
                                  ...
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                                    content="Modulo de promociones y Ofertas para crear platos con receta"
                                    placement="top-start"
                                  >
                                    <i class="fa fa-info-circle"></i>
                                  </el-tooltip>
                                ...
                                <el-switch
                                  v-model="form.promocion_oferta"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Promociones y Ofertas', form.promocion_oferta, 'promocion_oferta', 'tagsIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                <label class="control-label w-100">
                                  ...
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                                    content="Modulo de ingreso y salida de productos aquí podemos sacar o ingresar productos"
                                    placement="top-start"
                                  >
                                    <i class="fa fa-info-circle"></i>
                                  </el-tooltip>
                                ...
                                <el-switch
                                  v-model="form.ingreso_salida_productos"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Ingreso y Salida de Productos', form.ingreso_salida_productos, 'ingreso_salida_productos', 'exchangeAltIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                <label class="control-label w-100">
                                  ...
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                                    content="Modulo de transaciones e inventario aquí podemos crear o inhabilitar los tipos de transacciones que nos para el ingreso o salida de productos"
                                    placement="top-start"
                                  >
                                    <i class="fa fa-info-circle"></i>
                                  </el-tooltip>
                                ...
                                <el-switch
                                  v-model="form.tipo_transacciones_inventario"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Tipo de Transacciones Inventario', form.tipo_transacciones_inventario, 'tipo_transacciones_inventario', 'cogsIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                <label class="control-label w-100">
                                  ...
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                                    content="Aquí podemos imprimir nuestras etiquetas de nuestros productos"
                                    placement="top-start"
                                  >
                                    <i class="fa fa-info-circle"></i>
                                  </el-tooltip>
                                ...
                                <el-switch
                                  v-model="form.ver_etiqueta_logistica"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Etiquetas', form.ver_etiqueta_logistica, 'ver_etiqueta_logistica', 'tagsIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  v-model="form.pricing_policy_venta"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Listado De Politica De Precios', form.pricing_policy_venta, 'Listado De Politica De Precios', 'tagsIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              ...
                              <div class="form-group">
                                <label class="control-label w-100">
                                  ...
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                                    content="Aqui podemos emitir boletas y facturas de administrador"
                                    placement="top-start"
                                  >
                                    <i class="fa fa-info-circle"></i>
                                  </el-tooltip>
                                ...
                                <el-switch
                                  v-model="form.nuevo_comprobante_electronico"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Nuevo Comprobante', form.nuevo_comprobante_electronico, 'nuevo_comprobante_electronico', 'fileInvoiceIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                <label class="control-label w-100">
                                  ...
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                                    content="Aquí podemos ver todo los comprobantes emitidos boletas y facturas"
                                    placement="top-start"
                                  >
                                    <i class="fa fa-info-circle"></i>
                                  </el-tooltip>
                                ...
                                <el-switch
                                  v-model="form.listado_boleta_factura_nuevo"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Listado de Comprobantes', form.listado_boleta_factura_nuevo, 'listado_boleta_factura_nuevo', 'listAltIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                <label class="control-label w-100">
                                  ...
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                                    content="Aquí podemos ver los documentos que no se enviaron a SUNAT o vencieron el plazo de envio"
                                    placement="top-start"
                                  >
                                    <i class="fa fa-info-circle"></i>
                                  </el-tooltip>
                                ...
                                <el-switch
                                  v-model="form.no_enviados"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('No Enviados', form.no_enviados, 'no_enviados', 'timesCircleIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                <label class="control-label w-100">
                                  ...
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                                    content="Aquí podemos ver todas las notas de venta generadas y también crear nuevas notas de venta"
                                    placement="top-start"
                                  >
                                    <i class="fa fa-info-circle"></i>
                                  </el-tooltip>
                                ...
                                <el-switch
                                  v-model="form.nota_venta"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Nota de Venta', form.nota_venta, 'nota_venta', 'receiptIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                <label class="control-label w-100">
                                  ...
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                                    content="Aquí podemos generar notas de crédito con los documentos que por error se enviaron a SUNAT y se pedirá la devolución"
                                    placement="top-start"
                                  >
                                    <i class="fa fa-info-circle"></i>
                                  </el-tooltip>
                                ...
                                <el-switch
                                  v-model="form.nota_credito"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Nota de Crédito', form.nota_credito, 'nota_credito', 'creditCardIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                <label class="control-label w-100">
                                  ...
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                                    content="Aquí podemos ver las cotizaciones y crear nuevas cotizaciones en administrador"
                                    placement="top-start"
                                  >
                                    <i class="fa fa-info-circle"></i>
                                  </el-tooltip>
                                ...
                                <el-switch
                                  v-model="form.cotizaciones"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Cotizaciones', form.cotizaciones, 'cotizaciones', 'fileAltIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                <label class="control-label w-100">
                                  ...
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                                    content="Aquí podemos ver los resumenes generados de las boletas y también generar nuevos resumenes por fecha"
                                    placement="top-start"
                                  >
                                    <i class="fa fa-info-circle"></i>
                                  </el-tooltip>
                                ...
                                <el-switch
                                  v-model="form.resumenes"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Resumenes', form.resumenes, 'resumenes', 'bookIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                <label class="control-label w-100">
                                  ...
                                  <el-tooltip
                                    class="item"
                                    effect="dark"
                                    content="Aquí podemos ver todos los documentos anulados"
                                    placement="top-start"
                                  >
                                    <i class="fa fa-info-circle"></i>
                                  </el-tooltip>
                                ...
                                <el-switch
                                  v-model="form.anulaciones"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Anulaciones', form.anulaciones, 'anulaciones', 'banIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                          ...
                          <div class="row">
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  v-model="form.reporte_caja"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Reporte de Caja', form.reporte_caja, 'reporte_caja', 'patientFileIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  v-model="form.reporte_cierre_caja"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Reporte de Cierre De Caja', form.reporte_cierre_caja, 'reporte_cierre_caja', 'attachmentIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  v-model="form.reporte_globalizado"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Reporte Globalizado', form.reporte_globalizado, 'reporte_globalizado', 'globeIcon')"
                                ></el-switch>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  v-model="form.productos_vendidos"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Productos Vendidos Boletas y Facturas', form.productos_vendidos, 'productos_vendidos Boletas y Facturas', 'listIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  v-model="form.reporte_metodos_pago"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Reporte de métodos de pago', form.reporte_metodos_pago, 'reporte_metodos_pago', 'boxIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  v-model="form.reporte_ganancias"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Reporte de Ganancias', form.reporte_ganancias, 'reporte_ganancias', 'moneyBagIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  v-model="form.reporte_productos"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Reporte de Productos', form.reporte_productos, 'reporte_productos', 'windowRestoreIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  v-model="form.stock_valorizado"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Stock Valorizado', form.stock_valorizado, 'stock_valorizado', 'dollarIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  ...
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Stock Minimo', form.stock_minimo, 'stock_minimo', 'boxesIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  v-model="form.stock_producto"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Stock De Producto', form.stock_producto, 'stock_producto', 'boxIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  ...
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Kardex', form.kardex, 'kardex', 'chartBarGraphIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  v-model="form.reporte_series_vendidas"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Reporte De Series Vendidas', form.reporte_series_vendidas, 'reporte_series_vendidas', 'fingerprintIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  ...
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Ganancias Hogar / Efectivo', form.house, 'Ganacias Hogar / Efectivo', 'fingerprintIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  ...
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Reporte Diario - Credito', form.diary, 'Reporte Diario - Credito', 'fingerprintIcon')"
                                ></el-switch>
                              </div>
                            </div>
                            <div class="col-md-2 mt-4">
                              <div class="form-group">
                                ...
                                <el-switch
                                  v-model="form.sale_note_venta"
                                  active-text="Si"
                                  inactive-text="No"
                                  :active-color="'#28a745'"
                                  :inactive-color="'#6c757d'"
                                  @change="submit('Reporte Productos Vendidos Nota de Venta', form.sale_note_venta, 'Reporte Productos Vendidos Nota de Venta', 'fingerprintIcon')"
                                ></el-switch>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-md-2 mt-4">
                            <div class="form-group">
                              ...
                              <el-switch
                                ...
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Uso de Comanda Física', form.commands_fisico, 'commands_fisico', 'receiptIcon')"
                              ></el-switch>
                              <small
                                class="text-danger"
                                v-if="errors.commands_fisico"
                                v-text="errors.commands_fisico[0]"
                              ></small>
                            </div>
                          </div>
                          <div class="col-md-2 mt-4">
                            <div class="form-group">
                              ...
                              <el-switch
                                ...
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Imprimir Comanda en Caja', form.print_commands, 'print_commands', 'printIcon')"
                              ></el-switch>
                            </div>
                          </div>
                          <div class="col-md-2 mt-4">
                            <div class="form-group">
                              ...
                              <el-switch
                                v-model="form.show_variation_dcto"
                                active-text="Si"
                                inactive-text="No"
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Emitir Documento Variación', form.show_variation_dcto, 'show_variation_dcto', 'fileAltIcon')"
                              ></el-switch>
                            </div>
                          </div>
                          <div class="col-md-2 mt-4">
                            <div class="form-group">
                              ...
                              <el-select
                                :disabled="!form.show_variation_dcto"
                                ref="producto"
                                v-model="form.item_variation_id"
                                @change="changeItem"
                                filterable
                                remote
                                placeholder="Buscar..."
                          ...
                          <div class="col-md-2 mt-4">
                            <div class="form-group">
                              ...
                              <el-switch
                                ...
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Pedir PIN al Eliminar Orden', form.pin_orden_delete, 'pin_orden_delete', 'keyIcon')"
                              ></el-switch>
                            </div>
                          </div>
                          <div class="col-md-2 mt-4">
                            <div class="form-group">
                              ...
                              <el-switch
                                v-model="form.send_whatsapp_activity"
                                active-text="Si"
                                inactive-text="No"
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Enviar Whatsapp al Eliminar Orden', form.send_whatsapp_activity, 'send_whatsapp_activity', 'whatsappIcon')"
                              ></el-switch>
                            </div>
                          </div>
                          <div class="col-md-2 mt-4">
                            <div class="form-group">
                              ...
                              <el-switch
                                ...
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Categorías Arrastrables Caja', form.pos_drag_category, 'pos_drag_category', 'listAltIcon')"
                              ></el-switch>
                            </div>
                          </div>
                          ...
                          <div class="col-md-2 mt-4">
                            <div class="form-group">
                              ...
                              <el-switch
                                ...
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Reporte Caja - para llevar', form.carry_cash_report, 'carry_cash_report', 'clipboardIcon')"
                              ></el-switch>
                            </div>
                          </div>
                          <div class="col-md-2 mt-4">
                          ...
                          <div class="col-md-2 mt-4">
                            <div class="form-group">
                              ...
                              <el-switch
                                v-model="form.pdf_preorder"
                                active-text="Si"
                                inactive-text="No"
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('PDF de precuenta', form.pdf_preorder, 'pdf_preorder', 'fileAltIcon')"
                              ></el-switch>
                            </div>
                          </div>
                          <div class="col-md-2 mt-4">
                            <div class="form-group">
                              ...
                              <el-switch
                                ...
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Mostrar Mesa Caja', form.show_caja_table, 'show_caja_table', 'tableIcon')"
                              ></el-switch>
                            </div>
                          </div>
                          <div class="col-md-2 mt-4">
                            <div class="form-group">
                              ...
                              <el-switch
                                ...
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Texto en precuenta', form.text_comanda, 'text_comanda', 'fileAltIcon')"
                              ></el-switch>
                            </div>
                          </div>
                          ...
                          <div class="col-md-2 mt-4">
                            <div class="form-group">
                              ...
                              <el-switch
                                ...
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Evitar Cerrar Caja con Ordenes Pendientes', form.ordens_cash, 'ordens_cash', 'lockIcon')"
                              ></el-switch>
                            </div>
                          </div>
                          ...
                          <div class="col-md-2 mt-4">
                            <div class="form-group">
                              ...
                              <el-switch
                                v-model="form.variation_hotel"
                                active-text="Si"
                                inactive-text="No"
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Emitir documento con variación', form.variation_hotel, 'variation_hotel', 'fileAltIcon')"
                              ></el-switch>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-md-2 mt-4">
                            <div class="form-group">
                              ...
                              <el-switch
                                ...
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Ingresar pin mozo (ordenes)', form.pin_switch, 'pin_switch', 'keyIcon')"
                              ></el-switch>
                            </div>
                          </div>
                          <div class="col-md-2 mt-4">
                            <div class="form-group">
                              ...
                              <el-switch
                                ...
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Caja-Mozo', form.box_orden, 'box_orden', 'userIcon')"
                              ></el-switch>
                            </div>
                          </div>
                          <div class="col-md-2 mt-4">
                            ...
                            >
                              ...
                              <el-select
                                ...
                                @change="submit('Búsqueda de Producto', form.search_type, 'search_type', 'searchIcon')"
                                filterable
                              >
                          ...
                          <div class="col-md-2 mt-4">
                            <div class="form-group">
                              ...
                              <el-switch
                                v-model="form.cambiar_mesa_mozo"
                                active-text="Si"
                                inactive-text="No"
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Acciones mozo', form.cambiar_mesa_mozo, 'Acciones mozo', 'userIcon')"
                              ></el-switch>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col-md-2 mt-4">
                            <div class="form-group">
                              ...
                              <el-switch
                                ...
                                :active-color="'#28a745'"
                                :inactive-color="'#6c757d'"
                                @change="submit('Imprimir en Zona Preparación', form.print_kitchen, 'print_kitchen', 'printIcon')"
                              ></el-switch>
                            </div>
                          </div>
                        </div>
                  ...
                  <el-tab-pane name="Hotel" v-if="form.hotels">
                    <template #label>
                      <div class="tab-label">
                        ...
                        <span class="tab-text">Hotel</span>
                      </div>
                    </template>
                    <div class="nested-tab-content">
                      <!-- Contenido de Hotel -->
                      <div class="row" v-if="form.hotels">
                        ...
                        <div class="col-md-3 mt-4">
                          <div class="form-group">
                            ...
                            <el-input-number
                              ...
                              @change="submit('Tiempo de alarma de alquileres por vencer', form.alarm_to_end, 'alarm_to_end', 'bellIcon')"
                            ></el-input-number>
                          </div>
                        </div>
                        ...
                        <div class="col-md-3 mt-4">
                          <div class="form-group">
                            ...
                            <el-input-number
                              ...
                              @change="submit('Tiempo de mantenimiento', form.time_manteniment, 'time_manteniment', 'toolsIcon')"
                            ></el-input-number>
                          </div>
                        </div>
                        ...
                        <div class="col-md-3 mt-4">
                          <div class="form-group">
                            ...
                            <el-input-number
                              ...
                              @change="submit('Límite de la garantía - frigobar', form.credit_line_hotel_limit, 'credit_line_hotel_limit', 'shieldAltIcon')"
                            ></el-input-number>
                          </div>
                        </div>
                        ...
                        <div class="col-md-3 mt-4">
                          <div class="form-group">
                            <label class="control-label w-100">
                              <i class="fas fa-percent tab-icon"></i>
 Descuento aplicado por Día
                              <el-tooltip
                                class="item"
                                effect="dark"
                                content="Descuento aplicado por día a cambio del servicio x habitación"
                                placement="top-start"
                              >
                                <i class="fa fa-info-circle"></i>
                              </el-tooltip>
                            ...
                            <el-input-number
                              ...
                              @change="submit('Descuento aplicado por día a cambio del servicio x habitación', form.discount_amount_instead_service, 'discount_amount_instead_service', 'percentIcon')"
                            ></el-input-number>
                          </div>
                        </div>
                        ...
                        <div class="col-md-3 mt-4">
                          <div class="form-group">
                            ...
                            <el-input-number
                              class="w-100"
                              v-model="form.minute_close_to_leave"
                              @change="submit('Tiempo para aviso de salida de habitación', form.minute_close_to_leave, 'minute_close_to_leave', 'signOutAltIcon')"
                            ></el-input-number>
                          </div>
                        </div>
                        ...
                        <div class="col-md-3 mt-4">
                          <div class="form-group">
                            ...
                            <el-input-number
                              ...
                              @change="submit('Tiempo para limpiar la habitación', form.time_to_clean, 'time_to_clean', 'broomIcon')"
                            ></el-input-number>
                          </div>
                        </div>
                        ...
                        <div class="col-md-3 mt-4">
                          <div class="form-group">
                            ...
                            <el-time-picker
                              ...
                              timezone="America/Lima"
                              v-model="form.time_to_enter"
                              @change="submit('Tiempo para el cálculo del inicio del día', form.time_to_enter, 'time_to_enter', 'clockIcon')"
                            ></el-time-picker>
                          </div>
                        </div>
                        ...
                        <div class="col-md-3 mt-4">
                          <div class="form-group">
                            ...
                            <el-time-picker
                              ...
                              timezone="America/Lima"
                              v-model="form.time_to_leave"
                              @change="submit('Tiempo para el cálculo del final del día', form.time_to_leave, 'time_to_leave', 'clockIcon')"
                            ></el-time-picker>
                          </div>
                        </div>
                        ...
                        <div class="col-md-3 mt-4">
                          <div class="form-group">
                            ...
                            <el-switch
                              ...
                              :active-color="'#28a745'"
                              :inactive-color="'#6c757d'"
                              @change="submit('Autorización de descuento', form.auth_discount, 'auth_discount', 'checkCircleIcon')"
                            ></el-switch>
                          </div>
                        </div>
                        ...
                        <div class="col-md-3 mt-4">
                          <div class="form-group">
                            ...
                            <el-switch
                              ...
                              :active-color="'#28a745'"
                              :inactive-color="'#6c757d'"
                              @change="submit('Control de mantenimiento', form.maintenance_workers, 'maintenance_workers', 'wrenchIcon')"
                            ></el-switch>
                          </div>
                        </div>
                      </div>
                  ...
                  <el-tab-pane name="Creditos" label="Créditos NV" v-if="form.credits">
                    <template #label>
                      <div class="tab-label">
                        <i class="fas fa-credit-card tab-icon"></i>
                        <span class="tab-text">Créditos NV</span>
                      </div>
                    </template>
                    <div class="nested-tab-content">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-2 mt-4">
                          <div class="form-group">
                            ...
                            <el-switch
                              v-model="form.sale_note_credit_penalty"
                              active-text="Si"
                              inactive-text="No"
                              :active-color="'#28a745'"
                              :inactive-color="'#6c757d'"
                              @change="submit('Penalidades', form.sale_note_credit_penalty, 'sale_note_credit_penalty', 'balanceScaleIcon')"
                            ></el-switch>
                          </div>
                        </div>
                        ...
                        <div class="col-md-2 mt-4">
                          <div class="form-group">
                            ...
                            <el-switch
                              v-model="form.sale_note_credit_confirm"
                              active-text="Si"
                              inactive-text="No"
                              :active-color="'#28a745'"
                              :inactive-color="'#6c757d'"
                              @change="submit('Confirmación de aprobación', form.sale_note_credit_confirm, 'sale_note_credit_confirm', 'checkCircleIcon')"
                            ></el-switch>
                          </div>
                        </div>
                        ...
                        <div class="col-md-2 mt-4">
                          <div class="form-group">
                            ...
                            <el-switch
                              v-model="form.sale_note_credit_low_pay"
                              active-text="Si"
                              inactive-text="No"
                              :active-color="'#28a745'"
                              :inactive-color="'#6c757d'"
                              @change="submit('Aceptar montos menores en las cuotas', form.sale_note_credit_low_pay, 'sale_note_credit_low_pay', 'moneyBillWaveIcon')"
                            ></el-switch>
                          </div>
                        </div>
                        ...
                        <div class="col-md-2 mt-4">
                          <div class="form-group">
                            ...
                            <el-switch
                              v-model="form.sale_note_credit_edit"
                              active-text="Si"
                              inactive-text="No"
                              :active-color="'#28a745'"
                              :inactive-color="'#6c757d'"
                              @change="submit('Editar Créditos', form.sale_note_credit_edit, 'sale_note_credit_edit', 'editIcon')"
                            ></el-switch>
                          </div>
                        </div>
                        ...
                        <div class="col-md-2 mt-4">
                          <div class="form-group">
                            ...
                            <el-switch
                              v-model="form.sale_note_credit_send_whatsapp"
                              active-text="Si"
                              inactive-text="No"
                              :active-color="'#28a745'"
                              :inactive-color="'#6c757d'"
                              @change="submit('Enviar whatsapp a clientes', form.sale_note_credit_send_whatsapp, 'sale_note_credit_send_whatsapp', 'whatsappIcon')"
                            ></el-switch>
                          </div>
                        </div>
                        ...
                        <div class="col-md-2 mt-4">
                          <div class="form-group">
                            ...
                            <el-switch
                              v-model="form.sale_note_credit_formats"
                              active-text="Si"
                              inactive-text="No"
                              :active-color="'#28a745'"
                              :inactive-color="'#6c757d'"
                              @change="submit('Mostrar formatos adicionales', form.sale_note_credit_formats, 'sale_note_credit_formats', 'fileAltIcon')"
                            ></el-switch>
                          </div>
                        </div>
                        ...
                        <div class="col-md-2 mt-4">
                          <div class="form-group">
                            ...
                            <el-input-number
                              ...
                              :step="0.5"
                              :max="100"
                              @change="submit('Porcentaje de crédito', form.rates, 'rates', 'percentIcon')"
                            ></el-input-number>
                          </div>
                        </div>
                        ...
                        <div class="col-md-2 mt-4">
                          <div class="form-group">
                            ...
                            <el-switch
                              ...
                              :active-color="'#28a745'"
                              :inactive-color="'#6c757d'"
                              @change="submit('Whatsapp personalizado', form.whatsapp_client, 'whatsapp_client', 'userEditIcon')"
                            ></el-switch>
                          </div>
                        </div>
                                <div class="col-md-2 mt-4">
                  ...
                  <el-tab-pane name="Colegio" label="Colegio" v-if="form.college">
                    <template #label>
                      <div class="tab-label">
                        ...
                        <span class="tab-text">Colegios</span>
                      </div>
                    </template>
                    <div class="nested-tab-content">Contenido de Colegios</div>
                  </el-tab-pane>
                  ...
                  <el-tab-pane name="Internet" label="Internet" v-if="form.internet">
                    <template #label>
                      <div class="tab-label">
                        ...
                        <span class="tab-text">Internet</span>
                      </div>
                    </template>
                    <div class="nested-tab-content">Contenido de Internet</div>
                  </el-tab-pane>
                  ...
                  <el-tab-pane label="Hospital &  Botica" v-if="form.health_network">
                    <template #label>
                      <div class="tab-label">
                        ...
                        <span class="tab-text">Boticas y Farmacias</span>
                      </div>
                    </template>
                    <div class="nested-tab-content">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-2 mt-4">
                          <div class="form-group">
                            ...
                            <el-select
                              v-model="form.turn_end"
                              @change="submit('Turno final', form.turn_end, 'turn_end', 'hourglassEndIcon')"
                              clearable
                            >
                              <el-option
                                v-for="turn in turns"
                        ...
                        <div class="col-md-2 mt-4">
                          <div class="form-group">
                            ...
                            <el-switch
                              ...
                              :active-color="'#28a745'"
                              :inactive-color="'#6c757d'"
                              @change="submit('Caja principal automática', form.automatic_principal_cash, 'automatic_principal_cash', 'cogsIcon')"
                            ></el-switch>
                          </div>
                        </div>
                      </div>
      ...
      >
        <div class="row mt-2">
          <div class="col-12">
            <el-input :maxlength="9" v-model="numberWhatsapp"></el-input>
          </div>
        </div>
        <span slot="footer" class="dialog-footer">
          <el-button icon="fas fa-times fa-lg" @click="showAddNumberwhatsapp = false">Cancelar</el-button>
          <el-button icon="fas fa-save fa-lg" type="primary" @click="sendNumberWhatsapp">Agregar</el-button>
        </span>
      </el-dialog>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    getUsersExcluded() {
      this.$http.get("/configurations/get-users-excluded").then(response => {
    ...
    changeNumberActivity(input) {
      ...
      if (!/^\d+$/.test(v_number_activity)) {
        this.$toast.error("El numero de whatsapp debe ser un número válido");
        return;
      }
    ...
    async loadTables() {
      await this.$http.get(`/${this.resource}/tables`).then(response => {
        ...
        if (response.data.item) {
          ...
          this.items = [
            ...this.items.filter(i => i.id != response.data.item.id),
            response.data.item
          ];
        }
      });
