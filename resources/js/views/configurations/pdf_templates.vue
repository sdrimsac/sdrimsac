            ...
            <div class="card">
                <div class="card-header bg-primary d-flex align-items-center">
                    <h4 class="my-0 text-white">
                        <i class="fas fa-print fa-lg text-white mr-4"></i>
                        Plantillas de Impresión</h4>
                </div>
                <div class="data-table-visible-columns">
                    <el-button type="primary" class="" href="javascript:void(0)" @click="addSeeder">
                ...
                <div class="card-body p-t-2 p-b-5">
                    <h4>Plantilla Actual: <a :href="'#'+form.formats" class="text-secondary">{{form.formats}}</a></h4>
