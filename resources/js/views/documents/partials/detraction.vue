                            ...
                            <div class="row">
                                ...
                                <div class="short-div col-md-12"> 
                                    <div class="form-group">
                                        ...
                                        <el-input v-model="detraction.bank_account" readonly> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                                    </div>
                                </div>
                                ...
                                <div class="short-div col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <el-input v-model="detraction.amount" readonly> <i slot="prefix" class="el-icon-edit-outline"></i></el-input>
                                    </div>
                                </div> 
