    ...
    export default {
        ...
        methods: {
            ...
            beforeUpload(file) {
                ...
                if (!isIMG) this.$toast.error('La imagen no es valida!');
                if (!isLt2M) this.$toast.error('La imagen excede los 2MB!');
            ...
            async successUpload(response, file, fileList) {
                ...
                if (response.success) {
                    await this.$toast.success('Imágen registrada temporalmente')
