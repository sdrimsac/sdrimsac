            ...
            <form autocomplete="off" @submit.prevent="submit">
                <div class="form-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4 col-12">
                            <label for="document">Serie</label>
                            <el-input
                                v-model="data_affected_document.series"
                        ...
                        <div class="col-md-4 col-lg-4 col-12">
                            ...
                            <el-input
                                v-model="data_affected_document.number"
                            ...
                            <template v-if="form.document_type_id === '08'">
                                ...
                                >
                                    ...
                                    <small
                                        ...
                                        v-text="
                                            errors['note.note_debit_type_id'][0]
                                        "
                                    ></small>
                                </div>
                            </template>
                    ...
                    <div class="row">
                        <div
                            class="col-lg-2 col-md-6 d-flex align-items-end pt-2"
                        >
                            <div class="form-group">
                                <button
                                    type="button"
...
export default {
    components: { DocumentFormItem, DocumentOptions, PersonForm },
    mixins: [functions, exchangeRate],
    props: ["configuration", "external"],
    data() {
        return {
            percentage_igv:null,
    ...
    methods: {
        ...
        changeDocumentType() {
            ...
            this.series = _.filter(this.all_series, s => {
                return s.document_type_id === document_type.id;
            });
        ...
        submit() {
            let { document_type_id, series, number } =
                this.data_affected_document;
            //validar si estan llenos los campos de la nota de credito
            if (document_type_id && series && number) {
                this.form.data_affected_document = this.data_affected_document;
                if (series && series.length === 4) {
                    let char = series.toUpperCase().charAt(0);
                    if (char === "F" || char === "B") {
                        this.form.data_affected_document = this.data_affected_document;
                    } else {
                        return this.$message.error(
                            "Debe ingresar un documento afectado"
                        );
                    }
                } else {
                    return this.$message.error(
                ...
                //if series start with F or B and has length 4
