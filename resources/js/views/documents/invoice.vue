<!-- crear CPE Administrador -->
<template>
    <div
        class="card mb-0 pt-2 pt-md-0 rounded-top"
        v-loading="loader"
                    ...
                    <div class="form-body" style="padding: 20px;">
                                    ...
                                    >
                                        ...
                                        <div class="col-lg-6 pb-2">
                                            <div class="form-group">
                                                ...
                                                >
                                                    <i
                                                        class="fas fa-route red-icon fa-lg"
                                                    ></i>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-2">
                                ...
                                >
                                    <label class="control-label">
                                        <i
                                            class="fas fa-exchange-alt red-icon"
                                        ></i>
                                        Tipo de cambio
                                        <el-tooltip
                            ...
                            <div class="col-lg-2">
                                ...
                                >
                                    <label class="control-label">
                                        <i
                                            class="fas fa-money-bill-wave red-icon fa-lg"
                                        ></i>
                                        Condición de pago
                                    </label>
                                    <el-select
                            ...
                            <div class="col-lg-2">
                                ...
                                >
                                    <label class="control-label">
                                        <i
                                            class="fas ffas fa-user-tie fa-lg"
                                        ></i>
                                        Vendedor
                                    </label>
                                    <el-select
                            ...
                            <div class="col-lg-2" v-if="show_restriction == 1">
                                ...
                                >
                                    ...
                                    >
                                        <el-switch
                                            active-text="Si"
                                            v-model="form_control.stock_control"
                                            inactive-text="No"
                                            @change="update_stock()"
                                        ></el-switch>
                                        <small
                            ...
                            <div
                                class="col-lg-2 col align-self-center"
                                v-if="show_quotations == '1'"
                            >
                                <div
                                    class="form-group"
                                    :class="{
                                ...
                                >
                                    ...
                                    >
                                        <el-button
                                            type="primary"
                                            icon="el-icon-search"
                                            @click="showDialogQuotations = true"
                                            >Cotizaciones</el-button
                                        >
                                    </div>
                                </div>
                            </div>
                        ...
                        <template v-if="!is_client">
                            ...
                            <div class="row">
                                <div
                                    class="col-lg-4"
                                    v-if="form.payment_condition_id === '02'"
                                >
                                    <table
                                ...
                                >
                                    <a
                                        href="#"
                                        @click.prevent="clickAddDocumentHotel"
                                        class="text-center font-weight-bold text-info"
                                        >[+ Datos personales para reserva de
                                        hospedaje]</a
                                    >
                                </div>
                                <div
                        ...
                        <div class="row mt-2">
                            ...
                            >
                                ...
                                <template v-if="form.boxes">
                                    <h4
                                        v-for="(data, idx) in form.boxes"
                                        :key="idx"
                                        class="text-end"
                                    >
                                        <b style="padding-right: 50px;"
                                            >TOTAL
                                            {{ data.method.toUpperCase() }}: </b
                                        >{{ currency_type.symbol
                                        }}{{ data.amount }}
                                    </h4>
                                </template>
    ...
    methods: {
                ...
                await this.$http
                    ...
                    .then(response => {
                        this.form = {
                            ...
                            establishment_id:
                                response.data.data.establishment_id,
                            document_type_id:
                                response.data.data.document_type_id,
                            ...
                            total_base_other_taxes:
                                response.data.data.total_base_other_taxes,
                            total_other_taxes:
                                response.data.data.total_other_taxes,
                            total_plastic_bag_taxes:
                                response.data.data.total_plastic_bag_taxes,
                            ...
                            operation_type_id:
                                response.data.data.operation_type_id,
                            ...
                            additional_information:
                                response.data.data.additional_information[0],
                            plate_number: null,
                            ...
                            payment_condition_id:
                                response.data.data.payment_condition_id,
                            fee: []
                        };
            ...
            if (this.form.operation_type_id === "1001") {
                ...
                if (tot <= 700)
                    return {
                        success: false,
                        message:
                            "El importe de la operación debe ser mayor a S/ 700.00 o equivalente en USD"
                    };
        ...
        calculateTotal() {
            ...
            if (this.form.currency_type_id == "USD") {
                this.form.total_rounded = this.form.total;
