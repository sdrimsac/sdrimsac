<template>
    ...
    >
        <div class="card-header bg-primary rounded-top">
            <h6 class="my-0  text-white">Comprobante de Pago</h6>
        </div>
        <div class="card-body">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    >
                                                        <label
                                                            ...
                                                            >Orden Compra</label
                                                        >
                                                        <!-- <el-input v-model="form.purchase_order"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input> -->
                                                        <el-input
                                                            type="textarea"
                                                            v-model="
                                                                form.purchase_order
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    >
                                                        <label
                                                            ...
                                                            >N° Placa</label
                                                        >
                                                        <!-- <el-input v-model="form.plate_number"> <i slot="prefix" class="el-icon-edit-outline"></i></el-input> -->
                                                        <el-input
                                                            type="textarea"
                                                            v-model="
                                                                form.plate_number
                        ...
                        <div class="row mt-2">
                            ...
                            >
                                ...
                                <template v-if="form.total > 0">
                                    <span class="text-end" v-if="form.total > 0"
                                        ><b>TOTAL VENTA: </b
                                        >{{ currency_type.symbol }}
                                        {{ form.total }}</span
                                    >
                                ...
                                <template v-if="form.total > 0">
                                    <span class="text-end" v-if="form.total > 0"
                                        ><b>REDONDEO: </b
                                        >{{ currency_type.symbol }}
                                        {{ form.total_rounded }}</span
                                    >
                                </template>
                                <template v-if="form.total > 0">
                                    <h4 class="text-end" v-if="form.total > 0">
                                        <b>TOTAL A PAGAR: </b
                                        >{{ currency_type.symbol
                                        }}{{ form.total_payment }}
                                    </h4>
