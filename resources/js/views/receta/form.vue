<template>
<el-dialog width="65%" :title="titleDialog" :visible="showDialog" :close-on-click-modal="false" @close="close" @open="create" append-to-body top="7vh" class="rounded-dialog">
            ...
            <div class="row">
                ...
                <div class="col-md-3" v-show="recordId == null">
                    <div class="form-group" :class="{ 'has-danger': errors.warehouse_id }">
                        ...
                        <el-select :disabled="establishment_id != null" v-model="form.warehouse_id" filterable>
                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr slot="heading" class="bg-primary">
                                    ...
                                    <th class="font-weight-bold text-white">Descripción</th>
                                    <th class="text-white text-center font-weight-bold">Precio Unitario</th>
                                    <th class="text-white text-right font-weight-bold">Cantidad</th>
                ...
                <div class="row col-md-12">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <el-upload class="avatar-uploader" :data="{ type: 'items' }" :headers="headers" :action="`/${resource}/upload`" :show-file-list="false" :on-success="onSuccess">
                ...
                <item-set-form-item :warehouse_id.sync="form.warehouse_id" :showDialog.sync="showDialogAddItem" @add="addRow"></item-set-form-item>
            </div>
        </div>
        <div class="form-actions text-right pt-2">
            <el-button icon="fas fa-times fa-lg" @click.prevent="close()"> Cancelar
            </el-button>

            <el-button icon="fas fa-save fa-lg" type="primary" native-type="submit" :loading="loading_submit"> Guardar
            </el-button>
        </div>
        <br>
    </form>
