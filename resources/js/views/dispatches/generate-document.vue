        ...
        >
            ...
            <div v-if="generate" class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    >
                        ...
                        <el-input v-model="document.purchase_order"></el-input>
                        <small
                ...
                <div class="col-lg-6 col-md-6 px-0" v-if="show_has_retention">
                    <div class="row no-gutters">
                        <div class="col-10">¿Tiene retención de igv?</div>
                        <div class="col-2">
                            <el-switch
                                v-model="document.has_retention"
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <template v-else>
                    ...
                    >
                    <el-button v-else @click="clickFinalize"
    ...
    methods: {
        ...
        async changeCustomer() {
            ...
            this.validateCustomerRetention(
                this.form.dispatch.customer.identity_document_type_id
            );
        },
        ...
        changeRetention() {
            if (this.document.has_retention) {
                ...
                let percentage = _.round(
                    parseFloat(this.configuration.igv_retention_percentage) /
                        100,
                    5
                );
        ...
        initDocument() {
            ...
            this.currency_type = _.find(this.configuration.currency_types, {
                id: this.document.currency_type_id
            });
        },
        ...
        onUpdateDispatchWithDocumentId(documentId) {
            ...
            this.$http
                .post(
                    `dispatches/record/${this.recordId}/set-document-id`,
                    payload
                )
        ...
        async create() {
            ...
            const items = await data.items.map(i => {
                ...
                let unit_price = !i.has_igv
                    ? i.sale_unit_price * (1 + this.percentage_igv)
                    : i.sale_unit_price;
