...
if ($hostname) {
    Route::domain($hostname->fqdn)->group(
        function () {
            ...
            Route::middleware(['auth', 'redirect.module', 'locked.tenant'])->group(function () {
                ...
                Route::get('items/has_stock/{id}', [App\Http\Controllers\Tenant\ItemController::class, 'hasStock']);
                ...
                Route::get('items/records-totem', [App\Http\Controllers\Tenant\ItemController::class, 'recordsTotem']);
                ...
                Route::post('items/records-by-ids', [ItemController::class, 'recordsByIds']);
    ...
    Route::domain($app_url)->group(function () {
        ...
        Route::middleware('auth:admin')->group(function () {
            ...
            Route::post('clients/schedule-videos', 'System\ClientController@storeScheduleVideos');
            Route::get('clients/schedule-videos', 'System\ClientController@recordsScheduleVideos');
